...
public class Table0440 extends Table{
	...
	private Table0440(){
		...
		putMap("CNN", "Composite ID number and name simplified");
		putMap("CP", "Composite price");
		putMap("CQ", "Composite quantity with units");
		putMap("CSU", "Channel sensitivity and units");
		...
		putMap("NDL", "Name with date and location");
		putMap("NM", "Numeric");
		...
		putMap("SNM", "String of telephone number digits");
		...
		putMap("XCN", "Extended composite ID number and name for persons");

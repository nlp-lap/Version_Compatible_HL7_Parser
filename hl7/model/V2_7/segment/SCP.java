...
public class SCP extends hl7.model.V2_6.segment.SCP{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_7.table.Table0651.getInstance();
		tables[2]=hl7.model.V2_7.table.Table0653.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_7.table.Table0657.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0659.getInstance();
		
		descriptions[0]="NUMBER_OF_DECONTAMINATION_STERILIZATION_DEVICES";
		descriptions[1]="LABOR_CALCULATION_TYPE";
		descriptions[2]="DATE_FORMAT";
		descriptions[3]="DEVICE_NUMBER";
		descriptions[4]="DEVICE_NAME";
		descriptions[5]="DEVICE_MODEL_NAME";
		descriptions[6]="DEVICE_TYPE";
		descriptions[7]="LOT_CONTROL";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.SCP seg = new hl7.pseudo.segment.SCP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.SCP type = (hl7.model.V2_6.segment.SCP)this;

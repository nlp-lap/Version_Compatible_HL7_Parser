...
public class PR1 extends hl7.model.V2_6.segment.PR1{
	...
	static{
		...
		standard[2]=hl7.pseudo.datastructure.CNE.CLASS;
		...
		standard[15]=hl7.pseudo.datastructure.CNE.CLASS;
		...
		standard[22]=hl7.pseudo.datastructure.PL.CLASS;
		standard[23]=hl7.bean.datastructure.primitive.ID.CLASS;
		standard[24]=hl7.pseudo.datastructure.EI.CLASS;
		
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_7.table.Table0088.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_7.table.Table0230.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_7.table.Table0019.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_7.table.Table0059.getInstance();
		tables[13]=hl7.model.V2_7.table.Table0418.getInstance();
		tables[14]=hl7.model.V2_7.table.Table0051.getInstance();
		tables[15]=hl7.model.V2_7.table.Table0340.getInstance();
		tables[16]=hl7.model.V2_7.table.Table0416.getInstance();
		tables[17]=hl7.model.V2_7.table.Table0417.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_7.table.Table0206.getInstance();
		tables[20]=hl7.model.V2_7.table.Table0761.getInstance();
		tables[21]=hl7.model.V2_7.table.Table0763.getInstance();
		tables[22]=null;
		tables[23]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[24]=null;
		...
		descriptions[16]="PROCEDURE_DRG_TYPE";
		descriptions[17]="TISSUE_TYPE_CODE";
		descriptions[18]="PROCEDURE_IDENTIFIER";
		descriptions[19]="PROCEDURE_ACTION_CODE";
		descriptions[20]="DRG_PROCEDURE_DETERMINATION_STATUS";
		descriptions[21]="DRG_PROCEDURE_RELEVANCE";
		descriptions[22]="TREATING_ORGANIZATIONAL_UNIT";
		descriptions[23]="RESPIRATORY_WITHIN_SURGERY";
		descriptions[24]="PARENT_PROCEDURE_ID";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==13) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==22) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.PL.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==24) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.PR1 type = (hl7.model.V2_6.segment.PR1)this;

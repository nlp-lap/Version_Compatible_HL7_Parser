...
public class SCD extends hl7.model.V2_6.segment.SCD{
	...
	static{
		...
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_7.table.Table0682.getInstance();
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		...
		tables[16]=null;
		tables[17]=null;
		tables[18]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[19]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[20]=hl7.model.V2_7.table.Table0532.getInstance();
		...
		tables[26]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[27]=hl7.model.V2_7.table.Table0702.getInstance();
		tables[28]=null;
		tables[29]=null;
		tables[30]=null;
		tables[31]=hl7.model.V2_7.table.Table0088.getInstance();
		tables[32]=null;
		tables[33]=hl7.model.V2_7.table.Table0010.getInstance();
		tables[34]=null;
		tables[35]=null;
		tables[36]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.SCD type = (hl7.model.V2_6.segment.SCD)this;

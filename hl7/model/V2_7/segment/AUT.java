...
public class AUT extends hl7.model.V2_6.segment.AUT{
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0072.getInstance();
		tables[1]=hl7.model.V2_7.table.Table0285.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		descriptions[10]="REQUESTED_DISCIPLINE";
		descriptions[11]="AUTHORIZED_DISCIPLINE";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==7) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(VERSION, VERSION):null;

...
public class TXA extends hl7.model.V2_6.segment.TXA{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_7.table.Table0270.getInstance();
		tables[2]=hl7.model.V2_7.table.Table0191.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		...
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_7.table.Table0271.getInstance();
		tables[17]=hl7.model.V2_7.table.Table0272.getInstance();
		tables[18]=hl7.model.V2_7.table.Table0273.getInstance();
		tables[19]=hl7.model.V2_7.table.Table0275.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		...
		descriptions[23]="FOLDER_ASSIGNMENT";
		descriptions[24]="DOCUMENT_TITLE";
		descriptions[25]="AGREED_DUE_DATE_TIME";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==24) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(VERSION, VERSION):null;

...
public class MRG extends hl7.model.V2_6.segment.MRG{
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0061.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_7.table.Table0061.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_7.table.Table0061.getInstance();
		tables[5]=hl7.model.V2_7.table.Table0061.getInstance();
		tables[6]=hl7.model.V2_7.table.Table0200.getInstance();
		
		descriptions[0]="PRIOR_PATIENT_IDENTIFIER_LIST";
		descriptions[1]="PRIOR_ALTERNATE_PATIENT_ID";
		descriptions[2]="PRIOR_PATIENT_ACCOUNT_NUMBER";
		descriptions[3]="PRIOR_PATIENT_ID";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.MRG type = (hl7.model.V2_6.segment.MRG)this;

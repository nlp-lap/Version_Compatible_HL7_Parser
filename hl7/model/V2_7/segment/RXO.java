...
public class RXO extends hl7.model.V2_6.segment.RXO{
	...
	static{
		...
		standard[35]=hl7.pseudo.datastructure.XTN.CLASS;
		...
		tables[7]=null;
		tables[8]=hl7.model.V2_7.table.Table0161.getInstance();
		...
		tables[26]=hl7.model.V2_7.table.Table0480.getInstance();
		tables[27]=null;
		tables[28]=null;
		tables[29]=null;
		tables[30]=hl7.model.V2_7.table.Table0725.getInstance();
		tables[31]=hl7.model.V2_7.table.Table9999.getInstance();
		tables[32]=null;
		tables[33]=null;
		tables[34]=null;
		tables[35]=null;
		...
		descriptions[35]="PHARMACY_PHONE_NUMBER";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==35) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XTN.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.RXO type = (hl7.model.V2_6.segment.RXO)this;

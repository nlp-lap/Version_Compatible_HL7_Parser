...
public class REL extends hl7.model.V2_6.segment.REL{
	...
	static{
		...
		descriptions[0]="SET_ID_REL";
		descriptions[1]="RELATIONSHIP_TYPE";
		descriptions[2]="THIS_RELATIONSHIP_INSTANCE_IDENTIFIER";
		descriptions[3]="SOURCE_INFORMATION_INSTANCE_IDENTIFIER";
		descriptions[4]="TARGET_INFORMATION_INSTANCE_IDENTIFIER";
		descriptions[5]="ASSERTING_ENTITY_INSTANCE_ID";
		descriptions[6]="ASSERTING_PERSON";
		descriptions[7]="ASSERTING_ORGANIZATION";
		descriptions[8]="ASSERTOR_ADDRESS";
		descriptions[9]="ASSERTOR_CONTACT";
		descriptions[10]="ASSERTION_DATE_RANGE";
		descriptions[11]="NEGATION_INDICATOR";
		descriptions[12]="CERTAINTY_OF_RELATIONSHIP";
		descriptions[13]="PRIORITY_NO";
		descriptions[14]="PRIORITY_SEQUENCE_NO";
		descriptions[15]="SEPARABILITY_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.REL seg = new hl7.pseudo.segment.REL();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.REL type = (hl7.model.V2_6.segment.REL)this;

...
public class ILT extends hl7.model.V2_6.segment.ILT{
	...
	static{
		...
		standard[6]=hl7.pseudo.datastructure.MO.CLASS;
		...
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_7.table.Table0818.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_7.table.Table0818.getInstance();
		
		descriptions[0]="SET_ID_ILT";
		descriptions[1]="INVENTORY_LOT_NUMBER";
		descriptions[2]="INVENTORY_EXPIRATION_DATE";
		descriptions[3]="INVENTORY_RECEIVED_DATE";
		descriptions[4]="INVENTORY_RECEIVED_QUANTITY";
		descriptions[5]="INVENTORY_RECEIVED_QUANTITY_UNIT";
		descriptions[6]="INVENTORY_RECEIVED_ITEM_COST";
		descriptions[7]="INVENTORY_ON_HAND_DATE";
		descriptions[8]="INVENTORY_ON_HAND_QUANTITY";
		descriptions[9]="INVENTORY_ON_HAND_QUANTITY_UNIT";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ILT seg = new hl7.pseudo.segment.ILT();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.ILT type = (hl7.model.V2_6.segment.ILT)this;

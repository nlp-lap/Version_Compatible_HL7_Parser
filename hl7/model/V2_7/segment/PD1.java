...
public class PD1 extends hl7.model.V2_6.segment.PD1{
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0223.getInstance();
		tables[1]=hl7.model.V2_7.table.Table0220.getInstance();
		tables[2]=hl7.model.V2_7.table.Table0204.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_7.table.Table0231.getInstance();
		tables[5]=hl7.model.V2_7.table.Table0295.getInstance();
		tables[6]=hl7.model.V2_7.table.Table0315.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0316.getInstance();
		tables[8]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_7.table.Table0215.getInstance();
		tables[11]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_7.table.Table0435.getInstance();
		tables[15]=hl7.model.V2_7.table.Table0441.getInstance();
		tables[16]=null;
		tables[17]=null;
		tables[18]=hl7.model.V2_7.table.Table0140.getInstance();
		tables[19]=hl7.model.V2_7.table.Table0141.getInstance();
		tables[20]=hl7.model.V2_7.table.Table0142.getInstance();
		tables[21]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.PD1 type = (hl7.model.V2_6.segment.PD1)this;

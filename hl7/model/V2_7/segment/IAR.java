...
public class IAR extends hl7.character.segment.IAR{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_7.table.Table0128.getInstance();
		tables[2]=hl7.model.V2_7.table.Table0436.getInstance();
		tables[3]=null;
		
		descriptions[0]="ALLERGY_REACTION_CODE";
		descriptions[1]="ALLERGY_SEVERITY_CODE";
		descriptions[2]="SENSITIVITY_TO_CAUSATIVE_AGENT_CODE";
		descriptions[3]="MANAGEMENT";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.IAR seg = new hl7.pseudo.segment.IAR();

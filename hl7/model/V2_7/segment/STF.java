...
public class STF extends hl7.model.V2_6.segment.STF{
	...
	static{
		...
		standard[30]=hl7.bean.datastructure.primitive.DTM.CLASS;
		...
		standard[40]=hl7.pseudo.datastructure.ED.CLASS;
		
		tables[0]=hl7.model.V2_7.table.Table9999.getInstance();
		tables[1]=hl7.model.V2_7.table.Table0061.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_7.table.Table0182.getInstance();
		tables[4]=hl7.model.V2_7.table.Table0001.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_7.table.Table0183.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0184.getInstance();
		tables[8]=hl7.model.V2_7.table.Table0069.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_7.table.Table0537.getInstance();
		tables[12]=hl7.model.V2_7.table.Table0537.getInstance();
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_7.table.Table0185.getInstance();
		tables[16]=hl7.model.V2_7.table.Table0002.getInstance();
		tables[17]=null;
		tables[18]=hl7.model.V2_7.table.Table0327.getInstance();
		tables[19]=hl7.model.V2_7.table.Table0066.getInstance();
		tables[20]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[21]=null;
		tables[22]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[23]=null;
		tables[24]=null;
		tables[25]=null;
		tables[26]=hl7.model.V2_7.table.Table0005.getInstance();
		tables[27]=hl7.model.V2_7.table.Table0189.getInstance();
		tables[28]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[29]=hl7.model.V2_7.table.Table0171.getInstance();
		tables[30]=null;
		tables[31]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[32]=hl7.model.V2_7.table.Table0538.getInstance();
		tables[33]=null;
		tables[34]=null;
		tables[35]=hl7.model.V2_7.table.Table0539.getInstance();
		tables[36]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[37]=hl7.model.V2_7.table.Table0540.getInstance();
		tables[38]=hl7.model.V2_7.table.Table0771.getInstance();
		tables[39]=hl7.model.V2_7.table.Table0006.getInstance();
		tables[40]=null;
		...
		descriptions[30]="DATE_TIME_OF_DEATH";
		...
		descriptions[38]="GENERIC_RESOURCE_TYPE_OR_CATEGORY";
		descriptions[39]="RELIGION";
		descriptions[40]="SIGNATURE";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==40) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.ED.CLASS.cloneClass(VERSION, VERSION):null;

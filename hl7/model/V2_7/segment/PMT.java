...
public class PMT extends hl7.model.V2_6.segment.PMT{
	...
	static{
		...
		standard[5]=hl7.pseudo.datastructure.CP.CLASS;
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_7.table.Table0570.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		...
		descriptions[0]="PAYMENT_REMITTANCE_ADVICE_NUMBER";
		descriptions[1]="PAYMENT_REMITTANCE_EFFECTIVE_DATE_TIME";
		descriptions[2]="PAYMENT_REMITTANCE_EXPIRATION_DATE_TIME";
		descriptions[3]="PAYMENT_METHOD";
		descriptions[4]="PAYMENT_REMITTANCE_DATE_TIME";
		descriptions[5]="PAYMENT_REMITTANCE_AMOUNT";
		descriptions[6]="CHECK_NUMBER";
		descriptions[7]="PAYEE_BANK_IDENTIFICATION";
		descriptions[8]="PAYEE_TRANSIT_NUMBER";
		descriptions[9]="PAYEE_BANK_ACCOUNT_ID";
		descriptions[10]="PAYMENT_ORGANIZATION";
		descriptions[11]="ESR_CODE_LINE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PMT seg = new hl7.pseudo.segment.PMT();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.PMT type = (hl7.model.V2_6.segment.PMT)this;

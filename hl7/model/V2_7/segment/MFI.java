...
public class MFI extends hl7.model.V2_6.segment.MFI{
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0175.getInstance();
		tables[1]=hl7.model.V2_7.table.Table0361.getInstance();
		tables[2]=hl7.model.V2_7.table.Table0178.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_7.table.Table0179.getInstance();

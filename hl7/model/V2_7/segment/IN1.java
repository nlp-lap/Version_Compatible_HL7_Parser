...
public class IN1 extends hl7.model.V2_6.segment.IN1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_7.table.Table0072.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_7.table.Table0086.getInstance();
		tables[15]=null;
		tables[16]=hl7.model.V2_7.table.Table0063.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_7.table.Table0135.getInstance();
		tables[20]=hl7.model.V2_7.table.Table0173.getInstance();
		tables[21]=null;
		tables[22]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[23]=null;
		tables[24]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[25]=null;
		tables[26]=hl7.model.V2_7.table.Table0093.getInstance();
		tables[27]=null;
		tables[28]=null;
		tables[29]=null;
		tables[30]=hl7.model.V2_7.table.Table0098.getInstance();
		tables[31]=hl7.model.V2_7.table.Table0022.getInstance();
		tables[32]=null;
		tables[33]=null;
		tables[34]=hl7.model.V2_7.table.Table0042.getInstance();
		tables[35]=null;
		tables[36]=null;
		tables[37]=null;
		tables[38]=null;
		tables[39]=null;
		tables[40]=null;
		tables[41]=hl7.model.V2_7.table.Table0066.getInstance();
		tables[42]=hl7.model.V2_7.table.Table0001.getInstance();
		tables[43]=null;
		tables[44]=null;
		tables[45]=hl7.model.V2_7.table.Table0072.getInstance();
		tables[46]=hl7.model.V2_7.table.Table0309.getInstance();
		tables[47]=hl7.model.V2_7.table.Table0295.getInstance();
		tables[48]=null;
		tables[49]=hl7.model.V2_7.table.Table0535.getInstance();
		tables[50]=null;
		tables[51]=null;
		tables[52]=hl7.model.V2_7.table.Table0099.getInstance();
		tables[53]=null;
		
		descriptions[0]="SET_ID_IN1";
		descriptions[1]="HEALTH_PLAN_ID";
		...
		descriptions[53]="EXTERNAL_HEALTH_PLAN_IDENTIFIERS";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==49) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.IN1 type = (hl7.model.V2_6.segment.IN1)this;

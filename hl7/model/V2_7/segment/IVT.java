...
public class IVT extends hl7.model.V2_6.segment.IVT{
	...
	static{
		...
		standard[14]=hl7.pseudo.datastructure.CNE.CLASS;
		...
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_7.table.Table0625.getInstance();
		tables[6]=null;
		tables[7]=hl7.model.V2_7.table.Table0818.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[11]=hl7.model.V2_7.table.Table0132.getInstance();
		tables[12]=null;
		tables[13]=hl7.model.V2_7.table.Table0634.getInstance();
		tables[14]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[15]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[16]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=null;
		tables[20]=hl7.model.V2_7.table.Table0642.getInstance();
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		tables[25]=hl7.model.V2_7.table.Table0532.getInstance();
		
		descriptions[0]="SET_ID_IVT";
		descriptions[1]="INVENTORY_LOCATION_IDENTIFIER";
		descriptions[2]="INVENTORY_LOCATION_NAME";
		descriptions[3]="SOURCE_LOCATION_IDENTIFIER";
		descriptions[4]="SOURCE_LOCATION_NAME";
		descriptions[5]="ITEM_STATUS";
		descriptions[6]="BIN_LOCATION_IDENTIFIER";
		descriptions[7]="ORDER_PACKAGING";
		descriptions[8]="ISSUE_PACKAGING";
		descriptions[9]="DEFAULT_INVENTORY_ASSET_ACCOUNT";
		descriptions[10]="PATIENT_CHARGEABLE_INDICATOR";
		descriptions[11]="TRANSACTION_CODE";
		descriptions[12]="TRANSACTION_AMOUNT_UNIT";
		descriptions[13]="ITEM_IMPORTANCE_CODE";
		descriptions[14]="STOCKED_ITEM_INDICATOR";
		descriptions[15]="CONSIGNMENT_ITEM_INDICATOR";
		descriptions[16]="REUSABLE_ITEM_INDICATOR";
		descriptions[17]="REUSABLE_COST";
		descriptions[18]="SUBSTITUTE_ITEM_IDENTIFIER";
		descriptions[19]="LATEX_FREE_SUBSTITUTE_ITEM_IDENTIFIER";
		descriptions[20]="RECOMMENDED_REORDER_THEORY";
		descriptions[21]="RECOMMENDED_SAFETY_STOCK_DAYS";
		descriptions[22]="RECOMMENDED_MAXIMUM_DAYS_INVENTORY";
		descriptions[23]="RECOMMENDED_ORDER_POINT";
		descriptions[24]="RECOMMENDED_ORDER_AMOUNT";
		descriptions[25]="OPERATING_ROOM_PAR_LEVEL_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.IVT seg = new hl7.pseudo.segment.IVT();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.IVT type = (hl7.model.V2_6.segment.IVT)this;

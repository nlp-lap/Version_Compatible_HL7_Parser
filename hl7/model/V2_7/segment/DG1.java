...
public class DG1 extends hl7.model.V2_6.segment.DG1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_7.table.Table0051.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_7.table.Table0052.getInstance();
		tables[6]=hl7.model.V2_7.table.Table0118.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0055.getInstance();
		tables[8]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[9]=hl7.model.V2_7.table.Table0056.getInstance();
		tables[10]=hl7.model.V2_7.table.Table0083.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_7.table.Table0359.getInstance();
		tables[15]=null;
		tables[16]=hl7.model.V2_7.table.Table0228.getInstance();
		tables[17]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=hl7.model.V2_7.table.Table0206.getInstance();
		tables[21]=null;
		tables[22]=hl7.model.V2_7.table.Table0728.getInstance();
		tables[23]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[24]=hl7.model.V2_7.table.Table0731.getInstance();
		tables[25]=hl7.model.V2_7.table.Table0895.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.DG1 type = (hl7.model.V2_6.segment.DG1)this;

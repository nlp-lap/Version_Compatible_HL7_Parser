...
public class ITM extends hl7.model.V2_6.segment.ITM{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_7.table.Table0776.getInstance();
		tables[3]=hl7.model.V2_7.table.Table0778.getInstance();
		tables[4]=null;
		tables[5]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		...
		tables[12]=null;
		tables[13]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[14]=hl7.model.V2_7.table.Table0871.getInstance();
		tables[15]=hl7.model.V2_7.table.Table0790.getInstance();
		tables[16]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[17]=hl7.model.V2_7.table.Table0793.getInstance();
		tables[18]=hl7.model.V2_7.table.Table0320.getInstance();
		tables[19]=null;
		tables[20]=null;
		tables[21]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[22]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[23]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[24]=null;
		tables[25]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[26]=hl7.model.V2_7.table.Table0088.getInstance();
		tables[27]=hl7.model.V2_7.table.Table0340.getInstance();
		tables[28]=hl7.model.V2_7.table.Table0376.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.ITM type = (hl7.model.V2_6.segment.ITM)this;

...
public class ACC extends hl7.model.V2_6.segment.ACC{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_7.table.Table0050.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_7.table.Table0347.getInstance();
		tables[4]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[5]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		...
		descriptions[11]="DEGREE_OF_PATIENT_LIABILITY";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;

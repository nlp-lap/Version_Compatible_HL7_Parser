...
public class PSL extends hl7.model.V2_6.segment.PSL{
	...
	static{
		...
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_7.table.Table0559.getInstance();
		tables[6]=hl7.model.V2_7.table.Table0879.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0880.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_7.table.Table0560.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_7.table.Table0561.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_7.table.Table0562.getInstance();
		tables[20]=hl7.model.V2_7.table.Table0532.getInstance();
		tables[21]=hl7.model.V2_7.table.Table0879.getInstance();
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		tables[25]=null;
		...
		tables[28]=null;
		tables[29]=null;
		tables[30]=hl7.model.V2_7.table.Table0881.getInstance();
		tables[31]=hl7.model.V2_7.table.Table0882.getInstance();
		tables[32]=hl7.model.V2_7.table.Table0894.getInstance();
		tables[33]=null;
		tables[34]=null;
		tables[35]=null;
		tables[36]=null;
		...
		tables[44]=null;
		tables[45]=null;
		tables[46]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[47]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.PSL type = (hl7.model.V2_6.segment.PSL)this;

...
public class PRT extends hl7.character.segment.PRT{
	...
	static{
		...
		standard[7]=hl7.pseudo.datastructure.XON.CLASS;
		standard[8]=hl7.pseudo.datastructure.PL.CLASS;
		...
		standard[14]=hl7.pseudo.datastructure.XTN.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_7.table.Table0287.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_7.table.Table0912.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_7.table.Table0406.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		...
		descriptions[0]="PARTICIPATION_INSTANCE_ID";
		descriptions[1]="ACTION_CODE";
		descriptions[2]="ACTION_REASON";
		descriptions[3]="PARTICIPATION";
		descriptions[4]="PARTICIPATION_PERSON";
		descriptions[5]="PARTICIPATION_PERSON_PROVIDER_TYPE";
		descriptions[6]="PARTICIPANT_ORGANIZATION_UNIT_TYPE";
		descriptions[7]="PARTICIPATION_ORGANIZATION";
		descriptions[8]="PARTICIPANT_LOCATION";
		descriptions[9]="PARTICIPATION_DEVICE";
		descriptions[10]="PARTICIPATION_BEGIN_DATE_TIME";
		descriptions[11]="PARTICIPATION_END_DATE_TIME";
		descriptions[12]="PARTICIPATION_QUALITATIVE_DURATION";
		descriptions[13]="PARTICIPATION_ADDRESS";
		descriptions[14]="PARTICIPANT_TELECOMMUNICATION_ADDRESS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PRT seg = new hl7.pseudo.segment.PRT();

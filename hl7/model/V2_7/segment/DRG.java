...
public class DRG extends hl7.model.V2_6.segment.DRG{
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0055.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[3]=hl7.model.V2_7.table.Table0056.getInstance();
		tables[4]=hl7.model.V2_7.table.Table0083.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_7.table.Table0229.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[10]=hl7.model.V2_7.table.Table0415.getInstance();
		tables[11]=null;
		tables[12]=hl7.model.V2_7.table.Table0734.getInstance();
		tables[13]=hl7.model.V2_7.table.Table0728.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_7.table.Table0739.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_7.table.Table0742.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		tables[25]=hl7.model.V2_7.table.Table0749.getInstance();
		tables[26]=hl7.model.V2_7.table.Table0749.getInstance();
		tables[27]=hl7.model.V2_7.table.Table0749.getInstance();
		tables[28]=hl7.model.V2_7.table.Table0749.getInstance();
		tables[29]=hl7.model.V2_7.table.Table0749.getInstance();
		tables[30]=hl7.model.V2_7.table.Table0755.getInstance();
		tables[31]=hl7.model.V2_7.table.Table0757.getInstance();
		tables[32]=hl7.model.V2_7.table.Table0759.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.DRG type = (hl7.model.V2_6.segment.DRG)this;

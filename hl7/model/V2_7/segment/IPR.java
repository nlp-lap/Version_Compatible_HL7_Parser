...
public class IPR extends hl7.model.V2_6.segment.IPR{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_7.table.Table0571.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		
		descriptions[0]="IPR_IDENTIFIER";
		descriptions[1]="PROVIDER_CROSS_REFERENCE_IDENTIFIER";
		descriptions[2]="PAYER_CROSS_REFERENCE_IDENTIFIER";
		descriptions[3]="IPR_STATUS";
		descriptions[4]="IPR_DATE_TIME";
		descriptions[5]="ADJUDICATED_PAID_AMOUNT";
		descriptions[6]="EXPECTED_PAYMENT_DATE_TIME";
		descriptions[7]="IPR_CHECKSUM";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.IPR seg = new hl7.pseudo.segment.IPR();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.IPR type = (hl7.model.V2_6.segment.IPR)this;

...
public class PAC extends hl7.character.segment.PAC{
	...
	static{
		...
		standard[3]=hl7.pseudo.datastructure.NA.CLASS;
		...
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_7.table.Table0908.getInstance();
		tables[5]=hl7.model.V2_7.table.Table0544.getInstance();
		tables[6]=hl7.model.V2_7.table.Table0376.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0489.getInstance();
		
		descriptions[0]="SET_ID_PAC";
		descriptions[1]="PACKAGE_ID";
		descriptions[2]="PARENT_PACKAGE_ID";
		descriptions[3]="POSITION_IN_PARENT_PACKAGE";
		descriptions[4]="PACKAGE_TYPE";
		descriptions[5]="PACKAGE_CONDITION";
		descriptions[6]="PACKAGE_HANDLING_CODE";
		descriptions[7]="PACKAGE_RISK_CODE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PAC seg = new hl7.pseudo.segment.PAC();

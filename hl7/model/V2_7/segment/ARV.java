...
public class ARV extends hl7.model.V2_6.segment.ARV{
	...
	static{
		...
		standard[1]=hl7.pseudo.datastructure.CNE.CLASS;
		...
		standard[5]=hl7.pseudo.datastructure.DR.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_7.table.Table0206.getInstance();
		tables[2]=hl7.model.V2_7.table.Table0717.getInstance();
		tables[3]=hl7.model.V2_7.table.Table0719.getInstance();
		tables[4]=null;
		tables[5]=null;
		
		descriptions[0]="SET_ID";
		descriptions[1]="ACCESS_RESTRICTION_ACTION_CODE";
		descriptions[2]="ACCESS_RESTRICTION_VALUE";
		descriptions[3]="ACCESS_RESTRICTION_REASON";
		descriptions[4]="SPECIAL_ACCESS_RESTRICTION_INSTRUCTIONS";
		descriptions[5]="ACCESS_RESTRICTION_DATE_RANGE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ARV seg = new hl7.pseudo.segment.ARV();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.ARV type = (hl7.model.V2_6.segment.ARV)this;

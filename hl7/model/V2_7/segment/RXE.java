...
public class RXE extends hl7.model.V2_6.segment.RXE{
	...
	static{
		...
		standard[44]=hl7.pseudo.datastructure.XTN.CLASS;
		...
		tables[7]=null;
		tables[8]=hl7.model.V2_7.table.Table0167.getInstance();
		tables[9]=null;
		...
		tables[29]=hl7.model.V2_7.table.Table0321.getInstance();
		tables[30]=hl7.model.V2_7.table.Table9999.getInstance();
		tables[31]=null;
		tables[32]=null;
		tables[33]=hl7.model.V2_7.table.Table9999.getInstance();
		tables[34]=hl7.model.V2_7.table.Table0477.getInstance();
		tables[35]=hl7.model.V2_7.table.Table0478.getInstance();
		...
		tables[41]=null;
		tables[42]=null;
		tables[43]=hl7.model.V2_7.table.Table0480.getInstance();
		tables[44]=null;
		...
		descriptions[44]="PHARMACY_PHONE_NUMBER";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==44) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XTN.CLASS.cloneClass(VERSION, VERSION):null;

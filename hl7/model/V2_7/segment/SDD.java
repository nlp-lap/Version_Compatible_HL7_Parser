...
public class SDD extends hl7.model.V2_6.segment.SDD{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_7.table.Table0667.getInstance();
		tables[4]=hl7.model.V2_7.table.Table0669.getInstance();
		tables[5]=null;
		tables[6]=null;
		
		descriptions[0]="LOT_NUMBER";
		descriptions[1]="DEVICE_NUMBER";
		descriptions[2]="DEVICE_NAME";
		descriptions[3]="DEVICE_DATA_STATE";
		descriptions[4]="LOAD_STATUS";
		descriptions[5]="CONTROL_CODE";
		descriptions[6]="OPERATOR_NAME";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.SDD seg = new hl7.pseudo.segment.SDD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.SDD type = (hl7.model.V2_6.segment.SDD)this;

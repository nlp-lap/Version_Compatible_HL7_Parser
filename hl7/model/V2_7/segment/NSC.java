...
public class NSC extends hl7.model.V2_6.segment.NSC{
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0409.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_7.table.Table0361.getInstance();
		tables[4]=hl7.model.V2_7.table.Table0362.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_7.table.Table0361.getInstance();
		tables[8]=hl7.model.V2_7.table.Table0362.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.segment.NSC type = (hl7.model.V2_6.segment.NSC)this;

...
public class CLINICAL_ORDER_DETAIL_CCR_I16 extends hl7.character.group.CLINICAL_ORDER_DETAIL_CCR_I16{
	...
	static{
		...
		standard[3]=hl7.pseudo.segment.PR1.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.CLINICAL_ORDER_DETAIL_CCR_I16 group = new hl7.pseudo.group.CLINICAL_ORDER_DETAIL_CCR_I16();

...
public class INVOICE_PROCESSING_RESULTS_INFO_EHC_E10 extends hl7.model.V2_6.group.INVOICE_PROCESSING_RESULTS_INFO_EHC_E10{
	...
	static{
		standard[0]=hl7.pseudo.segment.IPR.CLASS;
		standard[1]=hl7.pseudo.segment.NTE.CLASS;
		standard[2]=hl7.pseudo.segment.PYE.CLASS;
		standard[3]=hl7.pseudo.segment.IN1.CLASS;
		standard[4]=hl7.pseudo.segment.IN2.CLASS;
		standard[5]=hl7.pseudo.segment.IVC.CLASS;
		standard[6]=hl7.pseudo.group.PRODUCT_SERVICE_SECTION_EHC_E10.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.INVOICE_PROCESSING_RESULTS_INFO_EHC_E10 group = new hl7.pseudo.group.INVOICE_PROCESSING_RESULTS_INFO_EHC_E10();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.INVOICE_PROCESSING_RESULTS_INFO_EHC_E10 type = (hl7.model.V2_6.group.INVOICE_PROCESSING_RESULTS_INFO_EHC_E10)this;

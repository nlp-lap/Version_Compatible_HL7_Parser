...
public class PRODUCT_SERVICE_GROUP_EHC_E15 extends hl7.model.V2_6.group.PRODUCT_SERVICE_GROUP_EHC_E15{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.PSL_ITEM_INFO_EHC_E15.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PRODUCT_SERVICE_GROUP_EHC_E15 group = new hl7.pseudo.group.PRODUCT_SERVICE_GROUP_EHC_E15();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.PRODUCT_SERVICE_GROUP_EHC_E15 type = (hl7.model.V2_6.group.PRODUCT_SERVICE_GROUP_EHC_E15)this;

...
public class PSL_ITEM_INFO_EHC_E24 extends hl7.model.V2_6.group.PSL_ITEM_INFO_EHC_E24{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.AUT.CLASS;
		standard[2]=hl7.pseudo.group.PAYER_ADJUSTMENT_EHC_E24.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PSL_ITEM_INFO_EHC_E24 group = new hl7.pseudo.group.PSL_ITEM_INFO_EHC_E24();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.PSL_ITEM_INFO_EHC_E24 type = (hl7.model.V2_6.group.PSL_ITEM_INFO_EHC_E24)this;

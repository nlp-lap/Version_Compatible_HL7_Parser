...
public class SHIPMENT_OSM_R26 extends hl7.character.group.SHIPMENT_OSM_R26{
	...
	static{
		standard[0]=hl7.pseudo.segment.SHP.CLASS;
		standard[1]=hl7.pseudo.segment.PRT.CLASS;
		standard[2]=hl7.pseudo.group.SHIPPING_OBSERVATION_OSM_R26.CLASS;
		standard[3]=hl7.pseudo.group.PACKAGE_OSM_R26.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.SHIPMENT_OSM_R26 group = new hl7.pseudo.group.SHIPMENT_OSM_R26();

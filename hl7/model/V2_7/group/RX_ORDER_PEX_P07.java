...
public class RX_ORDER_PEX_P07 extends hl7.model.V2_6.group.RX_ORDER_PEX_P07{
	...
	static{
		...
		standard[2]=hl7.pseudo.group.TIMING_QTY_PEX_P07.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.RX_ORDER_PEX_P07 group = new hl7.pseudo.group.RX_ORDER_PEX_P07();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.RX_ORDER_PEX_P07 type = (hl7.model.V2_6.group.RX_ORDER_PEX_P07)this;

...
public class SPECIMEN_OSM_R26 extends hl7.character.group.SPECIMEN_OSM_R26{
	...
	static{
		standard[0]=hl7.pseudo.segment.SPM.CLASS;
		standard[1]=hl7.pseudo.segment.PRT.CLASS;
		standard[2]=hl7.pseudo.group.SPECIMEN_OBSERVATION_OSM_R26.CLASS;
		standard[3]=hl7.pseudo.group.CONTAINER_OSM_R26.CLASS;
		standard[4]=hl7.pseudo.group.SUBJECT_PERSON_ANIMAL_IDENTIFICATION_OSM_R26.CLASS;
		standard[5]=hl7.pseudo.group.SUBJECT_POPULATION_LOCATION_IDENTIFICATION_OSM_R26.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.SPECIMEN_OSM_R26 group = new hl7.pseudo.group.SPECIMEN_OSM_R26();

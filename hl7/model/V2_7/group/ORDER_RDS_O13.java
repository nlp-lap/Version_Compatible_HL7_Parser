...
public class ORDER_RDS_O13 extends hl7.model.V2_6.group.ORDER_RDS_O13{
	...
	static{
		...
		standard[5]=hl7.pseudo.segment.RXD.CLASS;
		standard[6]=hl7.pseudo.segment.PRT.CLASS;
		...
		standard[4]=hl7.pseudo.group.ENCODING_RDS_O13.CLASS;
		standard[10]=hl7.pseudo.group.OBSERVATION_RDS_O13.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.ORDER_RDS_O13 type = (hl7.model.V2_6.group.ORDER_RDS_O13)this;

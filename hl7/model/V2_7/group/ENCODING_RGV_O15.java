...
public class ENCODING_RGV_O15 extends hl7.model.V2_6.group.ENCODING_RGV_O15{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.TIMING_ENCODED_RGV_O15.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.ENCODING_RGV_O15 type = (hl7.model.V2_6.group.ENCODING_RGV_O15)this;

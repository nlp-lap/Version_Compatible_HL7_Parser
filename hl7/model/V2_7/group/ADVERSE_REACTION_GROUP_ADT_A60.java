...
public class ADVERSE_REACTION_GROUP_ADT_A60 extends hl7.character.group.ADVERSE_REACTION_GROUP_ADT_A60{
	...
	static{
		standard[0]=hl7.pseudo.segment.IAM.CLASS;
		standard[1]=hl7.pseudo.segment.NTE.CLASS;
		standard[2]=hl7.pseudo.segment.IAR.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ADVERSE_REACTION_GROUP_ADT_A60 group = new hl7.pseudo.group.ADVERSE_REACTION_GROUP_ADT_A60();

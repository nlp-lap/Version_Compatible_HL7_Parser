...
public class OBSERVATION_REQUEST_OPL_O37 extends hl7.model.V2_6.group.OBSERVATION_REQUEST_OPL_O37{
	...
	static{
		...
		standard[6]=hl7.pseudo.group.ORDER_RELATED_OBSERVATION_OPL_O37.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.OBSERVATION_REQUEST_OPL_O37 type = (hl7.model.V2_6.group.OBSERVATION_REQUEST_OPL_O37)this;

...
public class ORDER_OMP_O09 extends hl7.model.V2_6.group.ORDER_OMP_O09{
	...
	static{
		...
		standard[8]=hl7.pseudo.segment.FT1.CLASS;
		standard[9]=hl7.pseudo.segment.BLG.CLASS;
		standard[1]=hl7.pseudo.group.TIMING_OMP_O09.CLASS;
		standard[6]=hl7.pseudo.group.COMPONENT_OMP_O09.CLASS;
		standard[7]=hl7.pseudo.group.OBSERVATION_OMP_O09.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.ORDER_OMP_O09 type = (hl7.model.V2_6.group.ORDER_OMP_O09)this;

...
public class CLINICAL_HISTORY_CCR_I16 extends hl7.character.group.CLINICAL_HISTORY_CCR_I16{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.CLINICAL_HISTORY_DETAIL_CCR_I16.CLASS;
		standard[2]=hl7.pseudo.group.ROLE_CLINICAL_HISTORY_CCR_I16.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.CLINICAL_HISTORY_CCR_I16 group = new hl7.pseudo.group.CLINICAL_HISTORY_CCR_I16();

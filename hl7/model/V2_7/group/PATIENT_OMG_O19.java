...
public class PATIENT_OMG_O19 extends hl7.model.V2_6.group.PATIENT_OMG_O19{
	...
	static{
		...
		standard[5]=hl7.pseudo.group.PATIENT_VISIT_OMG_O19.CLASS;
		standard[6]=hl7.pseudo.group.INSURANCE_OMG_O19.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.PATIENT_OMG_O19 type = (hl7.model.V2_6.group.PATIENT_OMG_O19)this;

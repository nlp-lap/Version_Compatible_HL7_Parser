...
public class ORDER_OMG_O19 extends hl7.model.V2_6.group.ORDER_OMG_O19{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.PRT.CLASS;
		standard[3]=hl7.pseudo.segment.OBR.CLASS;
		standard[4]=hl7.pseudo.segment.NTE.CLASS;
		standard[5]=hl7.pseudo.segment.PRT.CLASS;
		standard[6]=hl7.pseudo.segment.CTD.CLASS;
		standard[7]=hl7.pseudo.segment.DG1.CLASS;
		standard[11]=hl7.pseudo.segment.FT1.CLASS;
		standard[12]=hl7.pseudo.segment.CTI.CLASS;
		standard[13]=hl7.pseudo.segment.BLG.CLASS;
		standard[2]=hl7.pseudo.group.TIMING_OMG_O19.CLASS;
		standard[8]=hl7.pseudo.group.OBSERVATION_OMG_O19.CLASS;
		standard[9]=hl7.pseudo.group.SPECIMEN_OMG_O19.CLASS;
		standard[10]=hl7.pseudo.group.PRIOR_RESULT_OMG_O19.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.ORDER_OMG_O19 type = (hl7.model.V2_6.group.ORDER_OMG_O19)this;

...
public class MEDICATION_HISTORY_CQU_I19 extends hl7.character.group.MEDICATION_HISTORY_CQU_I19{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.MEDICATION_ORDER_DETAIL_CQU_I19.CLASS;
		standard[2]=hl7.pseudo.group.MEDICATION_ENCODING_DETAIL_CQU_I19.CLASS;
		standard[3]=hl7.pseudo.group.MEDICATION_ADMINISTRATION_DETAIL_CQU_I19.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.MEDICATION_HISTORY_CQU_I19 group = new hl7.pseudo.group.MEDICATION_HISTORY_CQU_I19();

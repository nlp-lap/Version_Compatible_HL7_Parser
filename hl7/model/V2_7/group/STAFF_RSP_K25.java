...
public class STAFF_RSP_K25 extends hl7.model.V2_6.group.STAFF_RSP_K25{
	...
	static{
		standard[0]=hl7.pseudo.segment.STF.CLASS;
		standard[1]=hl7.pseudo.segment.PRA.CLASS;
		standard[2]=hl7.pseudo.segment.ORG.CLASS;
		standard[3]=hl7.pseudo.segment.AFF.CLASS;
		standard[4]=hl7.pseudo.segment.LAN.CLASS;
		standard[5]=hl7.pseudo.segment.EDU.CLASS;
		standard[6]=hl7.pseudo.segment.CER.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.STAFF_RSP_K25 group = new hl7.pseudo.group.STAFF_RSP_K25();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.STAFF_RSP_K25 type = (hl7.model.V2_6.group.STAFF_RSP_K25)this;

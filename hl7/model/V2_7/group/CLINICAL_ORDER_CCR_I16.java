...
public class CLINICAL_ORDER_CCR_I16 extends hl7.character.group.CLINICAL_ORDER_CCR_I16{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.CLINICAL_ORDER_TIMING_CCR_I16.CLASS;
		standard[2]=hl7.pseudo.group.CLINICAL_ORDER_DETAIL_CCR_I16.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.CLINICAL_ORDER_CCR_I16 group = new hl7.pseudo.group.CLINICAL_ORDER_CCR_I16();

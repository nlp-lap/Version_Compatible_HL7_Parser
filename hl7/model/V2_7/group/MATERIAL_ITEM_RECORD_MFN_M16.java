...
public class MATERIAL_ITEM_RECORD_MFN_M16 extends hl7.model.V2_6.group.MATERIAL_ITEM_RECORD_MFN_M16{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.ITM.CLASS;
		standard[2]=hl7.pseudo.segment.NTE.CLASS;
		standard[3]=hl7.pseudo.group.STERILIZATION_MFN_M16.CLASS;
		standard[4]=hl7.pseudo.group.PURCHASING_VENDOR_MFN_M16.CLASS;
		standard[5]=hl7.pseudo.group.MATERIAL_LOCATION_MFN_M16.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.MATERIAL_ITEM_RECORD_MFN_M16 group = new hl7.pseudo.group.MATERIAL_ITEM_RECORD_MFN_M16();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.MATERIAL_ITEM_RECORD_MFN_M16 type = (hl7.model.V2_6.group.MATERIAL_ITEM_RECORD_MFN_M16)this;

...
public class INSURANCE_OPL_O37 extends hl7.model.V2_6.group.INSURANCE_OPL_O37{
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.INSURANCE_OPL_O37 group = new hl7.pseudo.group.INSURANCE_OPL_O37();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.INSURANCE_OPL_O37 type = (hl7.model.V2_6.group.INSURANCE_OPL_O37)this;

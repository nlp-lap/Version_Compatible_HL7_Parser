...
public class REQUEST_EHC_E13 extends hl7.model.V2_6.group.REQUEST_EHC_E13{
	...
	static{
		standard[0]=hl7.pseudo.segment.CTD.CLASS;
		standard[1]=hl7.pseudo.segment.OBR.CLASS;
		standard[2]=hl7.pseudo.segment.NTE.CLASS;
		standard[3]=hl7.pseudo.group.RESPONSE_EHC_E13.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.REQUEST_EHC_E13 group = new hl7.pseudo.group.REQUEST_EHC_E13();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.REQUEST_EHC_E13 type = (hl7.model.V2_6.group.REQUEST_EHC_E13)this;

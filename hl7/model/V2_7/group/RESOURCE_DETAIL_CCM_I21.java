...
public class RESOURCE_DETAIL_CCM_I21 extends hl7.character.group.RESOURCE_DETAIL_CCM_I21{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.AIG.CLASS;
		standard[2]=hl7.pseudo.segment.AIL.CLASS;
		standard[3]=hl7.pseudo.segment.AIP.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.RESOURCE_DETAIL_CCM_I21 group = new hl7.pseudo.group.RESOURCE_DETAIL_CCM_I21();

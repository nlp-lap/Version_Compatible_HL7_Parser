...
public class MF_DRG_MFN_M17 extends hl7.model.V2_6.group.MF_DRG_MFN_M17{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.DMI.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.MF_DRG_MFN_M17 group = new hl7.pseudo.group.MF_DRG_MFN_M17();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.MF_DRG_MFN_M17 type = (hl7.model.V2_6.group.MF_DRG_MFN_M17)this;

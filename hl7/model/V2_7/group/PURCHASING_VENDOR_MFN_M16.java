...
public class PURCHASING_VENDOR_MFN_M16 extends hl7.model.V2_6.group.PURCHASING_VENDOR_MFN_M16{
	...
	static{
		standard[0]=hl7.pseudo.segment.VND.CLASS;
		standard[1]=hl7.pseudo.group.PACKAGING_MFN_M16.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PURCHASING_VENDOR_MFN_M16 group = new hl7.pseudo.group.PURCHASING_VENDOR_MFN_M16();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_6.group.PURCHASING_VENDOR_MFN_M16 type = (hl7.model.V2_6.group.PURCHASING_VENDOR_MFN_M16)this;

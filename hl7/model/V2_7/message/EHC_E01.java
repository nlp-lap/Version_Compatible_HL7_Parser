...
public class EHC_E01 extends hl7.model.V2_6.message.EHC_E01{
	...
	static{
		...
		standard[3]=hl7.pseudo.segment.IVC.CLASS;
		standard[4]=hl7.pseudo.segment.PYE.CLASS;
		standard[5]=hl7.pseudo.segment.CTD.CLASS;
		standard[6]=hl7.pseudo.segment.AUT.CLASS;
		standard[7]=hl7.pseudo.segment.LOC.CLASS;
		standard[8]=hl7.pseudo.segment.ROL.CLASS;
		standard[9]=hl7.pseudo.group.PRODUCT_SERVICE_SECTION_EHC_E01.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.message.EHC_E01 type = (hl7.model.V2_6.message.EHC_E01)this;

package hl7.model.V2_7.message;
...
public class ADT_A05 extends hl7.model.V2_6.message.ADT_A05{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.UAC.CLASS;
		standard[3]=hl7.pseudo.segment.EVN.CLASS;
		standard[4]=hl7.pseudo.segment.PID.CLASS;
		standard[5]=hl7.pseudo.segment.PD1.CLASS;
		standard[6]=hl7.pseudo.segment.ARV.CLASS;
		standard[7]=hl7.pseudo.segment.ROL.CLASS;
		standard[8]=hl7.pseudo.segment.NK1.CLASS;
		standard[9]=hl7.pseudo.segment.PV1.CLASS;
		standard[10]=hl7.pseudo.segment.PV2.CLASS;
		standard[11]=hl7.pseudo.segment.ARV.CLASS;
		standard[12]=hl7.pseudo.segment.ROL.CLASS;
		standard[13]=hl7.pseudo.segment.DB1.CLASS;
		standard[14]=hl7.pseudo.segment.OBX.CLASS;
		standard[15]=hl7.pseudo.segment.AL1.CLASS;
		standard[16]=hl7.pseudo.segment.DG1.CLASS;
		standard[17]=hl7.pseudo.segment.DRG.CLASS;
		standard[19]=hl7.pseudo.segment.GT1.CLASS;
		standard[21]=hl7.pseudo.segment.ACC.CLASS;
		standard[22]=hl7.pseudo.segment.UB1.CLASS;
		standard[23]=hl7.pseudo.segment.UB2.CLASS;
		standard[18]=hl7.pseudo.group.PROCEDURE_ADT_A05.CLASS;
		standard[20]=hl7.pseudo.group.INSURANCE_ADT_A05.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[3] = subComponents[1];
		components[4] = subComponents[2];
		components[5] = subComponents[3];
		components[7] = subComponents[4];
		components[8] = subComponents[5];
		components[9] = subComponents[6];
		components[10] = subComponents[7];
		components[12] = subComponents[8];
		components[13] = subComponents[9];
		components[14] = subComponents[10];
		components[15] = subComponents[11];
		components[16] = subComponents[12];
		components[17] = subComponents[13];
		components[18] = subComponents[14];
		components[19] = subComponents[15];
		components[20] = subComponents[16];
		components[21] = subComponents[17];
		components[22] = subComponents[18];
		components[23] = subComponents[19];
		components[1] = null;
		components[2] = null;
		components[6] = null;
		components[11] = null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.message.ADT_A05 type = (hl7.model.V2_6.message.ADT_A05)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.message.ADT_A05 type = (hl7.model.V2_4.message.ADT_A05)this;

...
public class EHC_E13 extends hl7.model.V2_6.message.EHC_E13{
	...
	static{
		...
		standard[5]=hl7.pseudo.segment.RFI.CLASS;
		standard[6]=hl7.pseudo.segment.CTD.CLASS;
		standard[7]=hl7.pseudo.segment.IVC.CLASS;
		standard[8]=hl7.pseudo.segment.PSS.CLASS;
		standard[9]=hl7.pseudo.segment.PSG.CLASS;
		standard[10]=hl7.pseudo.segment.PID.CLASS;
		standard[11]=hl7.pseudo.segment.PSL.CLASS;
		standard[12]=hl7.pseudo.group.REQUEST_EHC_E13.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.message.EHC_E13 type = (hl7.model.V2_6.message.EHC_E13)this;

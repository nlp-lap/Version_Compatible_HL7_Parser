...
public class MOP extends hl7.model.V2_6.datastructure.MOP{
	...
	public static final String MONETARY_DENOMINATION = "Monetary  Denomination";
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0148.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_7.table.Table0913.getInstance();
		
		descriptions[0]=MONEY_OR_PERCENTAGE_INDICATOR;
		descriptions[1]=MONEY_OR_PERCENTAGE_QUANTITY;
		descriptions[2]=MONETARY_DENOMINATION;

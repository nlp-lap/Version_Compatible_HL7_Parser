...
public class CNN extends hl7.model.V2_6.datastructure.CNN{
	...
	static{
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_7.table.Table0360.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0297.getInstance();
		tables[8]=hl7.model.V2_7.table.Table0363.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_7.table.Table0301.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.datastructure.CNN type = (hl7.model.V2_6.datastructure.CNN)this;

...
public class PL extends hl7.model.V2_6.datastructure.PL{
	...
	public static final String PERSON_LOCATION_TYPE = "Person Location Type";
	public static final String BUILDING = "Building";
	public static final String FLOOR = "Floor";
	public static final String LOCATION_DESCRIPTION = "Location Description";
	public static final String COMPREHENSIVE_LOCATION_IDENTIFIER = "Comprehensive Location Identifier";
	public static final String ASSIGNING_AUTHORITY_FOR_LOCATION = "Assigning Authority for Location";
	...
	static{
		...
		standard[1]=hl7.pseudo.datastructure.HD.CLASS;
		...
		standard[6]=hl7.pseudo.datastructure.HD.CLASS;
		standard[7]=hl7.pseudo.datastructure.HD.CLASS;
		standard[8]=hl7.bean.datastructure.primitive.ST.CLASS;
		standard[9]=hl7.pseudo.datastructure.EI.CLASS;
		standard[10]=hl7.pseudo.datastructure.HD.CLASS;
		
		tables[0]=hl7.model.V2_7.table.Table0302.getInstance();
		tables[1]=hl7.model.V2_7.table.Table0303.getInstance();
		tables[2]=hl7.model.V2_7.table.Table0304.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_7.table.Table0306.getInstance();
		tables[5]=hl7.model.V2_7.table.Table0305.getInstance();
		tables[6]=hl7.model.V2_7.table.Table0307.getInstance();
		tables[7]=hl7.model.V2_7.table.Table0308.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_7.table.Table0363.getInstance();
		...
		descriptions[5]=PERSON_LOCATION_TYPE;
		descriptions[6]=BUILDING;
		descriptions[7]=FLOOR;
		descriptions[8]=LOCATION_DESCRIPTION;
		descriptions[9]=COMPREHENSIVE_LOCATION_IDENTIFIER;
		descriptions[10]=ASSIGNING_AUTHORITY_FOR_LOCATION;
	...
	public PL(){
		type = DataStructure.PL;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.PL data = new hl7.pseudo.datastructure.PL();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==0) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==1) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==2) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==6) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==7) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.datastructure.PL type = (hl7.model.V2_6.datastructure.PL)this;

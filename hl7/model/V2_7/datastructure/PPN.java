...
public class PPN extends hl7.model.V2_6.datastructure.PPN{
	...
	static{
		...
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_7.table.Table0465.getInstance();
		tables[16]=hl7.model.V2_7.table.Table0448.getInstance();
		tables[17]=null;
		tables[18]=hl7.model.V2_7.table.Table0444.getInstance();
		tables[19]=null;
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		tables[25]=hl7.model.V2_7.table.Table0904.getInstance();
		...
		descriptions[24]=SECURITY_CHECK;
		descriptions[25]=SECURITY_CHECK_SCHEME;
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==24) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==25) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;

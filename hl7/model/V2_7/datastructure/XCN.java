...
public class XCN extends hl7.model.V2_6.datastructure.XCN{
	public static final String VERSION = "2.7";
	public static final String PERSON_IDENTIFIER = "Person Identifier";
	...
	public static final String SECURITY_CHECK_SCHEME = "Security Check Scheme";
	...
	static{
		...
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_7.table.Table0297.getInstance();
		tables[8]=hl7.model.V2_7.table.Table0363.getInstance();
		tables[9]=hl7.model.V2_7.table.Table0200.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_7.table.Table0061.getInstance();
		tables[12]=hl7.model.V2_7.table.Table0203.getInstance();
		tables[13]=null;
		tables[14]=hl7.model.V2_7.table.Table0465.getInstance();
		tables[15]=hl7.model.V2_7.table.Table0448.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_7.table.Table0444.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		tables[24]=hl7.model.V2_7.table.Table0904.getInstance();
		
		descriptions[0]=PERSON_IDENTIFIER;
		...
		descriptions[14]=NAME_REPRESENTATION_CODE;
		descriptions[15]=NAME_CONTEXT;
		descriptions[16]=NAME_VALIDITY_RANGE;
		descriptions[17]=NAME_ASSEMBLY_ORDER;
		descriptions[18]=EFFECTIVE_DATE;
		descriptions[19]=EXPIRATION_DATE;
		descriptions[20]=PROFESSIONAL_SUFFIX;
		descriptions[21]=ASSIGNING_JURISDICTION;
		descriptions[22]=ASSIGNING_AGENCY_OR_DEPARTMENT;
		descriptions[23]=SECURITY_CHECK;
		descriptions[24]=SECURITY_CHECK_SCHEME;
		...
		length[23]=2147483647;
		length[24]=3;
	}
	
	public XCN(){
		type = DataStructure.XCN;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.XCN data = new hl7.pseudo.datastructure.XCN();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==23) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==24) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==7) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_6.datastructure.XCN type = (hl7.model.V2_6.datastructure.XCN)this;

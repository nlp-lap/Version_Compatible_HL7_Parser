...
public class ICD extends hl7.model.V2_6.datastructure.ICD{
	...
	static{
		...
		tables[0]=hl7.model.V2_7.table.Table0150.getInstance();
		tables[1]=hl7.model.V2_7.table.Table0136.getInstance();
		tables[2]=null;

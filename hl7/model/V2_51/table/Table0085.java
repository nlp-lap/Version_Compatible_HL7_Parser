...
public class Table0085 extends Table{
	...
	private Table0085(){
		...
		putMap("U", "Results status change to final without retransmitting results already sent as a??preliminary.'  E.g., radiology changes status from preliminary to final");

...
public class Table0356 extends Table{
	...
	private Table0356(){
		...
		putMap("2.3", "The character set switching mode specified in HL7 2.5, section 2.7.2, a??Escape sequences supporting multiple character setsa?? and section 2.A.46, XPN - extended person name.");

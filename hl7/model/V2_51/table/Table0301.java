...
public class Table0301 extends Table{
	...
	private Table0301(){
		...
		putMap("Random", "Usually a base64 encoded string of random bits.<p>The uniqueness depends on the length of the bits. Mail systems often generate ASCII string a??unique names, from a combination of random bits and system names. Obviously, such identifiers will not be cons");

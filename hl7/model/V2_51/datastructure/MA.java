...
public class MA extends hl7.model.V2_5.datastructure.MA{
	public static final String VERSION = "2.5.1";
	public static final String SAMPLE_1_FROM_CHANNEL_1 = "Sample 1 From Channel 1";
	public static final String SAMPLE_1_FROM_CHANNEL_2 = "Sample 1 From Channel 2";
	public static final String SAMPLE_1_FROM_CHANNEL_N = "Sample 1 From Channel N";
	public static final String SAMPLE_2_FROM_CHANNEL_1 = "Sample 2 From Channel 1";
	public static final String SAMPLE_2_FROM_CHANNEL_N = "Sample 2 From Channel N";
	public static final String SAMPLE_N_FROM_CHANNEL_N = "Sample N From Channel N";
	...
	static{
		...
		descriptions[0]=SAMPLE_1_FROM_CHANNEL_1;
		descriptions[1]=SAMPLE_1_FROM_CHANNEL_2;
		descriptions[2]=SAMPLE_1_FROM_CHANNEL_N;
		descriptions[3]=SAMPLE_2_FROM_CHANNEL_1;
		descriptions[4]=SAMPLE_2_FROM_CHANNEL_N;
		descriptions[5]=SAMPLE_N_FROM_CHANNEL_N;
	...
	public MA(){
		type = DataStructure.MA;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.MA data = new hl7.pseudo.datastructure.MA();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.datastructure.MA type = (hl7.model.V2_5.datastructure.MA)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.datastructure.MA type = (hl7.model.V2_6.datastructure.MA)this;

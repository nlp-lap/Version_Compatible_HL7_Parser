...
public class CP extends hl7.model.V2_5.datastructure.CP{
	public static final String VERSION = "2.5.1";
	public static final String PRICE = "Price";
	public static final String PRICE_TYPE = "Price Type";
	public static final String FROM_VALUE = "From Value";
	public static final String TO_VALUE = "To Value";
	public static final String RANGE_UNITS = "Range Units";
	public static final String RANGE_TYPE = "Range Type";
	...
	static{
		standard[0]=hl7.pseudo.datastructure.MO.CLASS;
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0205.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_51.table.Table0298.getInstance();
		
		descriptions[0]=PRICE;
		descriptions[1]=PRICE_TYPE;
		descriptions[2]=FROM_VALUE;
		descriptions[3]=TO_VALUE;
		descriptions[4]=RANGE_UNITS;
		descriptions[5]=RANGE_TYPE;
	...
	public CP(){
		type = DataStructure.CP;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.CP data = new hl7.pseudo.datastructure.CP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.datastructure.CP type = (hl7.model.V2_5.datastructure.CP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.datastructure.CP type = (hl7.model.V2_6.datastructure.CP)this;

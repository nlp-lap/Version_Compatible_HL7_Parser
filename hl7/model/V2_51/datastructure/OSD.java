...
public class OSD extends hl7.model.V2_5.datastructure.OSD{
	public static final String VERSION = "2.5.1";
	public static final String SEQUENCE_RESULTS_FLAG = "Sequence/Results Flag";
	public static final String PLACER_ORDER_NUMBER_ENTITY_IDENTIFIER = "Placer Order Number: Entity Identifier";
	public static final String PLACER_ORDER_NUMBER_NAMESPACE_ID = "Placer Order Number: Namespace ID";
	public static final String FILLER_ORDER_NUMBER_ENTITY_IDENTIFIER = "Filler Order Number: Entity Identifier";
	public static final String FILLER_ORDER_NUMBER_NAMESPACE_ID = "Filler Order Number: Namespace ID";
	public static final String SEQUENCE_CONDITION_VALUE = "Sequence Condition Value";
	public static final String MAXIMUM_NUMBER_OF_REPEATS = "Maximum Number of Repeats";
	public static final String PLACER_ORDER_NUMBER_UNIVERSAL_ID = "Placer Order Number: Universal ID";
	public static final String PLACER_ORDER_NUMBER_UNIVERSAL_ID_TYPE = "Placer Order Number: Universal ID Type";
	public static final String FILLER_ORDER_NUMBER_UNIVERSAL_ID = "Filler Order Number: Universal ID";
	public static final String FILLER_ORDER_NUMBER_UNIVERSAL_ID_TYPE = "Filler Order Number: Universal ID Type";
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0524.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_51.table.Table0363.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_51.table.Table0363.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0301.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0301.getInstance();
		
		descriptions[0]=SEQUENCE_RESULTS_FLAG;
		descriptions[1]=PLACER_ORDER_NUMBER_ENTITY_IDENTIFIER;
		descriptions[2]=PLACER_ORDER_NUMBER_NAMESPACE_ID;
		descriptions[3]=FILLER_ORDER_NUMBER_ENTITY_IDENTIFIER;
		descriptions[4]=FILLER_ORDER_NUMBER_NAMESPACE_ID;
		descriptions[5]=SEQUENCE_CONDITION_VALUE;
		descriptions[6]=MAXIMUM_NUMBER_OF_REPEATS;
		descriptions[7]=PLACER_ORDER_NUMBER_UNIVERSAL_ID;
		descriptions[8]=PLACER_ORDER_NUMBER_UNIVERSAL_ID_TYPE;
		descriptions[9]=FILLER_ORDER_NUMBER_UNIVERSAL_ID;
		descriptions[10]=FILLER_ORDER_NUMBER_UNIVERSAL_ID_TYPE;
	...
	public OSD(){
		type = DataStructure.OSD;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.OSD data = new hl7.pseudo.datastructure.OSD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.datastructure.OSD type = (hl7.model.V2_5.datastructure.OSD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.datastructure.OSD type = (hl7.model.V2_6.datastructure.OSD)this;

...
public class VID extends hl7.model.V2_5.datastructure.VID{
	public static final String VERSION = "2.5.1";
	public static final String VERSION_ID = "Version ID";
	public static final String INTERNATIONALIZATION_CODE = "Internationalization Code";
	public static final String INTERNATIONAL_VERSION_ID = "International Version ID";
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0104.getInstance();
		tables[1]=hl7.model.V2_51.table.Table0399.getInstance();
		tables[2]=null;
		
		descriptions[0]=VERSION_ID;
		descriptions[1]=INTERNATIONALIZATION_CODE;
		descriptions[2]=INTERNATIONAL_VERSION_ID;
	...
	public VID(){
		type = DataStructure.VID;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.VID data = new hl7.pseudo.datastructure.VID();
	...
	public static void backward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, String prevVersion, int depth) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			if(i==2) components[i] = (subComponents[i]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.datastructure.VID type = (hl7.model.V2_5.datastructure.VID)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.datastructure.VID type = (hl7.model.V2_6.datastructure.VID)this;

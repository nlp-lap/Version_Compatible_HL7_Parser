...
public class RQ1 extends hl7.model.V2_5.segment.RQ1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0385.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		...
		descriptions[0]="ANTICIPATED_PRICE";
		descriptions[1]="MANUFACTURER_IDENTIFIER";
		descriptions[2]="MANUFACTURERS_CATALOG";
		descriptions[3]="VENDOR_ID";
		descriptions[4]="VENDOR_CATALOG";
		descriptions[5]="TAXABLE";
		descriptions[6]="SUBSTITUTE_ALLOWED";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.RQ1 seg = new hl7.pseudo.segment.RQ1();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.RQ1 type = (hl7.model.V2_5.segment.RQ1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.RQ1 type = (hl7.model.V2_6.segment.RQ1)this;

...
public class ABS extends hl7.model.V2_5.segment.ABS{
	...
	static{
		standard[0]=hl7.pseudo.datastructure.XCN.CLASS;
		...
		tables[0]=hl7.model.V2_51.table.Table0010.getInstance();
		tables[1]=hl7.model.V2_51.table.Table0069.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0421.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_51.table.Table0422.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0423.getInstance();
		tables[9]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[10]=hl7.model.V2_51.table.Table0424.getInstance();
		tables[11]=null;
		tables[12]=hl7.model.V2_51.table.Table0425.getInstance();
		tables[13]=hl7.model.V2_51.table.Table0136.getInstance();
		
		descriptions[0]="DISCHARGE_CARE_PROVIDER";
		descriptions[1]="TRANSFER_MEDICAL_SERVICE_CODE";
		descriptions[2]="SEVERITY_OF_ILLNESS_CODE";
		descriptions[3]="DATE_TIME_OF_ATTESTATION";
		descriptions[4]="ATTESTED_BY";
		descriptions[5]="TRIAGE_CODE";
		descriptions[6]="ABSTRACT_COMPLETION_DATE_TIME";
		descriptions[7]="ABSTRACTED_BY";
		descriptions[8]="CASE_CATEGORY_CODE";
		descriptions[9]="CAESARIAN_SECTION_INDICATOR";
		descriptions[10]="GESTATION_CATEGORY_CODE";
		descriptions[11]="GESTATION_PERIOD_WEEKS";
		descriptions[12]="NEWBORN_CODE";
		descriptions[13]="STILLBORN_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ABS seg = new hl7.pseudo.segment.ABS();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.ABS type = (hl7.model.V2_5.segment.ABS)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.ABS type = (hl7.model.V2_6.segment.ABS)this;

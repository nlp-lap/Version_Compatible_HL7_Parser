...
public class AUT extends hl7.model.V2_5.segment.AUT{
	...
	static{
		...
		standard[9]=hl7.bean.datastructure.primitive.TS.CLASS;
		
		tables[0]=hl7.model.V2_51.table.Table0072.getInstance();
		tables[1]=hl7.model.V2_51.table.Table0285.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		descriptions[0]="AUTHORIZING_PAYOR_PLAN_ID";
		descriptions[1]="AUTHORIZING_PAYOR_COMPANY_ID";
		descriptions[2]="AUTHORIZING_PAYOR_COMPANY_NAME";
		descriptions[3]="AUTHORIZATION_EFFECTIVE_DATE";
		descriptions[4]="AUTHORIZATION_EXPIRATION_DATE";
		descriptions[5]="AUTHORIZATION_IDENTIFIER";
		descriptions[6]="REIMBURSEMENT_LIMIT";
		descriptions[7]="REQUESTED_NUMBER_OF_TREATMENTS";
		descriptions[8]="AUTHORIZED_NUMBER_OF_TREATMENTS";
		descriptions[9]="PROCESS_DATE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.AUT seg = new hl7.pseudo.segment.AUT();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==9) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.AUT type = (hl7.model.V2_5.segment.AUT)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.AUT type = (hl7.model.V2_6.segment.AUT)this;

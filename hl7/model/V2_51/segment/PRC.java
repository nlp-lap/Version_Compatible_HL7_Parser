...
public class PRC extends hl7.model.V2_5.segment.PRC{
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0132.getInstance();
		tables[1]=hl7.model.V2_51.table.Table0464.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0184.getInstance();
		tables[3]=hl7.model.V2_51.table.Table0004.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		...
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_51.table.Table0268.getInstance();
		tables[13]=hl7.model.V2_51.table.Table0293.getInstance();
		tables[14]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[15]=hl7.model.V2_51.table.Table0183.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_51.table.Table0269.getInstance();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==10) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.PRC type = (hl7.model.V2_5.segment.PRC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.PRC type = (hl7.model.V2_6.segment.PRC)this;

...
public class PCR extends hl7.model.V2_5.segment.PCR{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0249.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0244.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0245.getInstance();
		tables[11]=null;
		tables[12]=hl7.model.V2_51.table.Table0246.getInstance();
		tables[13]=null;
		tables[14]=hl7.model.V2_51.table.Table0247.getInstance();
		tables[15]=null;
		tables[16]=hl7.model.V2_51.table.Table0248.getInstance();
		tables[17]=null;
		tables[18]=hl7.model.V2_51.table.Table0242.getInstance();
		tables[19]=hl7.model.V2_51.table.Table0250.getInstance();
		tables[20]=hl7.model.V2_51.table.Table0251.getInstance();
		tables[21]=hl7.model.V2_51.table.Table0252.getInstance();
		tables[22]=hl7.model.V2_51.table.Table0253.getInstance();
		
		descriptions[0]="IMPLICATED_PRODUCT";
		descriptions[1]="GENERIC_PRODUCT";
		descriptions[2]="PRODUCT_CLASS";
		descriptions[3]="TOTAL_DURATION_OF_THERAPY";
		descriptions[4]="PRODUCT_MANUFACTURE_DATE";
		descriptions[5]="PRODUCT_EXPIRATION_DATE";
		descriptions[6]="PRODUCT_IMPLANTATION_DATE";
		descriptions[7]="PRODUCT_EXPLANTATION_DATE";
		descriptions[8]="SINGLE_USE_DEVICE";
		descriptions[9]="INDICATION_FOR_PRODUCT_USE";
		descriptions[10]="PRODUCT_PROBLEM";
		descriptions[11]="PRODUCT_SERIAL_LOT_NUMBER";
		descriptions[12]="PRODUCT_AVAILABLE_FOR_INSPECTION";
		descriptions[13]="PRODUCT_EVALUATION_PERFORMED";
		descriptions[14]="PRODUCT_EVALUATION_STATUS";
		descriptions[15]="PRODUCT_EVALUATION_RESULTS";
		descriptions[16]="EVALUATED_PRODUCT_SOURCE";
		descriptions[17]="DATE_PRODUCT_RETURNED_TO_MANUFACTURER";
		descriptions[18]="DEVICE_OPERATOR_QUALIFICATIONS";
		descriptions[19]="RELATEDNESS_ASSESSMENT";
		descriptions[20]="ACTION_TAKEN_IN_RESPONSE_TO_THE_EVENT";
		descriptions[21]="EVENT_CAUSALITY_OBSERVATIONS";
		descriptions[22]="INDIRECT_EXPOSURE_MECHANISM";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PCR seg = new hl7.pseudo.segment.PCR();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==4) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.PCR type = (hl7.model.V2_5.segment.PCR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.PCR type = (hl7.model.V2_6.segment.PCR)this;

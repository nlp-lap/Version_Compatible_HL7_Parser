...
public class OM3 extends hl7.model.V2_5.segment.OM3{
	...
	static{
		...
		tables[2]=hl7.model.V2_51.table.Table9999.getInstance();
		...
		tables[6]=hl7.model.V2_51.table.Table0125.getInstance();
		
		descriptions[0]="SEQUENCE_NUMBER_TEST_OBSERVATION_MASTER_FILE";
		descriptions[1]="PREFERRED_CODING_SYSTEM";
		descriptions[2]="VALID_CODED_ANSWERS";
		descriptions[3]="NORMAL_TEXT_CODES_FOR_CATEGORICAL_OBSERVATIONS";
		descriptions[4]="ABNORMAL_TEXT_CODES_FOR_CATEGORICAL_OBSERVATIONS";
		descriptions[5]="CRITICAL_TEXT_CODES_FOR_CATEGORICAL_OBSERVATIONS";
		descriptions[6]="VALUE_TYPE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.OM3 seg = new hl7.pseudo.segment.OM3();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.OM3 type = (hl7.model.V2_5.segment.OM3)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.OM3 type = (hl7.model.V2_6.segment.OM3)this;

...
public class QRF extends hl7.model.V2_5.segment.QRF{
	...
	static{
		...
		descriptions[0]="WHERE_SUBJECT_FILTER";
		descriptions[1]="WHEN_DATA_START_DATE_TIME";
		descriptions[2]="WHEN_DATA_END_DATE_TIME";
		descriptions[3]="WHAT_USER_QUALIFIER";
		descriptions[4]="OTHER_QRY_SUBJECT_FILTER";
		descriptions[5]="WHICH_DATE_TIME_QUALIFIER";
		descriptions[6]="WHICH_DATE_TIME_STATUS_QUALIFIER";
		descriptions[7]="DATE_TIME_SELECTION_QUALIFIER";
		descriptions[8]="WHEN_QUANTITY_TIMING_QUALIFIER";
		descriptions[9]="SEARCH_CONFIDENCE_THRESHOLD";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.QRF seg = new hl7.pseudo.segment.QRF();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.QRF type = (hl7.model.V2_5.segment.QRF)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.QRF type = (hl7.model.V2_6.segment.QRF)this;

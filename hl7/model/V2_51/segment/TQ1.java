...
public class TQ1 extends hl7.model.V2_5.segment.TQ1{
	...
	static{
		...
		standard[1]=hl7.pseudo.datastructure.CQ.CLASS;
		standard[2]=hl7.pseudo.datastructure.RPT.CLASS;
		standard[3]=hl7.bean.datastructure.primitive.TM.CLASS;
		...
		standard[10]=hl7.bean.datastructure.primitive.TX.CLASS;
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_51.table.Table0335.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0485.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_51.table.Table0427.getInstance();
		tables[12]=null;
		tables[13]=null;
		
		descriptions[0]="SET_ID_TQ1";
		descriptions[1]="QUANTITY";
		descriptions[2]="REPEAT_PATTERN";
		descriptions[3]="EXPLICIT_TIME";
		descriptions[4]="RELATIVE_TIME_AND_UNITS";
		descriptions[5]="SERVICE_DURATION";
		descriptions[6]="START_DATE_TIME";
		descriptions[7]="END_DATE_TIME";
		descriptions[8]="PRIORITY";
		descriptions[9]="CONDITION_TEXT";
		descriptions[10]="TEXT_INSTRUCTION";
		descriptions[11]="CONJUNCTION";
		descriptions[12]="OCCURRENCE_DURATION";
		descriptions[13]="TOTAL_OCCURRENCES";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.TQ1 seg = new hl7.pseudo.segment.TQ1();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.TQ1 type = (hl7.model.V2_5.segment.TQ1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.TQ1 type = (hl7.model.V2_6.segment.TQ1)this;

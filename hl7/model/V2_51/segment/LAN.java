...
public class LAN extends hl7.model.V2_5.segment.LAN{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0296.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0403.getInstance();
		tables[3]=hl7.model.V2_51.table.Table0404.getInstance();
		
		descriptions[0]="SET_ID_LAN";
		descriptions[1]="LANGUAGE_CODE";
		descriptions[2]="LANGUAGE_ABILITY_CODE";
		descriptions[3]="LANGUAGE_PROFICIENCY_CODE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.LAN seg = new hl7.pseudo.segment.LAN();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.LAN type = (hl7.model.V2_5.segment.LAN)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.LAN type = (hl7.model.V2_6.segment.LAN)this;

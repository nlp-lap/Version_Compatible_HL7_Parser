...
public class STF extends hl7.model.V2_5.segment.STF{
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table9999.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_51.table.Table0182.getInstance();
		tables[4]=hl7.model.V2_51.table.Table0001.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_51.table.Table0183.getInstance();
		tables[7]=hl7.model.V2_51.table.Table0184.getInstance();
		tables[8]=hl7.model.V2_51.table.Table0069.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_51.table.Table0537.getInstance();
		tables[12]=hl7.model.V2_51.table.Table0537.getInstance();
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_51.table.Table0185.getInstance();
		tables[16]=hl7.model.V2_51.table.Table0002.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_51.table.Table0066.getInstance();
		tables[20]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[21]=null;
		tables[22]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[23]=null;
		tables[24]=null;
		tables[25]=null;
		tables[26]=hl7.model.V2_51.table.Table0005.getInstance();
		tables[27]=hl7.model.V2_51.table.Table0189.getInstance();
		tables[28]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[29]=hl7.model.V2_51.table.Table0171.getInstance();
		tables[30]=null;
		tables[31]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[32]=hl7.model.V2_51.table.Table0538.getInstance();
		tables[33]=null;
		tables[34]=null;
		tables[35]=hl7.model.V2_51.table.Table0539.getInstance();
		tables[36]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[37]=hl7.model.V2_51.table.Table0540.getInstance();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==5) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==30) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==0) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.STF type = (hl7.model.V2_6.segment.STF)this;

...
public class RXR extends hl7.model.V2_5.segment.RXR{
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0162.getInstance();
		tables[1]=hl7.model.V2_51.table.Table0163.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0164.getInstance();
		tables[3]=hl7.model.V2_51.table.Table0165.getInstance();
		tables[4]=null;
		tables[5]=hl7.model.V2_51.table.Table0495.getInstance();
		...
		descriptions[5]="ADMINISTRATION_SITE_MODIFIER";
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.RXR type = (hl7.model.V2_6.segment.RXR)this;

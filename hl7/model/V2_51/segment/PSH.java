...
public class PSH extends hl7.model.V2_5.segment.PSH{
	...
	static{
		...
		standard[11]=hl7.bean.datastructure.primitive.FT.CLASS;
		...
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_51.table.Table0329.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0329.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		
		descriptions[0]="REPORT_TYPE";
		descriptions[1]="REPORT_FORM_IDENTIFIER";
		descriptions[2]="REPORT_DATE";
		descriptions[3]="REPORT_INTERVAL_START_DATE";
		descriptions[4]="REPORT_INTERVAL_END_DATE";
		descriptions[5]="QUANTITY_MANUFACTURED";
		descriptions[6]="QUANTITY_DISTRIBUTED";
		descriptions[7]="QUANTITY_DISTRIBUTED_METHOD";
		descriptions[8]="QUANTITY_DISTRIBUTED_COMMENT";
		descriptions[9]="QUANTITY_IN_USE";
		descriptions[10]="QUANTITY_IN_USE_METHOD";
		descriptions[11]="QUANTITY_IN_USE_COMMENT";
		descriptions[12]="NUMBER_OF_PRODUCT_EXPERIENCE_REPORTS_FILED_BY_FACILITY";
		descriptions[13]="NUMBER_OF_PRODUCT_EXPERIENCE_REPORTS_FILED_BY_DISTRIBUTOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PSH seg = new hl7.pseudo.segment.PSH();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.PSH type = (hl7.model.V2_5.segment.PSH)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.PSH type = (hl7.model.V2_6.segment.PSH)this;

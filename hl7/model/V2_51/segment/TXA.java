...
public class TXA extends hl7.model.V2_5.segment.TXA{
	...
	static{
		...
		standard[3]=hl7.bean.datastructure.primitive.TS.CLASS;
		...
		standard[13]=hl7.pseudo.datastructure.EI.CLASS;
		standard[14]=hl7.pseudo.datastructure.EI.CLASS;
		...
		standard[21]=hl7.pseudo.datastructure.PPN.CLASS;
		standard[22]=hl7.pseudo.datastructure.XCN.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0270.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0191.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		...
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_51.table.Table0271.getInstance();
		tables[17]=hl7.model.V2_51.table.Table0272.getInstance();
		tables[18]=hl7.model.V2_51.table.Table0273.getInstance();
		tables[19]=hl7.model.V2_51.table.Table0275.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		
		descriptions[0]="SET_ID_TXA";
		descriptions[1]="DOCUMENT_TYPE";
		descriptions[2]="DOCUMENT_CONTENT_PRESENTATION";
		descriptions[3]="ACTIVITY_DATE_TIME";
		descriptions[4]="PRIMARY_ACTIVITY_PROVIDER_CODE_NAME";
		descriptions[5]="ORIGINATION_DATE_TIME";
		descriptions[6]="TRANSCRIPTION_DATE_TIME";
		descriptions[7]="EDIT_DATE_TIME";
		descriptions[8]="ORIGINATOR_CODE_NAME";
		descriptions[9]="ASSIGNED_DOCUMENT_AUTHENTICATOR";
		descriptions[10]="TRANSCRIPTIONIST_CODE_NAME";
		descriptions[11]="UNIQUE_DOCUMENT_NUMBER";
		descriptions[12]="PARENT_DOCUMENT_NUMBER";
		descriptions[13]="PLACER_ORDER_NUMBER";
		descriptions[14]="FILLER_ORDER_NUMBER";
		descriptions[15]="UNIQUE_DOCUMENT_FILE_NAME";
		descriptions[16]="DOCUMENT_COMPLETION_STATUS";
		descriptions[17]="DOCUMENT_CONFIDENTIALITY_STATUS";
		descriptions[18]="DOCUMENT_AVAILABILITY_STATUS";
		descriptions[19]="DOCUMENT_STORAGE_STATUS";
		descriptions[20]="DOCUMENT_CHANGE_REASON";
		descriptions[21]="AUTHENTICATION_PERSON_TIME_STAMP";
		descriptions[22]="DISTRIBUTED_COPIES";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.TXA seg = new hl7.pseudo.segment.TXA();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==3) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.TXA type = (hl7.model.V2_5.segment.TXA)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.TXA type = (hl7.model.V2_6.segment.TXA)this;

...
public class PRA extends hl7.model.V2_5.segment.PRA{
	...
	static{
		...
		tables[1]=hl7.model.V2_51.table.Table0358.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0186.getInstance();
		tables[3]=hl7.model.V2_51.table.Table0187.getInstance();
		tables[4]=hl7.model.V2_51.table.Table0337.getInstance();
		tables[5]=hl7.model.V2_51.table.Table0338.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0537.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0401.getInstance();
		tables[11]=null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.PRA type = (hl7.model.V2_6.segment.PRA)this;

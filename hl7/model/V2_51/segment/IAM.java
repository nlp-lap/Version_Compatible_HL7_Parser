...
public class IAM extends hl7.model.V2_5.segment.IAM{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0127.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_51.table.Table0128.getInstance();
		tables[4]=null;
		tables[5]=hl7.model.V2_51.table.Table0323.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0436.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_51.table.Table0063.getInstance();
		tables[15]=hl7.model.V2_51.table.Table0437.getInstance();
		tables[16]=hl7.model.V2_51.table.Table0438.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.IAM type = (hl7.model.V2_5.segment.IAM)this;

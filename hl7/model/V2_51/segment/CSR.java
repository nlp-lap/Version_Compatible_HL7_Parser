...
public class CSR extends hl7.model.V2_5.segment.CSR{
	...
	static{
		...
		descriptions[0]="SPONSOR_STUDY_ID";
		descriptions[1]="ALTERNATE_STUDY_ID";
		descriptions[2]="INSTITUTION_REGISTERING_THE_PATIENT";
		descriptions[3]="SPONSOR_PATIENT_ID";
		descriptions[4]="ALTERNATE_PATIENT_ID_CSR";
		descriptions[5]="DATE_TIME_OF_PATIENT_STUDY_REGISTRATION";
		descriptions[6]="PERSON_PERFORMING_STUDY_REGISTRATION";
		descriptions[7]="STUDY_AUTHORIZING_PROVIDER";
		descriptions[8]="DATE_TIME_PATIENT_STUDY_CONSENT_SIGNED";
		descriptions[9]="PATIENT_STUDY_ELIGIBILITY_STATUS";
		descriptions[10]="STUDY_RANDOMIZATION_DATE_TIME";
		descriptions[11]="RANDOMIZED_STUDY_ARM";
		descriptions[12]="STRATUM_FOR_STUDY_RANDOMIZATION";
		descriptions[13]="PATIENT_EVALUABILITY_STATUS";
		descriptions[14]="DATE_TIME_ENDED_STUDY";
		descriptions[15]="REASON_ENDED_STUDY";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.CSR seg = new hl7.pseudo.segment.CSR();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.CSR type = (hl7.model.V2_5.segment.CSR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.CSR type = (hl7.model.V2_6.segment.CSR)this;

...
public class BPO extends hl7.model.V2_5.segment.BPO{
	...
	static{
		...
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_51.table.Table0509.getInstance();
		tables[13]=hl7.model.V2_51.table.Table0136.getInstance();
		
		descriptions[0]="SET_ID_BPO";
		descriptions[1]="BP_UNIVERSAL_SERVICE_ID";
		descriptions[2]="BP_PROCESSING_REQUIREMENTS";
		descriptions[3]="BP_QUANTITY";
		descriptions[4]="BP_AMOUNT";
		descriptions[5]="BP_UNITS";
		descriptions[6]="BP_INTENDED_USE_DATE_TIME";
		descriptions[7]="BP_INTENDED_DISPENSE_FROM_LOCATION";
		descriptions[8]="BP_INTENDED_DISPENSE_FROM_ADDRESS";
		descriptions[9]="BP_REQUESTED_DISPENSE_DATE_TIME";
		descriptions[10]="BP_REQUESTED_DISPENSE_TO_LOCATION";
		descriptions[11]="BP_REQUESTED_DISPENSE_TO_ADDRESS";
		descriptions[12]="BP_INDICATION_FOR_USE";
		descriptions[13]="BP_INFORMED_CONSENT_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.BPO seg = new hl7.pseudo.segment.BPO();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.BPO type = (hl7.model.V2_5.segment.BPO)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.BPO type = (hl7.model.V2_6.segment.BPO)this;

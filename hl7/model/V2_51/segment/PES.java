...
public class PES extends hl7.model.V2_5.segment.PES{
	...
	static{
		standard[0]=hl7.pseudo.datastructure.XON.CLASS;
		standard[1]=hl7.pseudo.datastructure.XCN.CLASS;
		standard[2]=hl7.pseudo.datastructure.XAD.CLASS;
		standard[3]=hl7.pseudo.datastructure.XTN.CLASS;
		...
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0234.getInstance();
		tables[11]=hl7.model.V2_51.table.Table0235.getInstance();
		tables[12]=hl7.model.V2_51.table.Table0236.getInstance();
		
		descriptions[0]="SENDER_ORGANIZATION_NAME";
		descriptions[1]="SENDER_INDIVIDUAL_NAME";
		descriptions[2]="SENDER_ADDRESS";
		descriptions[3]="SENDER_TELEPHONE";
		descriptions[4]="SENDER_EVENT_IDENTIFIER";
		descriptions[5]="SENDER_SEQUENCE_NUMBER";
		descriptions[6]="SENDER_EVENT_DESCRIPTION";
		descriptions[7]="SENDER_COMMENT";
		descriptions[8]="SENDER_AWARE_DATE_TIME";
		descriptions[9]="EVENT_REPORT_DATE";
		descriptions[10]="EVENT_REPORT_TIMING_TYPE";
		descriptions[11]="EVENT_REPORT_SOURCE";
		descriptions[12]="EVENT_REPORTED_TO";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PES seg = new hl7.pseudo.segment.PES();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.PES type = (hl7.model.V2_5.segment.PES)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.PES type = (hl7.model.V2_6.segment.PES)this;

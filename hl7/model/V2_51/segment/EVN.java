...
public class EVN extends hl7.model.V2_5.segment.EVN{
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0003.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_51.table.Table0062.getInstance();
		tables[4]=hl7.model.V2_51.table.Table0188.getInstance();
		tables[5]=null;
		tables[6]=null;
		
		descriptions[0]="EVENT_TYPE_CODE";
		descriptions[1]="RECORDED_DATE_TIME";
		descriptions[2]="DATE_TIME_PLANNED_EVENT";
		descriptions[3]="EVENT_REASON_CODE";
		descriptions[4]="OPERATOR_ID";
		descriptions[5]="EVENT_OCCURRED";
		descriptions[6]="EVENT_FACILITY";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.EVN seg = new hl7.pseudo.segment.EVN();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.EVN type = (hl7.model.V2_5.segment.EVN)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.EVN type = (hl7.model.V2_6.segment.EVN)this;

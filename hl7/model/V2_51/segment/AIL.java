...
public class AIL extends hl7.model.V2_5.segment.AIL{
	...
	static{
		...
		tables[2]=null;
		tables[3]=hl7.model.V2_51.table.Table0305.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0279.getInstance();
		tables[11]=hl7.model.V2_51.table.Table0278.getInstance();
		
		descriptions[0]="SET_ID_AIL";
		descriptions[1]="SEGMENT_ACTION_CODE";
		descriptions[2]="LOCATION_RESOURCE_ID";
		descriptions[3]="LOCATION_TYPE_AIL";
		descriptions[4]="LOCATION_GROUP";
		descriptions[5]="START_DATE_TIME";
		descriptions[6]="START_DATE_TIME_OFFSET";
		descriptions[7]="START_DATE_TIME_OFFSET_UNITS";
		descriptions[8]="DURATION";
		descriptions[9]="DURATION_UNITS";
		descriptions[10]="ALLOW_SUBSTITUTION_CODE";
		descriptions[11]="FILLER_STATUS_CODE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.AIL seg = new hl7.pseudo.segment.AIL();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.AIL type = (hl7.model.V2_5.segment.AIL)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.AIL type = (hl7.model.V2_6.segment.AIL)this;

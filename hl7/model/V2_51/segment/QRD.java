...
public class QRD extends hl7.model.V2_5.segment.QRD{
	...
	static{
		...
		standard[10]=hl7.pseudo.datastructure.VR.CLASS;
		standard[11]=hl7.bean.datastructure.primitive.ID.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0106.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0091.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_51.table.Table0107.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_51.table.Table0126.getInstance();
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0048.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_51.table.Table0108.getInstance();
		...
		descriptions[10]="WHAT_DATA_CODE_VALUE_QUAL";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==0) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.QRD type = (hl7.model.V2_5.segment.QRD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.QRD type = (hl7.model.V2_6.segment.QRD)this;

...
public class TCD extends hl7.model.V2_5.segment.TCD{
	...
	static{
		...
		standard[1]=hl7.pseudo.datastructure.SN.CLASS;
		standard[2]=hl7.pseudo.datastructure.SN.CLASS;
		...
		tables[6]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[7]=hl7.model.V2_51.table.Table0389.getInstance();
		
		descriptions[0]="UNIVERSAL_SERVICE_IDENTIFIER";
		descriptions[1]="AUTO_DILUTION_FACTOR";
		descriptions[2]="RERUN_DILUTION_FACTOR";
		descriptions[3]="PRE_DILUTION_FACTOR";
		descriptions[4]="ENDOGENOUS_CONTENT_OF_PRE_DILUTION_DILUENT";
		descriptions[5]="AUTOMATIC_REPEAT_ALLOWED";
		descriptions[6]="REFLEX_ALLOWED";
		descriptions[7]="ANALYTE_REPEAT_STATUS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.TCD seg = new hl7.pseudo.segment.TCD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.TCD type = (hl7.model.V2_5.segment.TCD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.TCD type = (hl7.model.V2_6.segment.TCD)this;

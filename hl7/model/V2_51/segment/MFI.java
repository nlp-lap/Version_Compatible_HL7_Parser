...
public class MFI extends hl7.model.V2_5.segment.MFI{
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0175.getInstance();
		tables[1]=hl7.model.V2_51.table.Table0361.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0178.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_51.table.Table0179.getInstance();
		
		descriptions[0]="MASTER_FILE_IDENTIFIER";
		descriptions[1]="MASTER_FILE_APPLICATION_IDENTIFIER";
		descriptions[2]="FILE_LEVEL_EVENT_CODE";
		descriptions[3]="ENTERED_DATE_TIME";
		descriptions[4]="EFFECTIVE_DATE_TIME";
		descriptions[5]="RESPONSE_LEVEL_CODE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.MFI seg = new hl7.pseudo.segment.MFI();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.MFI type = (hl7.model.V2_5.segment.MFI)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.MFI type = (hl7.model.V2_6.segment.MFI)this;

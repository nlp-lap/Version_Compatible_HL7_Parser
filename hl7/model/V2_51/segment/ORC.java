...
public class ORC extends hl7.model.V2_5.segment.ORC{
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0119.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_51.table.Table0038.getInstance();
		tables[5]=hl7.model.V2_51.table.Table0121.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		...
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_51.table.Table0339.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		tables[25]=hl7.model.V2_51.table.Table0552.getInstance();
		tables[26]=null;
		tables[27]=hl7.model.V2_51.table.Table0177.getInstance();
		tables[28]=hl7.model.V2_51.table.Table0482.getInstance();
		tables[29]=hl7.model.V2_51.table.Table0483.getInstance();
		tables[30]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.ORC type = (hl7.model.V2_5.segment.ORC)this;

...
public class NK1 extends hl7.model.V2_5.segment.NK1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_51.table.Table0063.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_51.table.Table0131.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0327.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_51.table.Table0002.getInstance();
		tables[14]=hl7.model.V2_51.table.Table0001.getInstance();
		tables[15]=null;
		tables[16]=hl7.model.V2_51.table.Table0223.getInstance();
		tables[17]=hl7.model.V2_51.table.Table0009.getInstance();
		tables[18]=hl7.model.V2_51.table.Table0171.getInstance();
		tables[19]=hl7.model.V2_51.table.Table0296.getInstance();
		tables[20]=hl7.model.V2_51.table.Table0220.getInstance();
		tables[21]=hl7.model.V2_51.table.Table0215.getInstance();
		tables[22]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[23]=hl7.model.V2_51.table.Table0231.getInstance();
		tables[24]=hl7.model.V2_51.table.Table0006.getInstance();
		tables[25]=null;
		tables[26]=hl7.model.V2_51.table.Table0212.getInstance();
		tables[27]=hl7.model.V2_51.table.Table0189.getInstance();
		tables[28]=hl7.model.V2_51.table.Table0222.getInstance();
		tables[29]=null;
		tables[30]=null;
		tables[31]=null;
		tables[32]=null;
		tables[33]=hl7.model.V2_51.table.Table0311.getInstance();
		tables[34]=hl7.model.V2_51.table.Table0005.getInstance();
		tables[35]=hl7.model.V2_51.table.Table0295.getInstance();
		tables[36]=null;
		tables[37]=null;
		tables[38]=hl7.model.V2_51.table.Table0099.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.NK1 type = (hl7.model.V2_5.segment.NK1)this;

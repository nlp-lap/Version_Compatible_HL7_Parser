...
public class LDP extends hl7.model.V2_5.segment.LDP{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0264.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0069.getInstance();
		tables[3]=hl7.model.V2_51.table.Table0265.getInstance();
		tables[4]=hl7.model.V2_51.table.Table0004.getInstance();
		tables[5]=hl7.model.V2_51.table.Table0183.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_51.table.Table0267.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_51.table.Table0462.getInstance();
		...
		descriptions[11]="LOCATION_COST_CENTER";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.LDP type = (hl7.model.V2_5.segment.LDP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.LDP type = (hl7.model.V2_6.segment.LDP)this;

...
public class OBR extends hl7.model.V2_5.segment.OBR{
	...
	static{
		...
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0065.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		...
		tables[21]=null;
		tables[22]=null;
		tables[23]=hl7.model.V2_51.table.Table0074.getInstance();
		tables[24]=hl7.model.V2_51.table.Table0123.getInstance();
		tables[25]=null;
		tables[26]=null;
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_51.table.Table0124.getInstance();
		tables[30]=null;
		tables[31]=null;
		tables[32]=null;
		tables[33]=null;
		...
		tables[38]=null;
		tables[39]=null;
		tables[40]=hl7.model.V2_51.table.Table0224.getInstance();
		tables[41]=hl7.model.V2_51.table.Table0225.getInstance();
		tables[42]=null;
		tables[43]=hl7.model.V2_51.table.Table0088.getInstance();
		tables[44]=hl7.model.V2_51.table.Table0340.getInstance();
		tables[45]=hl7.model.V2_51.table.Table0411.getInstance();
		tables[46]=hl7.model.V2_51.table.Table0411.getInstance();
		tables[47]=hl7.model.V2_51.table.Table0476.getInstance();
		tables[48]=hl7.model.V2_51.table.Table0507.getInstance();
		tables[49]=null;
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==35) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.OBR type = (hl7.model.V2_5.segment.OBR)this;

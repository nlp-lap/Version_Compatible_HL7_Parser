...
public class ORG extends hl7.model.V2_5.segment.ORG{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0405.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0474.getInstance();
		tables[3]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[4]=null;
		tables[5]=hl7.model.V2_51.table.Table0452.getInstance();
		tables[6]=hl7.model.V2_51.table.Table0453.getInstance();
		tables[7]=hl7.model.V2_51.table.Table0454.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_51.table.Table0066.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.ORG type = (hl7.model.V2_5.segment.ORG)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.ORG type = (hl7.model.V2_6.segment.ORG)this;

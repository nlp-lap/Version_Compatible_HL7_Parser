...
public class NST extends hl7.model.V2_5.segment.NST{
	...
	static{
		...
		tables[0]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_51.table.Table0332.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		...
		descriptions[0]="STATISTICS_AVAILABLE";
		descriptions[1]="SOURCE_IDENTIFIER";
		descriptions[2]="SOURCE_TYPE";
		descriptions[3]="STATISTICS_START";
		descriptions[4]="STATISTICS_END";
		descriptions[5]="RECEIVE_CHARACTER_COUNT";
		descriptions[6]="SEND_CHARACTER_COUNT";
		descriptions[7]="MESSAGES_RECEIVED";
		descriptions[8]="MESSAGES_SENT";
		descriptions[9]="CHECKSUM_ERRORS_RECEIVED";
		descriptions[10]="LENGTH_ERRORS_RECEIVED";
		descriptions[11]="OTHER_ERRORS_RECEIVED";
		descriptions[12]="CONNECT_TIMEOUTS";
		descriptions[13]="RECEIVE_TIMEOUTS";
		descriptions[14]="APPLICATION_CONTROL_LEVEL_ERRORS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.NST seg = new hl7.pseudo.segment.NST();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.NST type = (hl7.model.V2_5.segment.NST)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.NST type = (hl7.model.V2_6.segment.NST)this;

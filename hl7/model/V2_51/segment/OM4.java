...
public class OM4 extends hl7.model.V2_5.segment.OM4{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0170.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_51.table.Table9999.getInstance();
		tables[5]=hl7.model.V2_51.table.Table9999.getInstance();
		tables[6]=hl7.model.V2_51.table.Table0371.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_51.table.Table0027.getInstance();
		tables[13]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.OM4 type = (hl7.model.V2_5.segment.OM4)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.OM4 type = (hl7.model.V2_6.segment.OM4)this;

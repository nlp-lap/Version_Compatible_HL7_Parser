...
public class BTX extends hl7.model.V2_5.segment.BTX{
	...
	static{
		...
		standard[16]=hl7.bean.datastructure.primitive.TS.CLASS;
		...
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_51.table.Table0512.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_51.table.Table0513.getInstance();
		tables[11]=hl7.model.V2_51.table.Table0511.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		tables[15]=null;
		tables[16]=null;
		tables[17]=hl7.model.V2_51.table.Table0514.getInstance();
		tables[18]=hl7.model.V2_51.table.Table0515.getInstance();
		...
		descriptions[13]="BP_ADMINISTRATOR";
		descriptions[14]="BP_VERIFIER";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==16) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.BTX type = (hl7.model.V2_5.segment.BTX)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.BTX type = (hl7.model.V2_6.segment.BTX)this;

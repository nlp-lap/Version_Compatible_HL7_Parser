...
public class TCC extends hl7.model.V2_5.segment.TCC{
	...
	static{
		...
		standard[2]=hl7.pseudo.datastructure.SPS.CLASS;
		standard[3]=hl7.pseudo.datastructure.SN.CLASS;
		standard[4]=hl7.pseudo.datastructure.SN.CLASS;
		standard[5]=hl7.pseudo.datastructure.SN.CLASS;
		standard[6]=hl7.pseudo.datastructure.SN.CLASS;
		...
		standard[11]=hl7.pseudo.datastructure.SN.CLASS;
		...
		tables[10]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_51.table.Table0388.getInstance();
		
		descriptions[0]="UNIVERSAL_SERVICE_IDENTIFIER";
		descriptions[1]="TEST_APPLICATION_IDENTIFIER";
		descriptions[2]="SPECIMEN_SOURCE";
		descriptions[3]="AUTO_DILUTION_FACTOR_DEFAULT";
		descriptions[4]="RERUN_DILUTION_FACTOR_DEFAULT";
		descriptions[5]="PRE_DILUTION_FACTOR_DEFAULT";
		descriptions[6]="ENDOGENOUS_CONTENT_OF_PRE_DILUTION_DILUENT";
		descriptions[7]="INVENTORY_LIMITS_WARNING_LEVEL";
		descriptions[8]="AUTOMATIC_RERUN_ALLOWED";
		descriptions[9]="AUTOMATIC_REPEAT_ALLOWED";
		descriptions[10]="AUTOMATIC_REFLEX_ALLOWED";
		descriptions[11]="EQUIPMENT_DYNAMIC_RANGE";
		descriptions[12]="UNITS";
		descriptions[13]="PROCESSING_TYPE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.TCC seg = new hl7.pseudo.segment.TCC();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.TCC type = (hl7.model.V2_5.segment.TCC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.TCC type = (hl7.model.V2_6.segment.TCC)this;

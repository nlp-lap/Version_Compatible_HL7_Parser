...
public class SPM extends hl7.model.V2_5.segment.SPM{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_51.table.Table0487.getInstance();
		tables[4]=hl7.model.V2_51.table.Table0541.getInstance();
		tables[5]=hl7.model.V2_51.table.Table0371.getInstance();
		tables[6]=hl7.model.V2_51.table.Table0488.getInstance();
		tables[7]=null;
		tables[8]=hl7.model.V2_51.table.Table0542.getInstance();
		tables[9]=hl7.model.V2_51.table.Table0543.getInstance();
		tables[10]=hl7.model.V2_51.table.Table0369.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_51.table.Table0376.getInstance();
		tables[15]=hl7.model.V2_51.table.Table0489.getInstance();
		tables[16]=null;
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_51.table.Table0136.getInstance();
		tables[20]=hl7.model.V2_51.table.Table0490.getInstance();
		tables[21]=hl7.model.V2_51.table.Table0491.getInstance();
		tables[22]=hl7.model.V2_51.table.Table0492.getInstance();
		tables[23]=hl7.model.V2_51.table.Table0493.getInstance();
		tables[24]=null;
		tables[25]=null;
		tables[26]=null;
		tables[27]=hl7.model.V2_51.table.Table0544.getInstance();
		tables[28]=hl7.model.V2_51.table.Table0494.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.SPM type = (hl7.model.V2_5.segment.SPM)this;

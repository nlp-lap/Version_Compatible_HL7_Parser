...
public class PV1 extends hl7.model.V2_5.segment.PV1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0004.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_51.table.Table0007.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_51.table.Table0010.getInstance();
		tables[7]=hl7.model.V2_51.table.Table0010.getInstance();
		tables[8]=hl7.model.V2_51.table.Table0010.getInstance();
		tables[9]=hl7.model.V2_51.table.Table0069.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_51.table.Table0087.getInstance();
		tables[12]=hl7.model.V2_51.table.Table0092.getInstance();
		tables[13]=hl7.model.V2_51.table.Table0023.getInstance();
		tables[14]=hl7.model.V2_51.table.Table0009.getInstance();
		tables[15]=hl7.model.V2_51.table.Table0099.getInstance();
		tables[16]=hl7.model.V2_51.table.Table0010.getInstance();
		tables[17]=hl7.model.V2_51.table.Table0018.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_51.table.Table0064.getInstance();
		tables[20]=hl7.model.V2_51.table.Table0032.getInstance();
		tables[21]=hl7.model.V2_51.table.Table0045.getInstance();
		tables[22]=hl7.model.V2_51.table.Table0046.getInstance();
		tables[23]=hl7.model.V2_51.table.Table0044.getInstance();
		tables[24]=null;
		tables[25]=null;
		tables[26]=null;
		tables[27]=hl7.model.V2_51.table.Table0073.getInstance();
		tables[28]=hl7.model.V2_51.table.Table0110.getInstance();
		tables[29]=null;
		tables[30]=hl7.model.V2_51.table.Table0021.getInstance();
		tables[31]=null;
		tables[32]=null;
		tables[33]=hl7.model.V2_51.table.Table0111.getInstance();
		tables[34]=null;
		tables[35]=hl7.model.V2_51.table.Table0112.getInstance();
		tables[36]=hl7.model.V2_51.table.Table0113.getInstance();
		tables[37]=hl7.model.V2_51.table.Table0114.getInstance();
		tables[38]=hl7.model.V2_51.table.Table0115.getInstance();
		tables[39]=hl7.model.V2_51.table.Table0116.getInstance();
		tables[40]=hl7.model.V2_51.table.Table0117.getInstance();
		tables[41]=null;
		tables[42]=null;
		tables[43]=null;
		tables[44]=null;
		...
		tables[47]=null;
		tables[48]=null;
		tables[49]=hl7.model.V2_51.table.Table0203.getInstance();
		tables[50]=hl7.model.V2_51.table.Table0326.getInstance();
		tables[51]=hl7.model.V2_51.table.Table0010.getInstance();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==43) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==44) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.PV1 type = (hl7.model.V2_5.segment.PV1)this;

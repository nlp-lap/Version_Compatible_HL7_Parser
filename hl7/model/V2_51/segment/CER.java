...
public class CER extends hl7.model.V2_5.segment.CER{
	...
	static{
		...
		standard[24]=hl7.bean.datastructure.primitive.TS.CLASS;
		standard[25]=hl7.bean.datastructure.primitive.TS.CLASS;
		standard[26]=hl7.bean.datastructure.primitive.TS.CLASS;
		standard[27]=hl7.bean.datastructure.primitive.TS.CLASS;
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_51.table.Table0399.getInstance();
		tables[7]=hl7.model.V2_51.table.Table0347.getInstance();
		tables[8]=hl7.model.V2_51.table.Table0289.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		...
		tables[17]=null;
		tables[18]=hl7.model.V2_51.table.Table0399.getInstance();
		tables[19]=hl7.model.V2_51.table.Table0347.getInstance();
		tables[20]=hl7.model.V2_51.table.Table0289.getInstance();
		tables[21]=hl7.model.V2_51.table.Table0547.getInstance();
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		tables[25]=null;
		...
		tables[28]=null;
		tables[29]=null;
		tables[30]=hl7.model.V2_51.table.Table0536.getInstance();
		...
		descriptions[30]="CERTIFICATE_STATUS";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==24) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==25) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==26) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==27) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.CER type = (hl7.model.V2_5.segment.CER)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.CER type = (hl7.model.V2_6.segment.CER)this;

...
public class RF1 extends hl7.model.V2_5.segment.RF1{
	...
	static{
		...
		standard[5]=hl7.pseudo.datastructure.EI.CLASS;
		...
		standard[10]=hl7.pseudo.datastructure.EI.CLASS;
		
		tables[0]=hl7.model.V2_51.table.Table0283.getInstance();
		tables[1]=hl7.model.V2_51.table.Table0280.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0281.getInstance();
		tables[3]=hl7.model.V2_51.table.Table0282.getInstance();
		tables[4]=hl7.model.V2_51.table.Table0284.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_51.table.Table0336.getInstance();
		tables[10]=null;
		
		descriptions[0]="REFERRAL_STATUS";
		descriptions[1]="REFERRAL_PRIORITY";
		descriptions[2]="REFERRAL_TYPE";
		descriptions[3]="REFERRAL_DISPOSITION";
		descriptions[4]="REFERRAL_CATEGORY";
		descriptions[5]="ORIGINATING_REFERRAL_IDENTIFIER";
		descriptions[6]="EFFECTIVE_DATE";
		descriptions[7]="EXPIRATION_DATE";
		descriptions[8]="PROCESS_DATE";
		descriptions[9]="REFERRAL_REASON";
		descriptions[10]="EXTERNAL_REFERRAL_IDENTIFIER";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.RF1 seg = new hl7.pseudo.segment.RF1();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.RF1 type = (hl7.model.V2_5.segment.RF1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.RF1 type = (hl7.model.V2_6.segment.RF1)this;

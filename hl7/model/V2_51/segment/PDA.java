...
public class PDA extends hl7.model.V2_5.segment.PDA{
	...
	static{
		...
		standard[1]=hl7.pseudo.datastructure.PL.CLASS;
		...
		descriptions[0]="DEATH_CAUSE_CODE";
		descriptions[1]="DEATH_LOCATION";
		descriptions[2]="DEATH_CERTIFIED_INDICATOR";
		descriptions[3]="DEATH_CERTIFICATE_SIGNED_DATE_TIME";
		descriptions[4]="DEATH_CERTIFIED_BY";
		descriptions[5]="AUTOPSY_INDICATOR";
		descriptions[6]="AUTOPSY_START_AND_END_DATE_TIME";
		descriptions[7]="AUTOPSY_PERFORMED_BY";
		descriptions[8]="CORONER_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PDA seg = new hl7.pseudo.segment.PDA();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.PDA type = (hl7.model.V2_5.segment.PDA)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.PDA type = (hl7.model.V2_6.segment.PDA)this;

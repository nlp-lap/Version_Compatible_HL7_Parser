...
public class ROL extends hl7.model.V2_5.segment.ROL{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_51.table.Table0287.getInstance();
		tables[2]=hl7.model.V2_51.table.Table0443.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_51.table.Table0406.getInstance();
		tables[10]=null;
		tables[11]=null;
		
		descriptions[0]="ROLE_INSTANCE_ID";
		descriptions[1]="ACTION_CODE";
		descriptions[2]="ROLE_ROL";
		descriptions[3]="ROLE_PERSON";
		descriptions[4]="ROLE_BEGIN_DATE_TIME";
		descriptions[5]="ROLE_END_DATE_TIME";
		descriptions[6]="ROLE_DURATION";
		descriptions[7]="ROLE_ACTION_REASON";
		descriptions[8]="PROVIDER_TYPE";
		descriptions[9]="ORGANIZATION_UNIT_TYPE";
		descriptions[10]="OFFICE_HOME_ADDRESS_BIRTHPLACE";
		descriptions[11]="PHONE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ROL seg = new hl7.pseudo.segment.ROL();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_5.segment.ROL type = (hl7.model.V2_5.segment.ROL)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.segment.ROL type = (hl7.model.V2_6.segment.ROL)this;

...
public class SPECIMEN_ORL_O22 extends hl7.model.V2_5.group.SPECIMEN_ORL_O22{
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_5.group.SPECIMEN_ORL_O22 type = (hl7.model.V2_5.group.SPECIMEN_ORL_O22)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.group.SPECIMEN_ORL_O22 type = (hl7.model.V2_6.group.SPECIMEN_ORL_O22)this;

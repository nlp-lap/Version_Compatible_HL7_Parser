...
public class ORDER_OBSERVATION_ORU_R01 extends hl7.model.V2_5.group.ORDER_OBSERVATION_ORU_R01{
	...
	static{
		...
		standard[6]=hl7.pseudo.segment.FT1.CLASS;
		standard[7]=hl7.pseudo.segment.CTI.CLASS;
		standard[3]=hl7.pseudo.group.TIMING_QTY_ORU_R01.CLASS;
		standard[5]=hl7.pseudo.group.OBSERVATION_ORU_R01.CLASS;
		standard[8]=hl7.pseudo.group.SPECIMEN_ORU_R01.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_5.group.ORDER_OBSERVATION_ORU_R01 type = (hl7.model.V2_5.group.ORDER_OBSERVATION_ORU_R01)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.group.ORDER_OBSERVATION_ORU_R01 type = (hl7.model.V2_6.group.ORDER_OBSERVATION_ORU_R01)this;

...
public class RDR_RDR extends hl7.model.V2_4.message.RDR_RDR{
	...
	static{
		...
		standard[7]=hl7.pseudo.segment.SFT.CLASS;
		standard[10]=hl7.pseudo.segment.DSC.CLASS;
		standard[11]=hl7.pseudo.segment.DSC.CLASS;
		standard[8]=hl7.pseudo.group.DEFINITION_RDR_RDR.CLASS;
		standard[9]=hl7.pseudo.group.DEFINITION_RDR_RDR.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[4] = subComponents[19];
		components[5] = subComponents[20];
		components[6] = subComponents[21];
		components[7] = subComponents[22];
		components[8] = subComponents[24];
		components[10] = subComponents[25];
		components[11] = subComponents[27];
		components[9] = null;
	}
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.message.RDR_RDR type = (hl7.model.V2_4.message.RDR_RDR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_6.message.RDR_RDR type = (hl7.model.V2_6.message.RDR_RDR)this;

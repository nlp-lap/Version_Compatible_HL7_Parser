...
public class SPD extends hl7.model.V2_51.datastructure.SPD{
	public static final String VERSION = "2.6";
	public static final String SPECIALTY_NAME = "Specialty Name";
	public static final String GOVERNING_BOARD = "Governing Board";
	public static final String ELIGIBLE_OR_CERTIFIED = "Eligible or Certified";
	public static final String DATE_OF_CERTIFICATION = "Date of Certification";
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0337.getInstance();
		tables[3]=null;
		
		descriptions[0]=SPECIALTY_NAME;
		descriptions[1]=GOVERNING_BOARD;
		descriptions[2]=ELIGIBLE_OR_CERTIFIED;
		descriptions[3]=DATE_OF_CERTIFICATION;
	...
	public SPD(){
		type = DataStructure.SPD;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.SPD data = new hl7.pseudo.datastructure.SPD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.SPD type = (hl7.model.V2_51.datastructure.SPD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.SPD type = (hl7.model.V2_7.datastructure.SPD)this;

...
public class OSD extends hl7.model.V2_51.datastructure.OSD{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0524.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0363.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_6.table.Table0363.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0301.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_6.table.Table0301.getInstance();

...
public class ERL extends hl7.model.V2_51.datastructure.ERL{
	public static final String VERSION = "2.6";
	public static final String SEGMENT_ID = "Segment ID";
	public static final String SEGMENT_SEQUENCE = "Segment Sequence";
	public static final String FIELD_POSITION = "Field Position";
	public static final String FIELD_REPETITION = "Field Repetition";
	public static final String COMPONENT_NUMBER = "Component Number";
	public static final String SUB_COMPONENT_NUMBER = "Sub-Component Number";
	...
	static{
		...
		descriptions[1]=SEGMENT_SEQUENCE;
		descriptions[2]=FIELD_POSITION;
		descriptions[3]=FIELD_REPETITION;
		descriptions[4]=COMPONENT_NUMBER;
		descriptions[5]=SUB_COMPONENT_NUMBER;
	...
	public ERL(){
		type = DataStructure.ERL;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.ERL data = new hl7.pseudo.datastructure.ERL();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.ERL type = (hl7.model.V2_51.datastructure.ERL)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.ERL type = (hl7.model.V2_7.datastructure.ERL)this;

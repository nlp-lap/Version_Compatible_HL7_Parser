...
public class XON extends hl7.model.V2_51.datastructure.XON{
	public static final String VERSION = "2.6";
	public static final String ORGANIZATION_NAME = "Organization Name";
	public static final String ORGANIZATION_NAME_TYPE_CODE = "Organization Name Type Code";
	...
	public static final String ORGANIZATION_IDENTIFIER = "Organization Identifier";
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0204.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_6.table.Table0061.getInstance();
		tables[5]=hl7.model.V2_6.table.Table0363.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0203.getInstance();
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0465.getInstance();
		tables[9]=null;
		
		descriptions[0]=ORGANIZATION_NAME;
		descriptions[1]=ORGANIZATION_NAME_TYPE_CODE;
		descriptions[2]=ID_NUMBER;
		descriptions[3]=IDENTIFIER_CHECK_DIGIT;
		descriptions[4]=CHECK_DIGIT_SCHEME;
		descriptions[5]=ASSIGNING_AUTHORITY;
		descriptions[6]=IDENTIFIER_TYPE_CODE;
		descriptions[7]=ASSIGNING_FACILITY;
		descriptions[8]=NAME_REPRESENTATION_CODE;
		descriptions[9]=ORGANIZATION_IDENTIFIER;
	...
	public XON(){
		type = DataStructure.XON;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.XON data = new hl7.pseudo.datastructure.XON();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.XON type = (hl7.model.V2_51.datastructure.XON)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.XON type = (hl7.model.V2_7.datastructure.XON)this;

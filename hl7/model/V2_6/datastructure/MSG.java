...
public class MSG extends hl7.model.V2_51.datastructure.MSG{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0076.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0003.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0354.getInstance();
		
		descriptions[0]=MESSAGE_CODE;
		descriptions[1]=TRIGGER_EVENT;
		descriptions[2]=MESSAGE_STRUCTURE;
	...
	public MSG(){
		type = DataStructure.MSG;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.MSG data = new hl7.pseudo.datastructure.MSG();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.MSG type = (hl7.model.V2_51.datastructure.MSG)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.MSG type = (hl7.model.V2_7.datastructure.MSG)this;

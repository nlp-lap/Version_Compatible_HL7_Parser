...
public class PTA extends hl7.model.V2_51.datastructure.PTA{
	public static final String VERSION = "2.6";
	public static final String POLICY_TYPE = "Policy Type";
	public static final String AMOUNT_CLASS = "Amount Class";
	public static final String MONEY_OR_PERCENTAGE_QUANTITY = "Money or Percentage Quantity";
	public static final String MONEY_OR_PERCENTAGE = "Money or Percentage";
	...
	static{
		...
		standard[3]=hl7.pseudo.datastructure.MOP.CLASS;
		
		tables[0]=hl7.model.V2_6.table.Table0147.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0193.getInstance();
		tables[2]=null;
		tables[3]=null;
		
		descriptions[0]=POLICY_TYPE;
		descriptions[1]=AMOUNT_CLASS;
		descriptions[2]=MONEY_OR_PERCENTAGE_QUANTITY;
		descriptions[3]=MONEY_OR_PERCENTAGE;
	...
	public PTA(){
		type = DataStructure.PTA;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.PTA data = new hl7.pseudo.datastructure.PTA();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.PTA type = (hl7.model.V2_51.datastructure.PTA)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.PTA type = (hl7.model.V2_7.datastructure.PTA)this;

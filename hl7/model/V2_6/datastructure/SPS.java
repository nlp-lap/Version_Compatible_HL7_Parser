...
public class SPS extends hl7.model.V2_51.datastructure.SPS{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0371.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_6.table.Table0163.getInstance();
		tables[4]=hl7.model.V2_6.table.Table0495.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0369.getInstance();

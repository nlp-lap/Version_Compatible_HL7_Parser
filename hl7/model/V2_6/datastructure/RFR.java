...
public class RFR extends hl7.model.V2_51.datastructure.RFR{
	public static final String VERSION = "2.6";
	public static final String NUMERIC_RANGE = "Numeric Range";
	public static final String ADMINISTRATIVE_SEX = "Administrative Sex";
	public static final String AGE_RANGE = "Age Range";
	public static final String GESTATIONAL_AGE_RANGE = "Gestational Age Range";
	public static final String SPECIES = "Species";
	public static final String RACE_SUBSPECIES = "Race/subspecies";
	...
	static{
		standard[0]=hl7.pseudo.datastructure.NR.CLASS;
		standard[1]=hl7.bean.datastructure.primitive.IS.CLASS;
		standard[2]=hl7.pseudo.datastructure.NR.CLASS;
		standard[3]=hl7.pseudo.datastructure.NR.CLASS;
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0001.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		descriptions[0]=NUMERIC_RANGE;
		descriptions[1]=ADMINISTRATIVE_SEX;
		descriptions[2]=AGE_RANGE;
		descriptions[3]=GESTATIONAL_AGE_RANGE;
		descriptions[4]=SPECIES;
		descriptions[5]=RACE_SUBSPECIES;
		descriptions[6]=CONDITIONS;
	...
	public RFR(){
		type = DataStructure.RFR;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.RFR data = new hl7.pseudo.datastructure.RFR();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.RFR type = (hl7.model.V2_51.datastructure.RFR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.RFR type = (hl7.model.V2_7.datastructure.RFR)this;

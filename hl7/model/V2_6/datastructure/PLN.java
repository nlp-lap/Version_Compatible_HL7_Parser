...
public class PLN extends hl7.model.V2_51.datastructure.PLN{
	public static final String VERSION = "2.6";
	public static final String ID_NUMBER = "ID Number";
	public static final String TYPE_OF_ID_NUMBER = "Type of ID Number";
	public static final String STATE_OTHER_QUALIFYING_INFORMATION = "State/other Qualifying Information";
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0338.getInstance();
		tables[2]=null;
		tables[3]=null;
		
		descriptions[0]=ID_NUMBER;
		descriptions[1]=TYPE_OF_ID_NUMBER;
		descriptions[2]=STATE_OTHER_QUALIFYING_INFORMATION;
		descriptions[3]=EXPIRATION_DATE;
	...
	public PLN(){
		type = DataStructure.PLN;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.PLN data = new hl7.pseudo.datastructure.PLN();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.PLN type = (hl7.model.V2_51.datastructure.PLN)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.PLN type = (hl7.model.V2_7.datastructure.PLN)this;

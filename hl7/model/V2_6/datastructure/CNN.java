...
public class CNN extends hl7.model.V2_51.datastructure.CNN{
	...
	public static final String ASSIGNING_AUTHORITY_NAMESPACE_ID = "Assigning Authority   - Namespace ID";
	public static final String ASSIGNING_AUTHORITY_UNIVERSAL_ID = "Assigning Authority  - Universal ID";
	public static final String ASSIGNING_AUTHORITY_UNIVERSAL_ID_TYPE = "Assigning Authority  - Universal ID Type";
	...
	static{
		...
		descriptions[8]=ASSIGNING_AUTHORITY_NAMESPACE_ID;
		descriptions[9]=ASSIGNING_AUTHORITY_UNIVERSAL_ID;
		descriptions[10]=ASSIGNING_AUTHORITY_UNIVERSAL_ID_TYPE;
	...
	public CNN(){
		type = DataStructure.CNN;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.CNN data = new hl7.pseudo.datastructure.CNN();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.CNN type = (hl7.model.V2_51.datastructure.CNN)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.CNN type = (hl7.model.V2_7.datastructure.CNN)this;

...
public class ED extends hl7.model.V2_51.datastructure.ED{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0834.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0291.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0299.getInstance();
		tables[4]=null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.ED type = (hl7.model.V2_7.datastructure.ED)this;

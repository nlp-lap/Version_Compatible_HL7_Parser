...
public class RPT extends hl7.model.V2_51.datastructure.RPT{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0335.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0527.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0528.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.RPT type = (hl7.model.V2_51.datastructure.RPT)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.RPT type = (hl7.model.V2_7.datastructure.RPT)this;

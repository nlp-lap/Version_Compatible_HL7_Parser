...
public class XAD extends hl7.model.V2_51.datastructure.XAD{
	...
	static{
		...
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table0399.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0190.getInstance();
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0289.getInstance();
		tables[9]=hl7.model.V2_6.table.Table0288.getInstance();
		tables[10]=hl7.model.V2_6.table.Table0465.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_6.table.Table0616.getInstance();
		tables[15]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[16]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[17]=hl7.model.V2_6.table.Table0617.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=hl7.model.V2_6.table.Table0618.getInstance();
		tables[22]=null;
	...
	public static void backward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, String prevVersion, int depth) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			if(i==8) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
			if(i==9) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
			...
			if(i==19) components[i] = subComponents[i];
			if(i==20) components[i] = subComponents[i];
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==12) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==13) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==15) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==16) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==17) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
			...
			if(i==20) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==14) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==21) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==22) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.XAD type = (hl7.model.V2_7.datastructure.XAD)this;

...
public class ICD extends hl7.model.V2_51.datastructure.ICD{
	public static final String VERSION = "2.6";
	public static final String CERTIFICATION_PATIENT_TYPE = "Certification Patient Type";
	public static final String CERTIFICATION_REQUIRED = "Certification Required";
	public static final String DATE_TIME_CERTIFICATION_REQUIRED = "Date/Time Certification Required";
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0150.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[2]=null;
		
		descriptions[0]=CERTIFICATION_PATIENT_TYPE;
		descriptions[1]=CERTIFICATION_REQUIRED;
		descriptions[2]=DATE_TIME_CERTIFICATION_REQUIRED;
	...
	public ICD(){
		type = DataStructure.ICD;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.ICD data = new hl7.pseudo.datastructure.ICD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.ICD type = (hl7.model.V2_51.datastructure.ICD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.ICD type = (hl7.model.V2_7.datastructure.ICD)this;

...
public class PL extends hl7.model.V2_51.datastructure.PL{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0302.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0303.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0304.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_6.table.Table0306.getInstance();
		tables[5]=hl7.model.V2_6.table.Table0305.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0307.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0308.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
	...
	public static void backward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, String prevVersion, int depth) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			if(i==0) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
			if(i==1) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
			if(i==2) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
			if(i==6) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
			if(i==7) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.PL type = (hl7.model.V2_51.datastructure.PL)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.PL type = (hl7.model.V2_7.datastructure.PL)this;

...
public class PRL extends hl7.model.V2_51.datastructure.PRL{
	public static final String VERSION = "2.6";
	public static final String PARENT_OBSERVATION_IDENTIFIER = "Parent Observation Identifier";
	public static final String PARENT_OBSERVATION_SUB_IDENTIFIER = "Parent Observation Sub-identifier";
	public static final String PARENT_OBSERVATION_VALUE_DESCRIPTOR = "Parent Observation Value Descriptor";
	...
	static{
		...
		descriptions[0]=PARENT_OBSERVATION_IDENTIFIER;
		descriptions[1]=PARENT_OBSERVATION_SUB_IDENTIFIER;
		descriptions[2]=PARENT_OBSERVATION_VALUE_DESCRIPTOR;
	...
	public PRL(){
		type = DataStructure.PRL;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.PRL data = new hl7.pseudo.datastructure.PRL();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.PRL type = (hl7.model.V2_51.datastructure.PRL)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.PRL type = (hl7.model.V2_7.datastructure.PRL)this;

...
public class VH extends hl7.model.V2_51.datastructure.VH{
	public static final String VERSION = "2.6";
	public static final String START_DAY_RANGE = "Start Day Range";
	public static final String END_DAY_RANGE = "End Day Range";
	public static final String START_HOUR_RANGE = "Start Hour Range";
	public static final String END_HOUR_RANGE = "End Hour Range";
	...
	static{
		...
		standard[2]=hl7.bean.datastructure.primitive.TM.CLASS;
		standard[3]=hl7.bean.datastructure.primitive.TM.CLASS;
		
		tables[0]=hl7.model.V2_6.table.Table0267.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0267.getInstance();
		tables[2]=null;
		tables[3]=null;
		
		descriptions[0]=START_DAY_RANGE;
		descriptions[1]=END_DAY_RANGE;
		descriptions[2]=START_HOUR_RANGE;
		descriptions[3]=END_HOUR_RANGE;
	...
	public VH(){
		type = DataStructure.VH;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.VH data = new hl7.pseudo.datastructure.VH();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.VH type = (hl7.model.V2_51.datastructure.VH)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.VH type = (hl7.model.V2_7.datastructure.VH)this;

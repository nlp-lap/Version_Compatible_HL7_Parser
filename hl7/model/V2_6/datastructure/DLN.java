...
public class DLN extends hl7.model.V2_51.datastructure.DLN{
	public static final String VERSION = "2.6";
	public static final String LICENSE_NUMBER = "License Number";
	public static final String ISSUING_STATE_PROVINCE_COUNTRY = "Issuing State, Province, Country";
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0333.getInstance();
		tables[2]=null;
		
		descriptions[0]=LICENSE_NUMBER;
		descriptions[1]=ISSUING_STATE_PROVINCE_COUNTRY;
	...
	public DLN(){
		type = DataStructure.DLN;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.DLN data = new hl7.pseudo.datastructure.DLN();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.DLN type = (hl7.model.V2_51.datastructure.DLN)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.DLN type = (hl7.model.V2_7.datastructure.DLN)this;

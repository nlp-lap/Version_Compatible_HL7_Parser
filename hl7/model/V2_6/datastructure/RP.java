...
public class RP extends hl7.model.V2_51.datastructure.RP{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0834.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0291.getInstance();
		
		descriptions[0]=POINTER;
		descriptions[1]=APPLICATION_ID;
		descriptions[2]=TYPE_OF_DATA;
		descriptions[3]=SUBTYPE;
	...
	public RP(){
		type = DataStructure.RP;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.RP data = new hl7.pseudo.datastructure.RP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.RP type = (hl7.model.V2_51.datastructure.RP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.RP type = (hl7.model.V2_7.datastructure.RP)this;

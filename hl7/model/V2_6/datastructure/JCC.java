...
public class JCC extends hl7.model.V2_51.datastructure.JCC{
	public static final String VERSION = "2.6";
	public static final String JOB_CODE = "Job Code";
	public static final String JOB_CLASS = "Job Class";
	public static final String JOB_DESCRIPTION_TEXT = "Job Description Text";
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0327.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0328.getInstance();
		tables[2]=null;
		
		descriptions[0]=JOB_CODE;
		descriptions[1]=JOB_CLASS;
		descriptions[2]=JOB_DESCRIPTION_TEXT;
	...
	public JCC(){
		type = DataStructure.JCC;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.JCC data = new hl7.pseudo.datastructure.JCC();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.JCC type = (hl7.model.V2_51.datastructure.JCC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.JCC type = (hl7.model.V2_7.datastructure.JCC)this;

...
public class SAD extends hl7.model.V2_51.datastructure.SAD{
	public static final String VERSION = "2.6";
	public static final String STREET_OR_MAILING_ADDRESS = "Street or Mailing Address";
	public static final String STREET_NAME = "Street Name";
	public static final String DWELLING_NUMBER = "Dwelling Number";
	...
	static{
		...
		descriptions[0]=STREET_OR_MAILING_ADDRESS;
		descriptions[1]=STREET_NAME;
		descriptions[2]=DWELLING_NUMBER;
	...
	public SAD(){
		type = DataStructure.SAD;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.SAD data = new hl7.pseudo.datastructure.SAD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.SAD type = (hl7.model.V2_51.datastructure.SAD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.SAD type = (hl7.model.V2_7.datastructure.SAD)this;

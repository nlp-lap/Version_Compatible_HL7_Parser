...
public class CD extends hl7.model.V2_51.datastructure.CD{
	public static final String VERSION = "2.6";
	public static final String CHANNEL_IDENTIFIER = "Channel Identifier";
	public static final String WAVEFORM_SOURCE = "Waveform Source";
	public static final String CHANNEL_SENSITIVITY_AND_UNITS = "Channel Sensitivity and Units";
	public static final String CHANNEL_CALIBRATION_PARAMETERS = "Channel Calibration Parameters";
	public static final String CHANNEL_SAMPLING_FREQUENCY = "Channel Sampling Frequency";
	public static final String MINIMUM_AND_MAXIMUM_DATA_VALUES = "Minimum and Maximum Data Values";
	...
	static{
		...
		descriptions[1]=WAVEFORM_SOURCE;
		descriptions[2]=CHANNEL_SENSITIVITY_AND_UNITS;
		descriptions[3]=CHANNEL_CALIBRATION_PARAMETERS;
		descriptions[4]=CHANNEL_SAMPLING_FREQUENCY;
		descriptions[5]=MINIMUM_AND_MAXIMUM_DATA_VALUES;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.datastructure.CD type = (hl7.model.V2_51.datastructure.CD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.datastructure.CD type = (hl7.model.V2_7.datastructure.CD)this;

...
public class IPC extends hl7.model.V2_51.segment.IPC{
	...
	static{
		...
		descriptions[0]="ACCESSION_IDENTIFIER";
		descriptions[1]="REQUESTED_PROCEDURE_ID";
		descriptions[2]="STUDY_INSTANCE_UID";
		descriptions[3]="SCHEDULED_PROCEDURE_STEP_ID";
		descriptions[4]="MODALITY";
		descriptions[5]="PROTOCOL_CODE";
		descriptions[6]="SCHEDULED_STATION_NAME";
		descriptions[7]="SCHEDULED_PROCEDURE_STEP_LOCATION";
		descriptions[8]="SCHEDULED_STATION_AE_TITLE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.IPC seg = new hl7.pseudo.segment.IPC();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.IPC type = (hl7.model.V2_51.segment.IPC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.IPC type = (hl7.model.V2_7.segment.IPC)this;

...
public class PCE extends hl7.character.segment.PCE{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0319.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0132.getInstance();
		tables[3]=null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PCE type = (hl7.model.V2_7.segment.PCE)this;

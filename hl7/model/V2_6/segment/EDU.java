...
public class EDU extends hl7.model.V2_51.segment.EDU{
	...
	static{
		...
		standard[2]=hl7.pseudo.datastructure.DR.CLASS;
		...
		standard[7]=hl7.pseudo.datastructure.XAD.CLASS;
		standard[8]=hl7.pseudo.datastructure.CWE.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0360.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0402.getInstance();
		tables[7]=null;
		tables[8]=null;
		
		descriptions[0]="SET_ID_EDU";
		descriptions[1]="ACADEMIC_DEGREE";
		descriptions[2]="ACADEMIC_DEGREE_PROGRAM_DATE_RANGE";
		descriptions[3]="ACADEMIC_DEGREE_PROGRAM_PARTICIPATION_DATE_RANGE";
		descriptions[4]="ACADEMIC_DEGREE_GRANTED_DATE";
		descriptions[5]="SCHOOL";
		descriptions[6]="SCHOOL_TYPE_CODE";
		descriptions[7]="SCHOOL_ADDRESS";
		descriptions[8]="MAJOR_FIELD_OF_STUDY";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.EDU seg = new hl7.pseudo.segment.EDU();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.EDU type = (hl7.model.V2_51.segment.EDU)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.EDU type = (hl7.model.V2_7.segment.EDU)this;

...
public class PRD extends hl7.model.V2_51.segment.PRD{
	...
	static{
		...
		standard[2]=hl7.pseudo.datastructure.XAD.CLASS;
		standard[3]=hl7.pseudo.datastructure.PL.CLASS;
		standard[4]=hl7.pseudo.datastructure.XTN.CLASS;
		standard[5]=hl7.pseudo.datastructure.CWE.CLASS;
		standard[6]=hl7.pseudo.datastructure.PLN.CLASS;
		...
		standard[11]=hl7.pseudo.datastructure.PL.CLASS;
		standard[12]=hl7.pseudo.datastructure.XTN.CLASS;
		standard[13]=hl7.pseudo.datastructure.CWE.CLASS;
		
		tables[0]=hl7.model.V2_6.table.Table0286.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table0185.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0338.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_6.table.Table0185.getInstance();
		
		descriptions[0]="PROVIDER_ROLE";
		descriptions[1]="PROVIDER_NAME";
		descriptions[2]="PROVIDER_ADDRESS";
		descriptions[3]="PROVIDER_LOCATION";
		descriptions[4]="PROVIDER_COMMUNICATION_INFORMATION";
		descriptions[5]="PREFERRED_METHOD_OF_CONTACT";
		descriptions[6]="PROVIDER_IDENTIFIERS";
		descriptions[7]="EFFECTIVE_START_DATE_OF_PROVIDER_ROLE";
		descriptions[8]="EFFECTIVE_END_DATE_OF_PROVIDER_ROLE";
		descriptions[9]="PROVIDER_ORGANIZATION_NAME_AND_IDENTIFIER";
		descriptions[10]="PROVIDER_ORGANIZATION_ADDRESS";
		descriptions[11]="PROVIDER_ORGANIZATION_LOCATION_INFORMATION";
		descriptions[12]="PROVIDER_ORGANIZATION_COMMUNICATION_INFORMATION";
		descriptions[13]="PROVIDER_ORGANIZATION_METHOD_OF_CONTACT";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PRD seg = new hl7.pseudo.segment.PRD();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XON.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.PL.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.PRD type = (hl7.model.V2_51.segment.PRD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PRD type = (hl7.model.V2_7.segment.PRD)this;

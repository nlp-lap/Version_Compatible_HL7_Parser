...
public class LAN extends hl7.model.V2_51.segment.LAN{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0296.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0403.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0404.getInstance();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.LAN type = (hl7.model.V2_7.segment.LAN)this;

...
public class AIS extends hl7.model.V2_51.segment.AIS{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0206.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0279.getInstance();
		tables[9]=hl7.model.V2_6.table.Table0278.getInstance();
		tables[10]=hl7.model.V2_6.table.Table0411.getInstance();
		tables[11]=hl7.model.V2_6.table.Table0411.getInstance();
		
		descriptions[0]="SET_ID_AIS";
		descriptions[1]="SEGMENT_ACTION_CODE";
		descriptions[2]="UNIVERSAL_SERVICE_IDENTIFIER";
		descriptions[3]="START_DATE_TIME";
		descriptions[4]="START_DATE_TIME_OFFSET";
		descriptions[5]="START_DATE_TIME_OFFSET_UNITS";
		descriptions[6]="DURATION";
		descriptions[7]="DURATION_UNITS";
		descriptions[8]="ALLOW_SUBSTITUTION_CODE";
		descriptions[9]="FILLER_STATUS_CODE";
		descriptions[10]="PLACER_SUPPLEMENTAL_SERVICE_INFORMATION";
		descriptions[11]="FILLER_SUPPLEMENTAL_SERVICE_INFORMATION";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.AIS seg = new hl7.pseudo.segment.AIS();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==5) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.AIS type = (hl7.model.V2_51.segment.AIS)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.AIS type = (hl7.model.V2_7.segment.AIS)this;

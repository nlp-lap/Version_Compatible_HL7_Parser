...
public class OM1 extends hl7.model.V2_51.segment.OM1{
	...
	static{
		...
		standard[20]=hl7.bean.datastructure.primitive.DTM.CLASS;
		...
		tables[2]=hl7.model.V2_6.table.Table0125.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0136.getInstance();
		...
		tables[12]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[13]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[14]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[15]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_6.table.Table0174.getInstance();
		...
		tables[22]=null;
		tables[23]=null;
		tables[24]=hl7.model.V2_6.table.Table0168.getInstance();
		tables[25]=hl7.model.V2_6.table.Table0169.getInstance();
		tables[26]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_6.table.Table0177.getInstance();
		tables[30]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[31]=null;
		tables[32]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[33]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[34]=null;
		tables[35]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[36]=null;
		tables[37]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[38]=null;
		tables[39]=null;
		tables[40]=null;
		tables[41]=hl7.model.V2_6.table.Table0254.getInstance();
		tables[42]=hl7.model.V2_6.table.Table0255.getInstance();
		tables[43]=hl7.model.V2_6.table.Table0256.getInstance();
		tables[44]=hl7.model.V2_6.table.Table0258.getInstance();
		tables[45]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[46]=hl7.model.V2_6.table.Table0259.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==20) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.OM1 type = (hl7.model.V2_51.segment.OM1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.OM1 type = (hl7.model.V2_7.segment.OM1)this;

...
public class SDD extends hl7.character.segment.SDD{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_6.table.Table0667.getInstance();
		tables[4]=hl7.model.V2_6.table.Table0669.getInstance();
		tables[5]=null;
		tables[6]=null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.SDD type = (hl7.model.V2_7.segment.SDD)this;

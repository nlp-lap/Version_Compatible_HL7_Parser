...
public class PSG extends hl7.character.segment.PSG{
	...
	static{
		...
		descriptions[0]="PROVIDER_PRODUCT_SERVICE_GROUP_NUMBER";
		descriptions[1]="PAYER_PRODUCT_SERVICE_GROUP_NUMBER";
		descriptions[2]="PRODUCT_SERVICE_GROUP_SEQUENCE_NUMBER";
		descriptions[3]="ADJUDICATE_AS_GROUP";
		descriptions[4]="PRODUCT_SERVICE_GROUP_BILLED_AMOUNT";
		descriptions[5]="PRODUCT_SERVICE_GROUP_DESCRIPTION";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PSG seg = new hl7.pseudo.segment.PSG();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PSG type = (hl7.model.V2_7.segment.PSG)this;

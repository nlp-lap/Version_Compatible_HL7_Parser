...
public class IN2 extends hl7.model.V2_51.segment.IN2{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_6.table.Table0139.getInstance();
		tables[4]=hl7.model.V2_6.table.Table0137.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_6.table.Table0342.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_6.table.Table0140.getInstance();
		tables[14]=hl7.model.V2_6.table.Table0141.getInstance();
		tables[15]=hl7.model.V2_6.table.Table0142.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[18]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[19]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=hl7.model.V2_6.table.Table0143.getInstance();
		tables[24]=null;
		tables[25]=null;
		tables[26]=hl7.model.V2_6.table.Table0144.getInstance();
		tables[27]=null;
		tables[28]=null;
		tables[29]=null;
		tables[30]=hl7.model.V2_6.table.Table0223.getInstance();
		tables[31]=hl7.model.V2_6.table.Table0009.getInstance();
		tables[32]=hl7.model.V2_6.table.Table0171.getInstance();
		tables[33]=hl7.model.V2_6.table.Table0296.getInstance();
		tables[34]=hl7.model.V2_6.table.Table0220.getInstance();
		tables[35]=hl7.model.V2_6.table.Table0215.getInstance();
		tables[36]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[37]=hl7.model.V2_6.table.Table0231.getInstance();
		tables[38]=hl7.model.V2_6.table.Table0006.getInstance();
		tables[39]=null;
		tables[40]=hl7.model.V2_6.table.Table0212.getInstance();
		tables[41]=hl7.model.V2_6.table.Table0189.getInstance();
		tables[42]=hl7.model.V2_6.table.Table0002.getInstance();
		tables[43]=null;
		tables[44]=null;
		tables[45]=null;
		tables[46]=null;
		tables[47]=hl7.model.V2_6.table.Table0311.getInstance();
		tables[48]=null;
		tables[49]=null;
		tables[50]=hl7.model.V2_6.table.Table0222.getInstance();
		tables[51]=null;
		tables[52]=null;
		tables[53]=hl7.model.V2_6.table.Table0222.getInstance();
		tables[54]=null;
		tables[55]=null;
		tables[56]=hl7.model.V2_6.table.Table0232.getInstance();
		tables[57]=null;
		tables[58]=hl7.model.V2_6.table.Table0312.getInstance();
		tables[59]=hl7.model.V2_6.table.Table0313.getInstance();
		tables[60]=null;
		tables[61]=hl7.model.V2_6.table.Table0063.getInstance();
		tables[62]=null;
		tables[63]=null;
		tables[64]=hl7.model.V2_6.table.Table0343.getInstance();
		tables[65]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[66]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[67]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[68]=null;
		tables[69]=null;
		tables[70]=hl7.model.V2_6.table.Table0005.getInstance();
		tables[71]=hl7.model.V2_6.table.Table0344.getInstance();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==37) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==47) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==53) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==56) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==58) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==59) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==32) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==41) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==42) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==61) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==64) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==70) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==71) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.IN2 type = (hl7.model.V2_51.segment.IN2)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.IN2 type = (hl7.model.V2_7.segment.IN2)this;

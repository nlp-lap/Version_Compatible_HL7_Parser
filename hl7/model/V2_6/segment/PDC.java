...
public class PDC extends hl7.model.V2_51.segment.PDC{
	...
	static{
		...
		tables[9]=hl7.model.V2_6.table.Table0330.getInstance();
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		...
		descriptions[0]="MANUFACTURER_DISTRIBUTOR";
		descriptions[1]="COUNTRY";
		descriptions[2]="BRAND_NAME";
		descriptions[3]="DEVICE_FAMILY_NAME";
		descriptions[4]="GENERIC_NAME";
		descriptions[5]="MODEL_IDENTIFIER";
		descriptions[6]="CATALOGUE_IDENTIFIER";
		descriptions[7]="OTHER_IDENTIFIER";
		descriptions[8]="PRODUCT_CODE";
		descriptions[9]="MARKETING_BASIS";
		descriptions[10]="MARKETING_APPROVAL_ID";
		descriptions[11]="LABELED_SHELF_LIFE";
		descriptions[12]="EXPECTED_SHELF_LIFE";
		descriptions[13]="DATE_FIRST_MARKETED";
		descriptions[14]="DATE_LAST_MARKETED";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PDC seg = new hl7.pseudo.segment.PDC();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.PDC type = (hl7.model.V2_51.segment.PDC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PDC type = (hl7.model.V2_7.segment.PDC)this;

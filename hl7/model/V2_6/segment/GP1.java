...
public class GP1 extends hl7.model.V2_51.segment.GP1{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0455.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0456.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0457.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0458.getInstance();
		tables[4]=null;
		
		descriptions[0]="TYPE_OF_BILL_CODE";
		descriptions[1]="REVENUE_CODE";
		descriptions[2]="OVERALL_CLAIM_DISPOSITION_CODE";
		descriptions[3]="OCE_EDITS_PER_VISIT_CODE";
		descriptions[4]="OUTLIER_COST";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.GP1 seg = new hl7.pseudo.segment.GP1();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.GP1 type = (hl7.model.V2_51.segment.GP1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.GP1 type = (hl7.model.V2_7.segment.GP1)this;

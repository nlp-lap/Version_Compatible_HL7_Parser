...
public class PCR extends hl7.model.V2_51.segment.PCR{
	...
	static{
		...
		tables[1]=hl7.model.V2_6.table.Table0249.getInstance();
		tables[2]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0244.getInstance();
		tables[9]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[10]=hl7.model.V2_6.table.Table0245.getInstance();
		tables[11]=null;
		tables[12]=hl7.model.V2_6.table.Table0246.getInstance();
		tables[13]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[14]=hl7.model.V2_6.table.Table0247.getInstance();
		tables[15]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[16]=hl7.model.V2_6.table.Table0248.getInstance();
		tables[17]=null;
		tables[18]=hl7.model.V2_6.table.Table0242.getInstance();
		tables[19]=hl7.model.V2_6.table.Table0250.getInstance();
		tables[20]=hl7.model.V2_6.table.Table0251.getInstance();
		tables[21]=hl7.model.V2_6.table.Table0252.getInstance();
		tables[22]=hl7.model.V2_6.table.Table0253.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.PCR type = (hl7.model.V2_51.segment.PCR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PCR type = (hl7.model.V2_7.segment.PCR)this;

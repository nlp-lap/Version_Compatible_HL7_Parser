...
public class CON_ extends hl7.model.V2_51.segment.CON_{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0496.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_6.table.Table0497.getInstance();
		tables[10]=hl7.model.V2_6.table.Table0498.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		...
		tables[17]=hl7.model.V2_6.table.Table0296.getInstance();
		tables[18]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[19]=hl7.model.V2_6.table.Table0499.getInstance();
		tables[20]=hl7.model.V2_6.table.Table0500.getInstance();
		tables[21]=hl7.model.V2_6.table.Table0501.getInstance();
		tables[22]=hl7.model.V2_6.table.Table0502.getInstance();
		tables[23]=null;
		tables[24]=hl7.model.V2_6.table.Table0548.getInstance();
		
		descriptions[0]="SET_ID_CON";
		descriptions[1]="CONSENT_TYPE";
		descriptions[2]="CONSENT_FORM_ID_AND_VERSION";
		descriptions[3]="CONSENT_FORM_NUMBER";
		descriptions[4]="CONSENT_TEXT";
		descriptions[5]="SUBJECT_SPECIFIC_CONSENT_TEXT";
		descriptions[6]="CONSENT_BACKGROUND_INFORMATION";
		descriptions[7]="SUBJECT_SPECIFIC_CONSENT_BACKGROUND_TEXT";
		...
		descriptions[24]="RELATIONSHIP_TO_SUBJECT";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.CON_ type = (hl7.model.V2_51.segment.CON_)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.CON_ type = (hl7.model.V2_7.segment.CON_)this;

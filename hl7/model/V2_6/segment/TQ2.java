...
public class TQ2 extends hl7.model.V2_51.segment.TQ2{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0503.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table0504.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0505.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_6.table.Table0506.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.TQ2 type = (hl7.model.V2_51.segment.TQ2)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.TQ2 type = (hl7.model.V2_7.segment.TQ2)this;

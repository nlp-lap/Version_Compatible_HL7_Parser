...
public class PKG extends hl7.character.segment.PKG{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0818.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0532.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PKG type = (hl7.model.V2_7.segment.PKG)this;

...
public class OVR extends hl7.model.V2_51.segment.OVR{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0518.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0521.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		
		descriptions[0]="BUSINESS_RULE_OVERRIDE_TYPE";
		descriptions[1]="BUSINESS_RULE_OVERRIDE_CODE";
		descriptions[2]="OVERRIDE_COMMENTS";
		descriptions[3]="OVERRIDE_ENTERED_BY";
		descriptions[4]="OVERRIDE_AUTHORIZED_BY";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.OVR seg = new hl7.pseudo.segment.OVR();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.OVR type = (hl7.model.V2_51.segment.OVR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.OVR type = (hl7.model.V2_7.segment.OVR)this;

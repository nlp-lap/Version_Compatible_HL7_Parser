...
public class PRB extends hl7.model.V2_51.segment.PRB{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0287.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		...
		tables[23]=null;
		tables[24]=null;
		tables[25]=hl7.model.V2_6.table.Table0836.getInstance();
		tables[26]=hl7.model.V2_6.table.Table0838.getInstance();
		tables[27]=hl7.model.V2_6.table.Table0725.getInstance();
		
		descriptions[0]="ACTION_CODE";
		descriptions[1]="ACTION_DATE_TIME";
		descriptions[2]="PROBLEM_ID";
		descriptions[3]="PROBLEM_INSTANCE_ID";
		descriptions[4]="EPISODE_OF_CARE_ID";
		descriptions[5]="PROBLEM_LIST_PRIORITY";
		descriptions[6]="PROBLEM_ESTABLISHED_DATE_TIME";
		descriptions[7]="ANTICIPATED_PROBLEM_RESOLUTION_DATE_TIME";
		descriptions[8]="ACTUAL_PROBLEM_RESOLUTION_DATE_TIME";
		descriptions[9]="PROBLEM_CLASSIFICATION";
		descriptions[10]="PROBLEM_MANAGEMENT_DISCIPLINE";
		descriptions[11]="PROBLEM_PERSISTENCE";
		descriptions[12]="PROBLEM_CONFIRMATION_STATUS";
		descriptions[13]="PROBLEM_LIFE_CYCLE_STATUS";
		descriptions[14]="PROBLEM_LIFE_CYCLE_STATUS_DATE_TIME";
		descriptions[15]="PROBLEM_DATE_OF_ONSET";
		descriptions[16]="PROBLEM_ONSET_TEXT";
		descriptions[17]="PROBLEM_RANKING";
		descriptions[18]="CERTAINTY_OF_PROBLEM";
		descriptions[19]="PROBABILITY_OF_PROBLEM";
		descriptions[20]="INDIVIDUAL_AWARENESS_OF_PROBLEM";
		descriptions[21]="PROBLEM_PROGNOSIS";
		descriptions[22]="INDIVIDUAL_AWARENESS_OF_PROGNOSIS";
		descriptions[23]="FAMILY_SIGNIFICANT_OTHER_AWARENESS_OF_PROBLEM_PROGNOSIS";
		descriptions[24]="SECURITY_SENSITIVITY";
		descriptions[25]="PROBLEM_SEVERITY";
		descriptions[26]="PROBLEM_PERSPECTIVE";
		descriptions[27]="MOOD_CODE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PRB seg = new hl7.pseudo.segment.PRB();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==14) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==15) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==27) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.PRB type = (hl7.model.V2_51.segment.PRB)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PRB type = (hl7.model.V2_7.segment.PRB)this;

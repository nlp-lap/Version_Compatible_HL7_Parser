...
public class CER extends hl7.model.V2_51.segment.CER{
	...
	static{
		...
		standard[4]=hl7.pseudo.datastructure.XCN.CLASS;
		standard[5]=hl7.pseudo.datastructure.ED.CLASS;
		...
		standard[22]=hl7.bean.datastructure.primitive.DTM.CLASS;
		standard[23]=hl7.bean.datastructure.primitive.DTM.CLASS;
		standard[24]=hl7.bean.datastructure.primitive.DTM.CLASS;
		standard[25]=hl7.bean.datastructure.primitive.DTM.CLASS;
		standard[26]=hl7.bean.datastructure.primitive.DTM.CLASS;
		standard[27]=hl7.bean.datastructure.primitive.DTM.CLASS;
		standard[28]=hl7.bean.datastructure.primitive.DTM.CLASS;
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0399.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0347.getInstance();
		tables[8]=hl7.model.V2_6.table.Table0289.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		...
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[17]=null;
		tables[18]=hl7.model.V2_6.table.Table0399.getInstance();
		tables[19]=hl7.model.V2_6.table.Table0347.getInstance();
		tables[20]=hl7.model.V2_6.table.Table0289.getInstance();
		tables[21]=hl7.model.V2_6.table.Table0547.getInstance();
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		tables[25]=null;
		...
		tables[28]=null;
		tables[29]=null;
		tables[30]=hl7.model.V2_6.table.Table0536.getInstance();
		
		descriptions[0]="SET_ID_CER";
		descriptions[1]="SERIAL_NUMBER";
		descriptions[2]="VERSION";
		descriptions[3]="GRANTING_AUTHORITY";
		descriptions[4]="ISSUING_AUTHORITY";
		descriptions[5]="SIGNATURE_OF_ISSUING_AUTHORITY";
		descriptions[6]="GRANTING_COUNTRY";
		descriptions[7]="GRANTING_STATE_PROVINCE";
		descriptions[8]="GRANTING_COUNTY_PARISH";
		descriptions[9]="CERTIFICATE_TYPE";
		descriptions[10]="CERTIFICATE_DOMAIN";
		descriptions[11]="SUBJECT_ID";
		descriptions[12]="SUBJECT_NAME";
		descriptions[13]="SUBJECT_DIRECTORY_ATTRIBUTE_EXTENSION";
		descriptions[14]="SUBJECT_PUBLIC_KEY_INFO";
		descriptions[15]="AUTHORITY_KEY_IDENTIFIER";
		descriptions[16]="BASIC_CONSTRAINT";
		descriptions[17]="CRL_DISTRIBUTION_POINT";
		descriptions[18]="JURISDICTION_COUNTRY";
		descriptions[19]="JURISDICTION_STATE_PROVINCE";
		descriptions[20]="JURISDICTION_COUNTY_PARISH";
		descriptions[21]="JURISDICTION_BREADTH";
		descriptions[22]="GRANTING_DATE";
		descriptions[23]="ISSUING_DATE";
		descriptions[24]="ACTIVATION_DATE";
		descriptions[25]="INACTIVATION_DATE";
		descriptions[26]="EXPIRATION_DATE";
		descriptions[27]="RENEWAL_DATE";
		descriptions[28]="REVOCATION_DATE";
		descriptions[29]="REVOCATION_REASON_CODE";
		descriptions[30]="CERTIFICATE_STATUS_CODE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.CER seg = new hl7.pseudo.segment.CER();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==22) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==23) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==24) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==25) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==26) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==27) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==28) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.CER type = (hl7.model.V2_51.segment.CER)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.CER type = (hl7.model.V2_7.segment.CER)this;

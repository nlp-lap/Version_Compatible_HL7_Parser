...
public class PRA extends hl7.model.V2_51.segment.PRA{
	...
	static{
		...
		tables[1]=hl7.model.V2_6.table.Table0358.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0186.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0187.getInstance();
		tables[4]=hl7.model.V2_6.table.Table0337.getInstance();
		tables[5]=hl7.model.V2_6.table.Table0338.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0537.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_6.table.Table0401.getInstance();
		tables[11]=null;
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==2) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.PRA type = (hl7.model.V2_51.segment.PRA)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PRA type = (hl7.model.V2_7.segment.PRA)this;

...
public class UB1 extends hl7.model.V2_51.segment.UB1{
	...
	static{
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0043.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_6.table.Table0348.getInstance();
		tables[12]=hl7.model.V2_6.table.Table0349.getInstance();
		tables[13]=null;
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_6.table.Table0351.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		...
		descriptions[2]="BLOOD_FURNISHED_PINTS";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.UB1 type = (hl7.model.V2_51.segment.UB1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.UB1 type = (hl7.model.V2_7.segment.UB1)this;

...
public class APR extends hl7.model.V2_51.segment.APR{
	...
	static{
		standard[0]=hl7.pseudo.datastructure.SCV.CLASS;
		standard[1]=hl7.pseudo.datastructure.SCV.CLASS;
		standard[2]=hl7.pseudo.datastructure.SCV.CLASS;
		standard[3]=hl7.bean.datastructure.primitive.NM.CLASS;
		standard[4]=hl7.pseudo.datastructure.SCV.CLASS;
		
		tables[0]=hl7.model.V2_6.table.Table0294.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0294.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0294.getInstance();
		tables[3]=null;
		tables[4]=null;
		
		descriptions[0]="TIME_SELECTION_CRITERIA";
		descriptions[1]="RESOURCE_SELECTION_CRITERIA";
		descriptions[2]="LOCATION_SELECTION_CRITERIA";
		descriptions[3]="SLOT_SPACING_CRITERIA";
		descriptions[4]="FILLER_OVERRIDE_CRITERIA";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.APR seg = new hl7.pseudo.segment.APR();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.APR type = (hl7.model.V2_51.segment.APR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.APR type = (hl7.model.V2_7.segment.APR)this;

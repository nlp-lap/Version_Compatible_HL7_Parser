...
public class EQU extends hl7.model.V2_51.segment.EQU{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0365.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0366.getInstance();
		tables[4]=hl7.model.V2_6.table.Table0367.getInstance();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.EQU type = (hl7.model.V2_7.segment.EQU)this;

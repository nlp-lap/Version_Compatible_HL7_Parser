...
public class RXG extends hl7.model.V2_51.segment.RXG{
	...
	static{
		...
		standard[2]=hl7.pseudo.datastructure.TQ.CLASS;
		...
		standard[28]=hl7.pseudo.datastructure.PL.CLASS;
		standard[29]=hl7.pseudo.datastructure.XAD.CLASS;
		
		tables[0]=null;
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_6.table.Table0292.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[7]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[8]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[9]=hl7.model.V2_6.table.Table0167.getInstance();
		tables[10]=null;
		...
		tables[18]=null;
		tables[19]=null;
		tables[20]=hl7.model.V2_6.table.Table0227.getInstance();
		tables[21]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[22]=null;
		tables[23]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[24]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[25]=hl7.model.V2_6.table.Table0480.getInstance();
		...
		descriptions[1]="DISPENSE_SUB_ID_COUNTER";
		descriptions[2]="QUANTITY_TIMING";
		descriptions[3]="GIVE_CODE";
		descriptions[4]="GIVE_AMOUNT_MINIMUM";
		descriptions[5]="GIVE_AMOUNT_MAXIMUM";
		descriptions[6]="GIVE_UNITS";
		descriptions[7]="GIVE_DOSAGE_FORM";
		descriptions[8]="ADMINISTRATION_NOTES";
		descriptions[9]="SUBSTITUTION_STATUS";
		descriptions[10]="DISPENSE_TO_LOCATION";
		descriptions[11]="NEEDS_HUMAN_REVIEW";
		descriptions[12]="PHARMACY_TREATMENT_SUPPLIERS_SPECIAL_ADMINISTRATION_INSTRUCTIONS";
		descriptions[13]="GIVE_PER";
		descriptions[14]="GIVE_RATE_AMOUNT";
		descriptions[15]="GIVE_RATE_UNITS";
		descriptions[16]="GIVE_STRENGTH";
		descriptions[17]="GIVE_STRENGTH_UNITS";
		descriptions[18]="SUBSTANCE_LOT_NUMBER";
		descriptions[19]="SUBSTANCE_EXPIRATION_DATE";
		descriptions[20]="SUBSTANCE_MANUFACTURER_NAME";
		descriptions[21]="INDICATION";
		descriptions[22]="GIVE_DRUG_STRENGTH_VOLUME";
		descriptions[23]="GIVE_DRUG_STRENGTH_VOLUME_UNITS";
		descriptions[24]="GIVE_BARCODE_IDENTIFIER";
		descriptions[25]="PHARMACY_ORDER_TYPE";
		descriptions[26]="DISPENSE_TO_PHARMACY";
		descriptions[27]="DISPENSE_TO_PHARMACY_ADDRESS";
		descriptions[28]="DELIVER_TO_PATIENT_LOCATION";
		descriptions[29]="DELIVER_TO_ADDRESS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.RXG seg = new hl7.pseudo.segment.RXG();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==28) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.PL.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==29) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.RXG type = (hl7.model.V2_51.segment.RXG)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.RXG type = (hl7.model.V2_7.segment.RXG)this;

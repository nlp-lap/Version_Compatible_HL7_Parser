...
public class RCP extends hl7.model.V2_51.segment.RCP{
	...
	static{
		...
		standard[5]=hl7.pseudo.datastructure.SRT.CLASS;
		standard[6]=hl7.bean.datastructure.primitive.ID.CLASS;
		
		tables[0]=hl7.model.V2_6.table.Table0091.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0126.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0394.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_6.table.Table0395.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0391.getInstance();
		
		descriptions[0]="QUERY_PRIORITY";
		descriptions[1]="QUANTITY_LIMITED_REQUEST";
		descriptions[2]="RESPONSE_MODALITY";
		descriptions[3]="EXECUTION_AND_DELIVERY_TIME";
		descriptions[4]="MODIFY_INDICATOR";
		descriptions[5]="SORT_BY_FIELD";
		descriptions[6]="SEGMENT_GROUP_INCLUSION";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.RCP seg = new hl7.pseudo.segment.RCP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.RCP type = (hl7.model.V2_51.segment.RCP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.RCP type = (hl7.model.V2_7.segment.RCP)this;

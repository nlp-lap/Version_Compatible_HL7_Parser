...
public class OBX extends hl7.model.V2_51.segment.OBX{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0125.getInstance();
		tables[2]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[6]=null;
		tables[7]=hl7.model.V2_6.table.Table0078.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_6.table.Table0080.getInstance();
		tables[10]=hl7.model.V2_6.table.Table0085.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		...
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_6.table.Table0163.getInstance();
		tables[20]=null;
		tables[21]=hl7.model.V2_6.table.Table0725.getInstance();
		tables[22]=null;
		tables[23]=null;
		tables[24]=null;
		...
		descriptions[19]="OBSERVATION_SITE";
		descriptions[20]="OBSERVATION_INSTANCE_IDENTIFIER";
		descriptions[21]="MOOD_CODE";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==20) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==21) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.OBX type = (hl7.model.V2_51.segment.OBX)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.OBX type = (hl7.model.V2_7.segment.OBX)this;

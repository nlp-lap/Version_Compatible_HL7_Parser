...
public class DG1 extends hl7.model.V2_51.segment.DG1{
	...
	static{
		...
		standard[7]=hl7.pseudo.datastructure.CNE.CLASS;
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0051.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table0052.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0118.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0055.getInstance();
		tables[8]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[9]=hl7.model.V2_6.table.Table0056.getInstance();
		tables[10]=hl7.model.V2_6.table.Table0083.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_6.table.Table0359.getInstance();
		tables[15]=null;
		tables[16]=hl7.model.V2_6.table.Table0228.getInstance();
		tables[17]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=hl7.model.V2_6.table.Table0206.getInstance();
		tables[21]=null;
		tables[22]=hl7.model.V2_6.table.Table0728.getInstance();
		tables[23]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[24]=hl7.model.V2_6.table.Table0731.getInstance();
		tables[25]=hl7.model.V2_6.table.Table0895.getInstance();
		...
		descriptions[21]="PARENT_DIAGNOSIS";
		descriptions[22]="DRG_CCL_VALUE_CODE";
		descriptions[23]="DRG_GROUPING_USAGE";
		descriptions[24]="DRG_DIAGNOSIS_DETERMINATION_STATUS";
		descriptions[25]="PRESENT_ON_ADMISSION_INDICATOR";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==6) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==7) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==21) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.DG1 type = (hl7.model.V2_7.segment.DG1)this;

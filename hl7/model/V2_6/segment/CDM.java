...
public class CDM extends hl7.model.V2_51.segment.CDM{
	...
	static{
		...
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_6.table.Table0268.getInstance();
		tables[5]=hl7.model.V2_6.table.Table0132.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0088.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0183.getInstance();
		tables[8]=hl7.model.V2_6.table.Table0463.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.CDM type = (hl7.model.V2_51.segment.CDM)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.CDM type = (hl7.model.V2_7.segment.CDM)this;

...
public class NTE extends hl7.model.V2_51.segment.NTE{
	...
	static{
		...
		standard[2]=hl7.bean.datastructure.primitive.FT.CLASS;
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0105.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_6.table.Table0364.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		
		descriptions[0]="SET_ID_NTE";
		descriptions[1]="SOURCE_OF_COMMENT";
		descriptions[2]="COMMENT";
		descriptions[3]="COMMENT_TYPE";
		descriptions[4]="ENTERED_BY";
		descriptions[5]="ENTERED_DATE_TIME";
		descriptions[6]="EFFECTIVE_START_DATE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.NTE seg = new hl7.pseudo.segment.NTE();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.NTE type = (hl7.model.V2_51.segment.NTE)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.NTE type = (hl7.model.V2_7.segment.NTE)this;

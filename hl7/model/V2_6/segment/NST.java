...
public class NST extends hl7.model.V2_51.segment.NST{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0332.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.NST type = (hl7.model.V2_7.segment.NST)this;

...
public class BPX extends hl7.model.V2_51.segment.BPX{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0510.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0511.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[6]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0512.getInstance();
		tables[8]=null;
		tables[9]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.BPX type = (hl7.model.V2_51.segment.BPX)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.BPX type = (hl7.model.V2_7.segment.BPX)this;

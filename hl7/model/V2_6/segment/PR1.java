...
public class PR1 extends hl7.model.V2_51.segment.PR1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0088.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table0230.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0019.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_6.table.Table0059.getInstance();
		tables[13]=hl7.model.V2_6.table.Table0418.getInstance();
		tables[14]=hl7.model.V2_6.table.Table0051.getInstance();
		tables[15]=hl7.model.V2_6.table.Table0340.getInstance();
		tables[16]=hl7.model.V2_6.table.Table0416.getInstance();
		tables[17]=hl7.model.V2_6.table.Table0417.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_6.table.Table0206.getInstance();
		tables[20]=hl7.model.V2_6.table.Table0761.getInstance();
		tables[21]=hl7.model.V2_6.table.Table0763.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==2) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==15) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.PR1 type = (hl7.model.V2_51.segment.PR1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PR1 type = (hl7.model.V2_7.segment.PR1)this;

...
public class IIM extends hl7.model.V2_51.segment.IIM{
	...
	static{
		...
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_6.table.Table0088.getInstance();
		tables[14]=hl7.model.V2_6.table.Table0340.getInstance();
		
		descriptions[0]="PRIMARY_KEY_VALUE_IIM";
		descriptions[1]="SERVICE_ITEM_CODE";
		descriptions[2]="INVENTORY_LOT_NUMBER";
		descriptions[3]="INVENTORY_EXPIRATION_DATE";
		descriptions[4]="INVENTORY_MANUFACTURER_NAME";
		descriptions[5]="INVENTORY_LOCATION";
		descriptions[6]="INVENTORY_RECEIVED_DATE";
		descriptions[7]="INVENTORY_RECEIVED_QUANTITY";
		descriptions[8]="INVENTORY_RECEIVED_QUANTITY_UNIT";
		descriptions[9]="INVENTORY_RECEIVED_ITEM_COST";
		descriptions[10]="INVENTORY_ON_HAND_DATE";
		descriptions[11]="INVENTORY_ON_HAND_QUANTITY";
		descriptions[12]="INVENTORY_ON_HAND_QUANTITY_UNIT";
		descriptions[13]="PROCEDURE_CODE";
		descriptions[14]="PROCEDURE_CODE_MODIFIER";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.IIM seg = new hl7.pseudo.segment.IIM();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==13) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==14) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.IIM type = (hl7.model.V2_51.segment.IIM)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.IIM type = (hl7.model.V2_7.segment.IIM)this;

...
public class RF1 extends hl7.model.V2_51.segment.RF1{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0283.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0280.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0281.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0282.getInstance();
		tables[4]=hl7.model.V2_6.table.Table0284.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_6.table.Table0336.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_6.table.Table0865.getInstance();
		...
		descriptions[11]="REFERRAL_DOCUMENTATION_COMPLETION_STATUS";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.RF1 type = (hl7.model.V2_51.segment.RF1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.RF1 type = (hl7.model.V2_7.segment.RF1)this;

...
public class GP2 extends hl7.model.V2_51.segment.GP2{
	...
	static{
		...
		standard[2]=hl7.pseudo.datastructure.CP.CLASS;
		...
		tables[0]=hl7.model.V2_6.table.Table0456.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_6.table.Table0459.getInstance();
		tables[4]=hl7.model.V2_6.table.Table0460.getInstance();
		tables[5]=hl7.model.V2_6.table.Table0458.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0466.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0467.getInstance();
		tables[8]=hl7.model.V2_6.table.Table0468.getInstance();
		tables[9]=hl7.model.V2_6.table.Table0469.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_6.table.Table0470.getInstance();
		tables[12]=null;
		tables[13]=null;
		
		descriptions[0]="REVENUE_CODE";
		descriptions[1]="NUMBER_OF_SERVICE_UNITS";
		descriptions[2]="CHARGE";
		descriptions[3]="REIMBURSEMENT_ACTION_CODE";
		descriptions[4]="DENIAL_OR_REJECTION_CODE";
		descriptions[5]="OCE_EDIT_CODE";
		descriptions[6]="AMBULATORY_PAYMENT_CLASSIFICATION_CODE";
		descriptions[7]="MODIFIER_EDIT_CODE";
		descriptions[8]="PAYMENT_ADJUSTMENT_CODE";
		descriptions[9]="PACKAGING_STATUS_CODE";
		descriptions[10]="EXPECTED_CMS_PAYMENT_AMOUNT";
		descriptions[11]="REIMBURSEMENT_TYPE_CODE";
		descriptions[12]="CO_PAY_AMOUNT";
		descriptions[13]="PAY_RATE_PER_SERVICE_UNIT";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.GP2 seg = new hl7.pseudo.segment.GP2();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.GP2 type = (hl7.model.V2_51.segment.GP2)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.GP2 type = (hl7.model.V2_7.segment.GP2)this;

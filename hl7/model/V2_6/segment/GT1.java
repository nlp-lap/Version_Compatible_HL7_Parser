...
public class GT1 extends hl7.model.V2_51.segment.GT1{
	...
	static{
		...
		standard[29]=hl7.pseudo.datastructure.CWE.CLASS;
		...
		standard[43]=hl7.pseudo.datastructure.CWE.CLASS;
		...
		standard[54]=hl7.pseudo.datastructure.CWE.CLASS;
		standard[55]=hl7.bean.datastructure.primitive.ST.CLASS;
		...
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0001.getInstance();
		tables[9]=hl7.model.V2_6.table.Table0068.getInstance();
		tables[10]=hl7.model.V2_6.table.Table0063.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		...
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_6.table.Table0066.getInstance();
		tables[20]=null;
		tables[21]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[22]=hl7.model.V2_6.table.Table0341.getInstance();
		tables[23]=null;
		tables[24]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[25]=hl7.model.V2_6.table.Table0218.getInstance();
		tables[26]=null;
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_6.table.Table0002.getInstance();
		tables[30]=null;
		tables[31]=null;
		tables[32]=hl7.model.V2_6.table.Table0223.getInstance();
		tables[33]=hl7.model.V2_6.table.Table0009.getInstance();
		tables[34]=hl7.model.V2_6.table.Table0171.getInstance();
		tables[35]=hl7.model.V2_6.table.Table0296.getInstance();
		tables[36]=hl7.model.V2_6.table.Table0220.getInstance();
		tables[37]=hl7.model.V2_6.table.Table0215.getInstance();
		tables[38]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[39]=hl7.model.V2_6.table.Table0231.getInstance();
		tables[40]=hl7.model.V2_6.table.Table0006.getInstance();
		tables[41]=null;
		tables[42]=hl7.model.V2_6.table.Table0212.getInstance();
		tables[43]=hl7.model.V2_6.table.Table0189.getInstance();
		tables[44]=hl7.model.V2_6.table.Table0200.getInstance();
		tables[45]=null;
		tables[46]=hl7.model.V2_6.table.Table0222.getInstance();
		tables[47]=hl7.model.V2_6.table.Table0063.getInstance();
		tables[48]=null;
		tables[49]=null;
		tables[50]=null;
		tables[51]=hl7.model.V2_6.table.Table0295.getInstance();
		tables[52]=hl7.model.V2_6.table.Table0311.getInstance();
		tables[53]=null;
		tables[54]=hl7.model.V2_6.table.Table0005.getInstance();
		tables[55]=null;
		tables[56]=hl7.model.V2_6.table.Table0099.getInstance();
		
		descriptions[0]="SET_ID_GT1";
		...
		descriptions[8]="GUARANTOR_ADMINISTRATIVE_SEX";
		...
		descriptions[17]="GUARANTOR_EMPLOYER_PHONE_NUMBER";
		descriptions[18]="GUARANTOR_EMPLOYEE_ID_NUMBER";
		descriptions[19]="GUARANTOR_EMPLOYMENT_STATUS";
		descriptions[20]="GUARANTOR_ORGANIZATION_NAME";
		...
		descriptions[55]="GUARANTOR_BIRTH_PLACE";
		descriptions[56]="VIP_INDICATOR";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==8) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==36) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==51) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==52) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==25) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==29) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==43) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==46) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==54) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.GT1 type = (hl7.model.V2_51.segment.GT1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.GT1 type = (hl7.model.V2_7.segment.GT1)this;

...
public class PID extends hl7.model.V2_51.segment.PID{
	...
	static{
		...
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_6.table.Table0200.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_6.table.Table0001.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_6.table.Table0005.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_6.table.Table0289.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_6.table.Table0296.getInstance();
		tables[15]=hl7.model.V2_6.table.Table0002.getInstance();
		tables[16]=hl7.model.V2_6.table.Table0006.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=hl7.model.V2_6.table.Table0189.getInstance();
		tables[22]=null;
		tables[23]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[24]=null;
		tables[25]=hl7.model.V2_6.table.Table0171.getInstance();
		tables[26]=hl7.model.V2_6.table.Table0172.getInstance();
		tables[27]=hl7.model.V2_6.table.Table0212.getInstance();
		tables[28]=null;
		tables[29]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[30]=hl7.model.V2_6.table.Table0136.getInstance();
		tables[31]=hl7.model.V2_6.table.Table0445.getInstance();
		tables[32]=null;
		tables[33]=null;
		tables[34]=hl7.model.V2_6.table.Table0446.getInstance();
		tables[35]=hl7.model.V2_6.table.Table0447.getInstance();
		tables[36]=null;
		tables[37]=hl7.model.V2_6.table.Table0429.getInstance();
		tables[38]=hl7.model.V2_6.table.Table0171.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.PID type = (hl7.model.V2_51.segment.PID)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PID type = (hl7.model.V2_7.segment.PID)this;

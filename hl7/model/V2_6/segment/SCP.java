...
public class SCP extends hl7.character.segment.SCP{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0651.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0653.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0657.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0659.getInstance();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.SCP type = (hl7.model.V2_7.segment.SCP)this;

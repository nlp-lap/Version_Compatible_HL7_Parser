...
public class SAC extends hl7.model.V2_51.segment.SAC{
	...
	static{
		...
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_6.table.Table0370.getInstance();
		tables[8]=hl7.model.V2_6.table.Table0378.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_6.table.Table0379.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[15]=null;
		tables[16]=null;
		tables[17]=null;
		tables[18]=null;
		...
		tables[24]=hl7.model.V2_6.table.Table0380.getInstance();
		tables[25]=hl7.model.V2_6.table.Table0381.getInstance();
		tables[26]=hl7.model.V2_6.table.Table0371.getInstance();
		tables[27]=hl7.model.V2_6.table.Table0372.getInstance();
		tables[28]=null;
		tables[29]=hl7.model.V2_6.table.Table0373.getInstance();
		tables[30]=null;
		tables[31]=null;
		tables[32]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[33]=null;
		tables[34]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[35]=null;
		tables[36]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[37]=null;
		tables[38]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[39]=hl7.model.V2_6.table.Table0374.getInstance();
		tables[40]=hl7.model.V2_6.table.Table0382.getInstance();
		tables[41]=hl7.model.V2_6.table.Table0375.getInstance();
		tables[42]=hl7.model.V2_6.table.Table0376.getInstance();
		tables[43]=hl7.model.V2_6.table.Table0377.getInstance();
		...
		descriptions[21]="AVAILABLE_SPECIMEN_VOLUME";
		...
		descriptions[42]="SPECIAL_HANDLING_CODE";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.SAC type = (hl7.model.V2_51.segment.SAC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.SAC type = (hl7.model.V2_7.segment.SAC)this;

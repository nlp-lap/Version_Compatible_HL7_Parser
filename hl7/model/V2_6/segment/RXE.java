...
public class RXE extends hl7.model.V2_51.segment.RXE{
	...
	static{
		...
		standard[31]=hl7.bean.datastructure.primitive.DTM.CLASS;
		...
		tables[7]=null;
		tables[8]=hl7.model.V2_6.table.Table0167.getInstance();
		tables[9]=null;
		...
		tables[29]=hl7.model.V2_6.table.Table0321.getInstance();
		tables[30]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[31]=null;
		tables[32]=null;
		tables[33]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[34]=hl7.model.V2_6.table.Table0477.getInstance();
		tables[35]=hl7.model.V2_6.table.Table0478.getInstance();
		...
		tables[41]=null;
		tables[42]=null;
		tables[43]=hl7.model.V2_6.table.Table0480.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==31) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DTM.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.RXE type = (hl7.model.V2_7.segment.RXE)this;

...
public class ARV extends hl7.character.segment.ARV{
	...
	static{
		...
		tables[2]=hl7.model.V2_6.table.Table0717.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0719.getInstance();
		tables[4]=null;
		tables[5]=null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.ARV type = (hl7.model.V2_7.segment.ARV)this;

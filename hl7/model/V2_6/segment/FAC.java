...
public class FAC extends hl7.model.V2_51.segment.FAC{
	...
	static{
		...
		standard[7]=hl7.pseudo.datastructure.XTN.CLASS;
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0331.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		descriptions[0]="FACILITY_ID_FAC";
		descriptions[1]="FACILITY_TYPE";
		descriptions[2]="FACILITY_ADDRESS";
		descriptions[3]="FACILITY_TELECOMMUNICATION";
		descriptions[4]="CONTACT_PERSON";
		descriptions[5]="CONTACT_TITLE";
		descriptions[6]="CONTACT_ADDRESS";
		descriptions[7]="CONTACT_TELECOMMUNICATION";
		descriptions[8]="SIGNATURE_AUTHORITY";
		descriptions[9]="SIGNATURE_AUTHORITY_TITLE";
		descriptions[10]="SIGNATURE_AUTHORITY_ADDRESS";
		descriptions[11]="SIGNATURE_AUTHORITY_TELECOMMUNICATION";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.FAC seg = new hl7.pseudo.segment.FAC();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.FAC type = (hl7.model.V2_51.segment.FAC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.FAC type = (hl7.model.V2_7.segment.FAC)this;

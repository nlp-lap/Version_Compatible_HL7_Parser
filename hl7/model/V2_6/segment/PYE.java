...
public class PYE extends hl7.character.segment.PYE{
	...
	static{
		...
		standard[5]=hl7.pseudo.datastructure.XAD.CLASS;
		standard[6]=hl7.bean.datastructure.primitive.IS.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_6.table.Table0557.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0558.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0570.getInstance();
		
		descriptions[0]="SET_ID_PYE";
		descriptions[1]="PAYEE_TYPE";
		descriptions[2]="PAYEE_RELATIONSHIP_TO_INVOICE";
		descriptions[3]="PAYEE_IDENTIFICATION_LIST";
		descriptions[4]="PAYEE_PERSON_NAME";
		descriptions[5]="PAYEE_ADDRESS";
		descriptions[6]="PAYMENT_METHOD";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PYE seg = new hl7.pseudo.segment.PYE();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.PYE type = (hl7.model.V2_7.segment.PYE)this;

...
public class LOC extends hl7.model.V2_51.segment.LOC{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0260.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_6.table.Table0461.getInstance();
		tables[7]=hl7.model.V2_6.table.Table0261.getInstance();
		tables[8]=hl7.model.V2_6.table.Table0442.getInstance();
		
		descriptions[0]="PRIMARY_KEY_VALUE_LOC";
		descriptions[1]="LOCATION_DESCRIPTION";
		descriptions[2]="LOCATION_TYPE_LOC";
		descriptions[3]="ORGANIZATION_NAME_LOC";
		descriptions[4]="LOCATION_ADDRESS";
		descriptions[5]="LOCATION_PHONE";
		descriptions[6]="LICENSE_NUMBER";
		descriptions[7]="LOCATION_EQUIPMENT";
		descriptions[8]="LOCATION_SERVICE_CODE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.LOC seg = new hl7.pseudo.segment.LOC();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.LOC type = (hl7.model.V2_51.segment.LOC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.LOC type = (hl7.model.V2_7.segment.LOC)this;

...
public class FT1 extends hl7.model.V2_51.segment.FT1{
	...
	static{
		...
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_6.table.Table0017.getInstance();
		tables[6]=hl7.model.V2_6.table.Table0132.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_6.table.Table0049.getInstance();
		tables[13]=hl7.model.V2_6.table.Table0072.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_6.table.Table0024.getInstance();
		tables[17]=hl7.model.V2_6.table.Table0018.getInstance();
		tables[18]=hl7.model.V2_6.table.Table0051.getInstance();
		tables[19]=hl7.model.V2_6.table.Table0084.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		tables[24]=hl7.model.V2_6.table.Table0088.getInstance();
		tables[25]=hl7.model.V2_6.table.Table0340.getInstance();
		tables[26]=hl7.model.V2_6.table.Table0339.getInstance();
		tables[27]=hl7.model.V2_6.table.Table0476.getInstance();
		tables[28]=hl7.model.V2_6.table.Table0549.getInstance();
		tables[29]=null;
		tables[30]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==24) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==25) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.FT1 type = (hl7.model.V2_7.segment.FT1)this;

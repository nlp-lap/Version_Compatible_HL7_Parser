...
public class STZ extends hl7.character.segment.STZ{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0806.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_6.table.Table0809.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0811.getInstance();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.STZ type = (hl7.model.V2_7.segment.STZ)this;

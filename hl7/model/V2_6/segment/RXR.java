...
public class RXR extends hl7.model.V2_51.segment.RXR{
	...
	static{
		...
		tables[0]=hl7.model.V2_6.table.Table0162.getInstance();
		tables[1]=hl7.model.V2_6.table.Table0550.getInstance();
		tables[2]=hl7.model.V2_6.table.Table0164.getInstance();
		tables[3]=hl7.model.V2_6.table.Table0165.getInstance();
		tables[4]=hl7.model.V2_6.table.Table9999.getInstance();
		tables[5]=hl7.model.V2_6.table.Table0495.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.segment.RXR type = (hl7.model.V2_51.segment.RXR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.segment.RXR type = (hl7.model.V2_7.segment.RXR)this;

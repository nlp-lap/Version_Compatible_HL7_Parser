...
public class QBP_Qnn extends hl7.model.V2_51.message.QBP_Qnn{
	...
	static{
		...
		standard[3]=hl7.pseudo.segment.QPD.CLASS;
		standard[4]=hl7.pseudo.segment.RDF.CLASS;
		standard[5]=hl7.pseudo.segment.RCP.CLASS;
		standard[6]=hl7.pseudo.segment.DSC.CLASS;
		standard[7]=hl7.pseudo.segment.MSH.CLASS;
		standard[8]=hl7.pseudo.segment.SFT.CLASS;
		standard[9]=hl7.pseudo.segment.UAC.CLASS;
		standard[10]=hl7.pseudo.segment.MSA.CLASS;
		standard[11]=hl7.pseudo.segment.ERR.CLASS;
		standard[12]=hl7.pseudo.segment.QAK.CLASS;
		standard[13]=hl7.pseudo.segment.QPD.CLASS;
		standard[14]=hl7.pseudo.segment.DSC.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.message.QBP_Qnn type = (hl7.model.V2_51.message.QBP_Qnn)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.message.QBP_Qnn type = (hl7.model.V2_7.message.QBP_Qnn)this;

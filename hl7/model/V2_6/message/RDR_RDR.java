package hl7.model.V2_6.message;
...
public class RDR_RDR extends hl7.model.V2_51.message.RDR_RDR{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.ERR.CLASS;
		standard[3]=hl7.pseudo.segment.SFT.CLASS;
		standard[4]=hl7.pseudo.segment.UAC.CLASS;
		standard[5]=hl7.pseudo.segment.QRD.CLASS;
		standard[6]=hl7.pseudo.segment.QRF.CLASS;
		standard[7]=hl7.pseudo.segment.PID.CLASS;
		standard[8]=hl7.pseudo.segment.NTE.CLASS;
		standard[9]=hl7.pseudo.segment.ORC.CLASS;
		standard[10]=hl7.pseudo.segment.TQ1.CLASS;
		standard[11]=hl7.pseudo.segment.TQ2.CLASS;
		standard[12]=hl7.pseudo.segment.RXE.CLASS;
		standard[13]=hl7.pseudo.segment.TQ1.CLASS;
		standard[14]=hl7.pseudo.segment.TQ2.CLASS;
		standard[15]=hl7.pseudo.segment.RXR.CLASS;
		standard[16]=hl7.pseudo.segment.RXC.CLASS;
		standard[17]=hl7.pseudo.segment.RXD.CLASS;
		standard[18]=hl7.pseudo.segment.RXR.CLASS;
		standard[19]=hl7.pseudo.segment.MSH.CLASS;
		standard[20]=hl7.pseudo.segment.MSA.CLASS;
		standard[21]=hl7.pseudo.segment.ERR.CLASS;
		standard[22]=hl7.pseudo.segment.SFT.CLASS;
		standard[23]=hl7.pseudo.segment.UAC.CLASS;
		standard[25]=hl7.pseudo.segment.DSC.CLASS;
		standard[26]=hl7.pseudo.segment.RXC.CLASS;
		standard[27]=hl7.pseudo.segment.DSC.CLASS;
		standard[24]=hl7.pseudo.group.DEFINITION_RDR_RDR.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[24] = subComponents[4];
		components[25] = subComponents[5];
		components[4] = null;
		components[5] = null;
		components[6] = null;
		components[7] = null;
	...
	public static void forward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		...
		subComponents[19] = components[4];
		subComponents[20] = components[5];
		subComponents[21] = components[6];
		subComponents[22] = components[7];
		subComponents[24] = components[8];
		subComponents[25] = components[10];
		subComponents[27] = components[10];
		subComponents[4] = null;
		subComponents[5] = null;
		subComponents[6] = null;
		subComponents[7] = null;
		subComponents[8] = null;
		subComponents[9] = null;
		subComponents[10] = null;
		subComponents[11] = null;
		subComponents[12] = null;
		subComponents[13] = null;
		subComponents[14] = null;
		subComponents[15] = null;
		subComponents[16] = null;
		subComponents[17] = null;
		subComponents[18] = null;
		subComponents[23] = null;
		subComponents[26] = null;
	}
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.message.RDR_RDR type = (hl7.model.V2_51.message.RDR_RDR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.message.RDR_RDR type = (hl7.model.V2_5.message.RDR_RDR)this;

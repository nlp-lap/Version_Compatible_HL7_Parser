...
public class ADT_A03 extends hl7.model.V2_51.message.ADT_A03{
	...
	static{
		...
		standard[14]=hl7.pseudo.segment.AL1.CLASS;
		standard[15]=hl7.pseudo.segment.DG1.CLASS;
		standard[16]=hl7.pseudo.segment.DRG.CLASS;
		standard[18]=hl7.pseudo.segment.OBX.CLASS;
		standard[19]=hl7.pseudo.segment.GT1.CLASS;
		standard[21]=hl7.pseudo.segment.ACC.CLASS;
		standard[22]=hl7.pseudo.segment.PDA.CLASS;
		standard[17]=hl7.pseudo.group.PROCEDURE_ADT_A03.CLASS;
		standard[20]=hl7.pseudo.group.INSURANCE_ADT_A03.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.message.ADT_A03 type = (hl7.model.V2_51.message.ADT_A03)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.message.ADT_A03 type = (hl7.model.V2_7.message.ADT_A03)this;

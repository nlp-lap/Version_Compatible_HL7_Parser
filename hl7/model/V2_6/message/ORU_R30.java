...
public class ORU_R30 extends hl7.model.V2_51.message.ORU_R30{
	...
	static{
		...
		standard[7]=hl7.pseudo.segment.ORC.CLASS;
		standard[8]=hl7.pseudo.segment.OBR.CLASS;
		standard[9]=hl7.pseudo.segment.NTE.CLASS;
		standard[10]=hl7.pseudo.segment.ROL.CLASS;
		standard[6]=hl7.pseudo.group.VISIT_ORU_R30.CLASS;
		standard[11]=hl7.pseudo.group.TIMING_QTY_ORU_R30.CLASS;
		standard[12]=hl7.pseudo.group.OBSERVATION_ORU_R30.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.message.ORU_R30 type = (hl7.model.V2_51.message.ORU_R30)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.message.ORU_R30 type = (hl7.model.V2_7.message.ORU_R30)this;

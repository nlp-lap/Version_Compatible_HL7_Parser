...
public class PMU_B01 extends hl7.model.V2_51.message.PMU_B01{
	...
	static{
		...
		standard[4]=hl7.pseudo.segment.STF.CLASS;
		standard[5]=hl7.pseudo.segment.PRA.CLASS;
		standard[6]=hl7.pseudo.segment.ORG.CLASS;
		standard[7]=hl7.pseudo.segment.AFF.CLASS;
		standard[8]=hl7.pseudo.segment.LAN.CLASS;
		standard[9]=hl7.pseudo.segment.EDU.CLASS;
		standard[10]=hl7.pseudo.segment.CER.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_51.message.PMU_B01 type = (hl7.model.V2_51.message.PMU_B01)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.message.PMU_B01 type = (hl7.model.V2_7.message.PMU_B01)this;

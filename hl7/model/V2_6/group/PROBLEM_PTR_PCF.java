...
public class PROBLEM_PTR_PCF extends hl7.model.V2_51.group.PROBLEM_PTR_PCF{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PTR_PCF.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_OBSERVATION_PTR_PCF.CLASS;
		standard[5]=hl7.pseudo.group.GOAL_PTR_PCF.CLASS;
		standard[6]=hl7.pseudo.group.ORDER_PTR_PCF.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PTR_PCF group = new hl7.pseudo.group.PROBLEM_PTR_PCF();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_51.group.PROBLEM_PTR_PCF type = (hl7.model.V2_51.group.PROBLEM_PTR_PCF)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.group.PROBLEM_PTR_PCF type = (hl7.model.V2_7.group.PROBLEM_PTR_PCF)this;

...
public class ASSOCIATED_PERSON_PEX_P07 extends hl7.model.V2_51.group.ASSOCIATED_PERSON_PEX_P07{
	...
	static{
		standard[0]=hl7.pseudo.segment.NK1.CLASS;
		standard[3]=hl7.pseudo.segment.PRB.CLASS;
		standard[4]=hl7.pseudo.segment.OBX.CLASS;
		standard[1]=hl7.pseudo.group.ASSOCIATED_RX_ORDER_PEX_P07.CLASS;
		standard[2]=hl7.pseudo.group.ASSOCIATED_RX_ADMIN_PEX_P07.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ASSOCIATED_PERSON_PEX_P07 group = new hl7.pseudo.group.ASSOCIATED_PERSON_PEX_P07();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_51.group.ASSOCIATED_PERSON_PEX_P07 type = (hl7.model.V2_51.group.ASSOCIATED_PERSON_PEX_P07)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.group.ASSOCIATED_PERSON_PEX_P07 type = (hl7.model.V2_7.group.ASSOCIATED_PERSON_PEX_P07)this;

...
public class STUDY_SCHEDULE_CSU_C09 extends hl7.model.V2_51.group.STUDY_SCHEDULE_CSU_C09{
	...
	static{
		standard[0]=hl7.pseudo.segment.CSS.CLASS;
		standard[1]=hl7.pseudo.group.STUDY_OBSERVATION_CSU_C09.CLASS;
		standard[2]=hl7.pseudo.group.STUDY_PHARM_CSU_C09.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.STUDY_SCHEDULE_CSU_C09 group = new hl7.pseudo.group.STUDY_SCHEDULE_CSU_C09();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_51.group.STUDY_SCHEDULE_CSU_C09 type = (hl7.model.V2_51.group.STUDY_SCHEDULE_CSU_C09)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.group.STUDY_SCHEDULE_CSU_C09 type = (hl7.model.V2_7.group.STUDY_SCHEDULE_CSU_C09)this;

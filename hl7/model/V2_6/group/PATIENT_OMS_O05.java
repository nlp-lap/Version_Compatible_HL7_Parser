...
public class PATIENT_OMS_O05 extends hl7.model.V2_51.group.PATIENT_OMS_O05{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PATIENT_VISIT_OMS_O05.CLASS;
		standard[4]=hl7.pseudo.group.INSURANCE_OMS_O05.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PATIENT_OMS_O05 group = new hl7.pseudo.group.PATIENT_OMS_O05();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_51.group.PATIENT_OMS_O05 type = (hl7.model.V2_51.group.PATIENT_OMS_O05)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.group.PATIENT_OMS_O05 type = (hl7.model.V2_7.group.PATIENT_OMS_O05)this;

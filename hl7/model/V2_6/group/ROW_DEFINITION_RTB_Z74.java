...
public class ROW_DEFINITION_RTB_Z74 extends hl7.model.V2_51.group.ROW_DEFINITION_RTB_Z74{
	...
	static{
		standard[0]=hl7.pseudo.segment.RDF.CLASS;
		standard[1]=hl7.pseudo.segment.RDT.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ROW_DEFINITION_RTB_Z74 group = new hl7.pseudo.group.ROW_DEFINITION_RTB_Z74();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_51.group.ROW_DEFINITION_RTB_Z74 type = (hl7.model.V2_51.group.ROW_DEFINITION_RTB_Z74)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.group.ROW_DEFINITION_RTB_Z74 type = (hl7.model.V2_7.group.ROW_DEFINITION_RTB_Z74)this;

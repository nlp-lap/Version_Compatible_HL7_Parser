...
public class PROBLEM_PRR_PC5 extends hl7.model.V2_51.group.PROBLEM_PRR_PC5{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PRR_PC5.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_PATHWAY_PRR_PC5.CLASS;
		standard[5]=hl7.pseudo.group.PROBLEM_OBSERVATION_PRR_PC5.CLASS;
		standard[6]=hl7.pseudo.group.GOAL_PRR_PC5.CLASS;
		standard[7]=hl7.pseudo.group.ORDER_PRR_PC5.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PRR_PC5 group = new hl7.pseudo.group.PROBLEM_PRR_PC5();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_51.group.PROBLEM_PRR_PC5 type = (hl7.model.V2_51.group.PROBLEM_PRR_PC5)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.group.PROBLEM_PRR_PC5 type = (hl7.model.V2_7.group.PROBLEM_PRR_PC5)this;

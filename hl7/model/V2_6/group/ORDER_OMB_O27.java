...
public class ORDER_OMB_O27 extends hl7.model.V2_51.group.ORDER_OMB_O27{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.BPO.CLASS;
		standard[3]=hl7.pseudo.segment.SPM.CLASS;
		...
		standard[1]=hl7.pseudo.group.TIMING_OMB_O27.CLASS;
		standard[6]=hl7.pseudo.group.OBSERVATION_OMB_O27.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_OMB_O27 group = new hl7.pseudo.group.ORDER_OMB_O27();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_51.group.ORDER_OMB_O27 type = (hl7.model.V2_51.group.ORDER_OMB_O27)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.group.ORDER_OMB_O27 type = (hl7.model.V2_7.group.ORDER_OMB_O27)this;

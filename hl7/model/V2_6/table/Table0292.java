...
public class Table0292 extends Table{
	...
	private Table0292(){
		...
		putMap("09", "Td (adult)");
		putMap("10", "IPV");
		putMap("100", "pneumococcal conjugate");
		putMap("101", "typhoid, ViCPs");
		putMap("102", "DTP-Hib-Hep B");
		putMap("103", "meningococcal C conjugate");
		putMap("104", "Hep A-Hep B");
		putMap("105", "vaccinia (smallpox) diluted");
		putMap("106", "DTaP, 5 pertussis antigens6");
		putMap("107", "DTaP, NOS");
		putMap("108", "meningococcal, NOS");
		putMap("109", "pneumococcal, NOS");
		putMap("11", "pertussis");
		putMap("110", "DTaP-Hep B-IPV");
		putMap("111", "influenza, live, intranasal");
		putMap("112", "tetanus toxoid, NOS");
		putMap("113", "Td (adult)");
		putMap("114", "meningococcal A,C,Y,W-135 diphtheria conjugate");
		putMap("115", "Tdap");
		putMap("116", "rotavirus, pentavalent");
		putMap("117", "VZIG (IND)");
		putMap("118", "HPV, bivalent");
		putMap("119", "rotavirus, monovalent");
		putMap("12", "diphtheria antitoxin");
		putMap("120", "DTaP-Hib-IPV");
		putMap("121", "zoster");
		putMap("122", "rotavirus, NOS1");
		putMap("13", "TIG");
		putMap("14", "IG, NOS");
		...
		putMap("42", "Hep B, adolescent/high risk infant2");
		putMap("43", "Hep B, adult4");
		...
		putMap("74", "rotavirus, tetravalent");
		putMap("75", "vaccinia (smallpox)");
		...
		putMap("93", "RSV-MAb");
		putMap("94", "MMRV");
		putMap("95", "TST-OT tine test");
		putMap("96", "TST-PPD intradermal");
		putMap("97", "TST-PPD tine test");
		putMap("98", "TST, NOS");
		putMap("99", "RESERVED - do not use3");
		putMap("998", "no vaccine administered5");
		putMap("999", "unknown");

...
public class RESULTS_RRI_I15 extends hl7.character.group.RESULTS_RRI_I15{
	...
	static{
		...
		standard[2]=hl7.pseudo.group.OBSERVATION_RRI_I15.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.RESULTS_RRI_I15 group = new hl7.pseudo.group.RESULTS_RRI_I15();

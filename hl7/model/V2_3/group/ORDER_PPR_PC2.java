...
public class ORDER_PPR_PC2 extends hl7.character.group.ORDER_PPR_PC2{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_PPR_PC2.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_PPR_PC2 group = new hl7.pseudo.group.ORDER_PPR_PC2();

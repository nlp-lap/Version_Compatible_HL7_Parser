...
public class PROBLEM_PPP_PCC extends hl7.character.group.PROBLEM_PPP_PCC{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PPP_PCC.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_OBSERVATION_PPP_PCC.CLASS;
		standard[5]=hl7.pseudo.group.GOAL_PPP_PCC.CLASS;
		standard[6]=hl7.pseudo.group.ORDER_PPP_PCC.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PPP_PCC group = new hl7.pseudo.group.PROBLEM_PPP_PCC();

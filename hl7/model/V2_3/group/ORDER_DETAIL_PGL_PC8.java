...
public class ORDER_DETAIL_PGL_PC8 extends hl7.character.group.ORDER_DETAIL_PGL_PC8{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.ORDER_OBSERVATION_PGL_PC8.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_DETAIL_PGL_PC8 group = new hl7.pseudo.group.ORDER_DETAIL_PGL_PC8();

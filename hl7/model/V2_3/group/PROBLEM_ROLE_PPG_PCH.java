...
public class PROBLEM_ROLE_PPG_PCH extends hl7.character.group.PROBLEM_ROLE_PPG_PCH{
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_ROLE_PPG_PCH group = new hl7.pseudo.group.PROBLEM_ROLE_PPG_PCH();

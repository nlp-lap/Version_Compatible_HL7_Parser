...
public class GOAL_PPG_PCH extends hl7.character.group.GOAL_PPG_PCH{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.GOAL_ROLE_PPG_PCH.CLASS;
		standard[4]=hl7.pseudo.group.GOAL_OBSERVATION_PPG_PCH.CLASS;
		standard[5]=hl7.pseudo.group.PROBLEM_PPG_PCH.CLASS;
		standard[6]=hl7.pseudo.group.ORDER_PPG_PCH.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.GOAL_PPG_PCH group = new hl7.pseudo.group.GOAL_PPG_PCH();

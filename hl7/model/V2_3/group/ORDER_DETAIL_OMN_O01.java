...
public class ORDER_DETAIL_OMN_O01 extends hl7.character.group.ORDER_DETAIL_OMN_O01{
	...
	static{
		standard[0]=hl7.pseudo.segment.RQD.CLASS;
		standard[1]=hl7.pseudo.segment.RQ1.CLASS;
		standard[2]=hl7.pseudo.segment.NTE.CLASS;
		standard[3]=hl7.pseudo.group.OBSERVATION_OMN_O01.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_DETAIL_OMN_O01 group = new hl7.pseudo.group.ORDER_DETAIL_OMN_O01();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.group.ORDER_DETAIL_OMN_O01 type = (hl7.model.V2_31.group.ORDER_DETAIL_OMN_O01)this;

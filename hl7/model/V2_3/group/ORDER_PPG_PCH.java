...
public class ORDER_PPG_PCH extends hl7.character.group.ORDER_PPG_PCH{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_PPG_PCH.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_PPG_PCH group = new hl7.pseudo.group.ORDER_PPG_PCH();

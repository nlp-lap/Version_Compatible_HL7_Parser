...
public class ORDER_DETAIL_PPR_PC3 extends hl7.character.group.ORDER_DETAIL_PPR_PC3{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.ORDER_OBSERVATION_PPR_PC3.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_DETAIL_PPR_PC3 group = new hl7.pseudo.group.ORDER_DETAIL_PPR_PC3();

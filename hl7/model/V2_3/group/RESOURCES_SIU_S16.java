...
public class RESOURCES_SIU_S16 extends hl7.character.group.RESOURCES_SIU_S16{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.SERVICE_SIU_S16.CLASS;
		standard[2]=hl7.pseudo.group.GENERAL_RESOURCE_SIU_S16.CLASS;
		standard[3]=hl7.pseudo.group.LOCATIONL_RESOURCE_SIU_S16.CLASS;
		standard[4]=hl7.pseudo.group.PERSONNEL_RESOURCE_SIU_S16.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.RESOURCES_SIU_S16 group = new hl7.pseudo.group.RESOURCES_SIU_S16();

...
public class PATHWAY_PPG_PCJ extends hl7.character.group.PATHWAY_PPG_PCJ{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PATHWAY_ROLE_PPG_PCJ.CLASS;
		standard[4]=hl7.pseudo.group.GOAL_PPG_PCJ.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PATHWAY_PPG_PCJ group = new hl7.pseudo.group.PATHWAY_PPG_PCJ();

...
public class GOAL_PGL_PC8 extends hl7.character.group.GOAL_PGL_PC8{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.GOAL_ROLE_PGL_PC8.CLASS;
		standard[4]=hl7.pseudo.group.PATHWAY_PGL_PC8.CLASS;
		standard[5]=hl7.pseudo.group.OBSERVATION_PGL_PC8.CLASS;
		standard[6]=hl7.pseudo.group.PROBLEM_PGL_PC8.CLASS;
		standard[7]=hl7.pseudo.group.ORDER_PGL_PC8.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.GOAL_PGL_PC8 group = new hl7.pseudo.group.GOAL_PGL_PC8();

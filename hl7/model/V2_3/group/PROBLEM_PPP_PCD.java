...
public class PROBLEM_PPP_PCD extends hl7.character.group.PROBLEM_PPP_PCD{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PPP_PCD.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_OBSERVATION_PPP_PCD.CLASS;
		standard[5]=hl7.pseudo.group.GOAL_PPP_PCD.CLASS;
		standard[6]=hl7.pseudo.group.ORDER_PPP_PCD.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PPP_PCD group = new hl7.pseudo.group.PROBLEM_PPP_PCD();

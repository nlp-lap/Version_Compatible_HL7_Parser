...
public class PATHWAY_ROLE_PPP_PCD extends hl7.character.group.PATHWAY_ROLE_PPP_PCD{
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PATHWAY_ROLE_PPP_PCD group = new hl7.pseudo.group.PATHWAY_ROLE_PPP_PCD();

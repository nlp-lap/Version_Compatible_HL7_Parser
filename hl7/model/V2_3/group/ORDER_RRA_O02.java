...
public class ORDER_RRA_O02 extends hl7.character.group.ORDER_RRA_O02{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ADMINISTRATION_RRA_O02.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_RRA_O02 group = new hl7.pseudo.group.ORDER_RRA_O02();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.group.ORDER_RRA_O02 type = (hl7.model.V2_31.group.ORDER_RRA_O02)this;

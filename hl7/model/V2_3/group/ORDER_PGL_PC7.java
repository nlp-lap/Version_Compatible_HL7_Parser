...
public class ORDER_PGL_PC7 extends hl7.character.group.ORDER_PGL_PC7{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_PGL_PC7.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_PGL_PC7 group = new hl7.pseudo.group.ORDER_PGL_PC7();

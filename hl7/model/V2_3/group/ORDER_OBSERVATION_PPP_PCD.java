...
public class ORDER_OBSERVATION_PPP_PCD extends hl7.character.group.ORDER_OBSERVATION_PPP_PCD{
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_OBSERVATION_PPP_PCD group = new hl7.pseudo.group.ORDER_OBSERVATION_PPP_PCD();

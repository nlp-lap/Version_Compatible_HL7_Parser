...
public class PROBLEM_PPR_PC2 extends hl7.character.group.PROBLEM_PPR_PC2{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PPR_PC2.CLASS;
		standard[4]=hl7.pseudo.group.PATHWAY_PPR_PC2.CLASS;
		standard[5]=hl7.pseudo.group.PROBLEM_OBSERVATION_PPR_PC2.CLASS;
		standard[6]=hl7.pseudo.group.GOAL_PPR_PC2.CLASS;
		standard[7]=hl7.pseudo.group.ORDER_PPR_PC2.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PPR_PC2 group = new hl7.pseudo.group.PROBLEM_PPR_PC2();

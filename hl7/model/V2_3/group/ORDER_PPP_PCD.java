...
public class ORDER_PPP_PCD extends hl7.character.group.ORDER_PPP_PCD{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_PPP_PCD.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_PPP_PCD group = new hl7.pseudo.group.ORDER_PPP_PCD();

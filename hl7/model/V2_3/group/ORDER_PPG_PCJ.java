...
public class ORDER_PPG_PCJ extends hl7.character.group.ORDER_PPG_PCJ{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_PPG_PCJ.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_PPG_PCJ group = new hl7.pseudo.group.ORDER_PPG_PCJ();

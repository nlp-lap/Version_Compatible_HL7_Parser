...
public class GOAL_PPP_PCD extends hl7.character.group.GOAL_PPP_PCD{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.GOAL_ROLE_PPP_PCD.CLASS;
		standard[4]=hl7.pseudo.group.GOAL_OBSERVATION_PPP_PCD.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.GOAL_PPP_PCD group = new hl7.pseudo.group.GOAL_PPP_PCD();

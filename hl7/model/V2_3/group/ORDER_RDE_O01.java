...
public class ORDER_RDE_O01 extends hl7.character.group.ORDER_RDE_O01{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_RDE_O01.CLASS;
		standard[5]=hl7.pseudo.group.OBSERVATION_RDE_O01.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_RDE_O01 group = new hl7.pseudo.group.ORDER_RDE_O01();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.group.ORDER_RDE_O01 type = (hl7.model.V2_31.group.ORDER_RDE_O01)this;

...
public class ORDER_DETAIL_PPG_PCJ extends hl7.character.group.ORDER_DETAIL_PPG_PCJ{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.ORDER_OBSERVATION_PPG_PCJ.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_DETAIL_PPG_PCJ group = new hl7.pseudo.group.ORDER_DETAIL_PPG_PCJ();

...
public class PROBLEM_PPG_PCH extends hl7.character.group.PROBLEM_PPG_PCH{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PPG_PCH.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_OBSERVATION_PPG_PCH.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PPG_PCH group = new hl7.pseudo.group.PROBLEM_PPG_PCH();

...
public class ORDER_OBSERVATION_PPG_PCH extends hl7.character.group.ORDER_OBSERVATION_PPG_PCH{
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_OBSERVATION_PPG_PCH group = new hl7.pseudo.group.ORDER_OBSERVATION_PPG_PCH();

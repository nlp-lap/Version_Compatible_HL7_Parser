...
public class PATHWAY_PPP_PCD extends hl7.character.group.PATHWAY_PPP_PCD{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PATHWAY_ROLE_PPP_PCD.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_PPP_PCD.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PATHWAY_PPP_PCD group = new hl7.pseudo.group.PATHWAY_PPP_PCD();

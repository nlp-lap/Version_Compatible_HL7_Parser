...
public class PROBLEM_PGL_PC8 extends hl7.character.group.PROBLEM_PGL_PC8{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PGL_PC8.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_OBSERVATION_PGL_PC8.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PGL_PC8 group = new hl7.pseudo.group.PROBLEM_PGL_PC8();

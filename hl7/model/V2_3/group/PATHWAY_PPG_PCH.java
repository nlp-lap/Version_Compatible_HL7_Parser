...
public class PATHWAY_PPG_PCH extends hl7.character.group.PATHWAY_PPG_PCH{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PATHWAY_ROLE_PPG_PCH.CLASS;
		standard[4]=hl7.pseudo.group.GOAL_PPG_PCH.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PATHWAY_PPG_PCH group = new hl7.pseudo.group.PATHWAY_PPG_PCH();

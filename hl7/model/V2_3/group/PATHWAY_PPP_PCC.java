...
public class PATHWAY_PPP_PCC extends hl7.character.group.PATHWAY_PPP_PCC{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.PATHWAY_ROLE_PPP_PCC.CLASS;
		standard[4]=hl7.pseudo.group.PROBLEM_PPP_PCC.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PATHWAY_PPP_PCC group = new hl7.pseudo.group.PATHWAY_PPP_PCC();

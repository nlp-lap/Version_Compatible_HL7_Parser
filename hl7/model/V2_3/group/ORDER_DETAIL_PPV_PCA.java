...
public class ORDER_DETAIL_PPV_PCA extends hl7.character.group.ORDER_DETAIL_PPV_PCA{
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[1] = subComponents[5];
		components[2] = subComponents[6];
		components[3] = subComponents[7];
	}

...
public class ORDER_DETAIL_PPG_PCH extends hl7.character.group.ORDER_DETAIL_PPG_PCH{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.ORDER_OBSERVATION_PPG_PCH.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_DETAIL_PPG_PCH group = new hl7.pseudo.group.ORDER_DETAIL_PPG_PCH();

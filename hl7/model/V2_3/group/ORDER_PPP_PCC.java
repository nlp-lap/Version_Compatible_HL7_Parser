...
public class ORDER_PPP_PCC extends hl7.character.group.ORDER_PPP_PCC{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_PPP_PCC.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_PPP_PCC group = new hl7.pseudo.group.ORDER_PPP_PCC();

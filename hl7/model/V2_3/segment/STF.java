...
public class STF extends hl7.model.V2_2.segment.STF{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_3.table.Table0182.getInstance();
		tables[4]=hl7.model.V2_3.table.Table0001.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_3.table.Table0183.getInstance();
		tables[7]=hl7.model.V2_3.table.Table0184.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		...
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_3.table.Table0185.getInstance();
		tables[16]=hl7.model.V2_3.table.Table0002.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_3.table.Table0066.getInstance();
		tables[20]=hl7.model.V2_3.table.Table0136.getInstance();
		tables[21]=null;
		...
		descriptions[19]="EMPLOYMENT_STATUS";
		descriptions[20]="ADDITIONAL_INSURED_ON_AUTO";
		descriptions[21]="DRIVERS_LICENSE_NUMBER";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==9) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TN.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==23) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==24) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==18) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.JCC.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==21) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.DLN.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_2.segment.STF type = (hl7.model.V2_2.segment.STF)this;

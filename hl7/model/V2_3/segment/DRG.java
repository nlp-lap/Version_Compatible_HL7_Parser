...
public class DRG extends hl7.character.segment.DRG{
	...
	static{
		...
		tables[0]=hl7.model.V2_3.table.Table0055.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_3.table.Table0136.getInstance();
		tables[3]=hl7.model.V2_3.table.Table0056.getInstance();
		tables[4]=hl7.model.V2_3.table.Table0083.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_3.table.Table0229.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_3.table.Table0136.getInstance();

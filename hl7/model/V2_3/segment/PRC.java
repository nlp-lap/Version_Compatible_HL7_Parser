...
public class PRC extends hl7.character.segment.PRC{
	...
	static{
		...
		tables[0]=hl7.model.V2_3.table.Table0132.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_3.table.Table0004.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		...
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_3.table.Table0268.getInstance();
		tables[13]=hl7.model.V2_3.table.Table0293.getInstance();
		tables[14]=hl7.model.V2_3.table.Table0136.getInstance();
		tables[15]=hl7.model.V2_3.table.Table0183.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_3.table.Table0269.getInstance();
		
		descriptions[0]="PRIMARY_KEY_VALUE";
		descriptions[1]="FACILITY_ID";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==1) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.PRC type = (hl7.model.V2_31.segment.PRC)this;

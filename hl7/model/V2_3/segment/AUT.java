...
public class AUT extends hl7.character.segment.AUT{
	...
	static{
		...
		tables[0]=hl7.model.V2_3.table.Table0072.getInstance();
		tables[1]=hl7.model.V2_3.table.Table0285.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		descriptions[0]="AUTHORIZING_PAYOR_PLAN_CODE";
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.AUT type = (hl7.model.V2_31.segment.AUT)this;

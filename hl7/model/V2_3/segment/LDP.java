...
public class LDP extends hl7.character.segment.LDP{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_3.table.Table0264.getInstance();
		tables[2]=hl7.model.V2_3.table.Table0069.getInstance();
		tables[3]=hl7.model.V2_3.table.Table0265.getInstance();
		tables[4]=hl7.model.V2_3.table.Table0004.getInstance();
		tables[5]=hl7.model.V2_3.table.Table0183.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_3.table.Table0267.getInstance();
		tables[10]=null;
		
		descriptions[0]="LDP_PRIMARY_KEY_VALUE";
		descriptions[1]="LOCATION_DEPARTMENT";
		descriptions[2]="LOCATION_SERVICE";
		descriptions[3]="SPECIALITY_TYPE";
		descriptions[4]="VALID_PATIENT_CLASSES";
		descriptions[5]="ACTIVE_INACTIVE_FLAG";
		descriptions[6]="ACTIVATION_DATE";

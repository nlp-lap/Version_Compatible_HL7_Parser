...
public class DG1 extends hl7.model.V2_2.segment.DG1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_3.table.Table0053.getInstance();
		tables[2]=hl7.model.V2_3.table.Table0051.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_3.table.Table0052.getInstance();
		tables[6]=hl7.model.V2_3.table.Table0118.getInstance();
		tables[7]=hl7.model.V2_3.table.Table0055.getInstance();
		tables[8]=hl7.model.V2_3.table.Table0136.getInstance();
		tables[9]=hl7.model.V2_3.table.Table0056.getInstance();
		tables[10]=hl7.model.V2_3.table.Table0083.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_3.table.Table0228.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==12) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CP.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_2.segment.DG1 type = (hl7.model.V2_2.segment.DG1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.DG1 type = (hl7.model.V2_31.segment.DG1)this;

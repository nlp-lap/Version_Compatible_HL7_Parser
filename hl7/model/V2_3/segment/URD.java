...
public class URD extends hl7.model.V2_2.segment.URD{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_3.table.Table0109.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_3.table.Table0048.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_3.table.Table0108.getInstance();
		
		descriptions[0]="R_U_DATE_TIME";
		descriptions[1]="REPORT_PRIORITY";
		descriptions[2]="R_U_WHO_SUBJECT_DEFINITION";
		descriptions[3]="R_U_WHAT_SUBJECT_DEFINITION";
		descriptions[4]="R_U_WHAT_DEPARTMENT_CODE";
		descriptions[5]="R_U_DISPLAY_PRINT_LOCATIONS";
		descriptions[6]="R_U_RESULTS_LEVEL";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.URD seg = new hl7.pseudo.segment.URD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_2.segment.URD type = (hl7.model.V2_2.segment.URD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.URD type = (hl7.model.V2_31.segment.URD)this;

...
public class PRD extends hl7.character.segment.PRD{
	...
	static{
		...
		tables[0]=hl7.model.V2_3.table.Table0286.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_3.table.Table0185.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		...
		descriptions[7]="EFFECTIVE_START_DATE_OF_ROLE";
		descriptions[8]="EFFECTIVE_END_DATE_OF_ROLE";
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.PRD type = (hl7.model.V2_31.segment.PRD)this;

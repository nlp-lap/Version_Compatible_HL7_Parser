...
public class PRA extends hl7.model.V2_2.segment.PRA{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_3.table.Table0186.getInstance();
		tables[4]=hl7.model.V2_3.table.Table0187.getInstance();
		tables[5]=null;
		tables[6]=null;
		
		descriptions[0]="PRA_PRIMARY_KEY_VALUE";
		descriptions[1]="PRACTIONER_GROUP";
		descriptions[2]="PRACTIONER_CATEGORY";
		descriptions[3]="PROVIDER_BILLING";
		descriptions[4]="SPECIALTY";
		descriptions[5]="PRACTITIONER_ID_NUMBERS";
		descriptions[6]="PRIVILEGES";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PRA seg = new hl7.pseudo.segment.PRA();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_2.segment.PRA type = (hl7.model.V2_2.segment.PRA)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.PRA type = (hl7.model.V2_31.segment.PRA)this;

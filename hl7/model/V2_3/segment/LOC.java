...
public class LOC extends hl7.character.segment.LOC{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_3.table.Table0260.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_3.table.Table0261.getInstance();
		
		descriptions[0]="PRIMARY_KEY_VALUE";
		descriptions[1]="LOCATION_DESCRIPTION";
		descriptions[2]="LOCATION_TYPE";
		descriptions[3]="ORGANIZATION_NAME";

...
public class PD1 extends hl7.character.segment.PD1{
	...
	static{
		...
		tables[0]=hl7.model.V2_3.table.Table0223.getInstance();
		tables[1]=hl7.model.V2_3.table.Table0220.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_3.table.Table0231.getInstance();
		tables[5]=hl7.model.V2_3.table.Table0310.getInstance();
		tables[6]=hl7.model.V2_3.table.Table0315.getInstance();
		tables[7]=hl7.model.V2_3.table.Table0316.getInstance();
		tables[8]=hl7.model.V2_3.table.Table0136.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_3.table.Table0215.getInstance();
		...
		descriptions[10]="PUBLICITY_INDICATOR";

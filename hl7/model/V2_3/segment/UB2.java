...
public class UB2 extends hl7.model.V2_2.segment.UB2{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_3.table.Table0043.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		...
		descriptions[0]="SET_ID_UB2";
		descriptions[1]="CO_INSURANCE_DAYS";
		descriptions[2]="CONDITION_CODE";
		descriptions[3]="COVERED_DAYS";
		descriptions[4]="NON_COVERED_DAYS";
		descriptions[5]="VALUE_AMOUNT_CODE";
		descriptions[6]="OCCURRENCE_CODE_DATE";
		descriptions[7]="OCCURRENCE_SPAN_CODE_DATES";
		descriptions[8]="UB92_LOCATOR_2";
		descriptions[9]="UB92_LOCATOR_11";
		descriptions[10]="UB92_LOCATOR_31";
		descriptions[11]="DOCUMENT_CONTROL_NUMBER";
		descriptions[12]="UB92_LOCATOR_49";
		descriptions[13]="UB92_LOCATOR_56";
		descriptions[14]="UB92_LOCATOR_57";
		descriptions[15]="UB92_LOCATOR_78";
		descriptions[16]="SPECIAL_VISIT_COUNT";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.UB2 seg = new hl7.pseudo.segment.UB2();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_2.segment.UB2 type = (hl7.model.V2_2.segment.UB2)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.UB2 type = (hl7.model.V2_31.segment.UB2)this;

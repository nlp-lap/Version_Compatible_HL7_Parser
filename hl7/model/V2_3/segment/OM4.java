...
public class OM4 extends hl7.model.V2_2.segment.OM4{
	...
	static{
		...
		standard[2]=hl7.bean.datastructure.primitive.TX.CLASS;
		...
		standard[8]=hl7.bean.datastructure.primitive.TX.CLASS;
		standard[9]=hl7.pseudo.datastructure.CQ.CLASS;
		standard[10]=hl7.pseudo.datastructure.CQ.CLASS;
		standard[11]=hl7.bean.datastructure.primitive.TX.CLASS;
		standard[12]=hl7.bean.datastructure.primitive.ID.CLASS;
		standard[13]=hl7.pseudo.datastructure.CQ.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_3.table.Table0170.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_3.table.Table0027.getInstance();
		tables[13]=null;
		
		descriptions[0]="SEQUENCE_NUMBER_TEST_OBSERVATION_MASTER_FILE";
		descriptions[1]="DERIVED_SPECIMEN";
		descriptions[2]="CONTAINER_DESCRIPTION";
		descriptions[3]="CONTAINER_VOLUME";
		descriptions[4]="CONTAINER_UNITS";
		descriptions[5]="SPECIMEN";
		descriptions[6]="ADDITIVE";
		descriptions[7]="PREPARATION";
		descriptions[8]="SPECIAL_HANDLING_REQUIREMENTS";
		descriptions[9]="NORMAL_COLLECTION_VOLUME";
		descriptions[10]="MINIMUM_COLLECTION_VOLUME";
		descriptions[11]="SPECIMEN_REQUIREMENTS";
		descriptions[12]="SPECIMEN_PRIORITIES";
		descriptions[13]="SPECIMEN_RETENTION_TIME";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.OM4 seg = new hl7.pseudo.segment.OM4();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==1) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==2) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==3) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==7) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==12) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==4) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==13) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_2.segment.OM4 type = (hl7.model.V2_2.segment.OM4)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.OM4 type = (hl7.model.V2_31.segment.OM4)this;

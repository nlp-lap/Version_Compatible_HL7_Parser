...
public class IN1 extends hl7.model.V2_2.segment.IN1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_3.table.Table0072.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		...
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_3.table.Table0086.getInstance();
		tables[15]=null;
		tables[16]=hl7.model.V2_3.table.Table0063.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_3.table.Table0135.getInstance();
		tables[20]=hl7.model.V2_3.table.Table0173.getInstance();
		tables[21]=null;
		tables[22]=hl7.model.V2_3.table.Table0136.getInstance();
		tables[23]=null;
		tables[24]=hl7.model.V2_3.table.Table0136.getInstance();
		tables[25]=null;
		tables[26]=hl7.model.V2_3.table.Table0093.getInstance();
		tables[27]=null;
		tables[28]=null;
		tables[29]=null;
		tables[30]=hl7.model.V2_3.table.Table0098.getInstance();
		tables[31]=hl7.model.V2_3.table.Table0022.getInstance();
		tables[32]=null;
		tables[33]=null;
		tables[34]=hl7.model.V2_3.table.Table0042.getInstance();
		tables[35]=null;
		tables[36]=null;
		tables[37]=null;
		tables[38]=null;
		tables[39]=null;
		tables[40]=null;
		tables[41]=hl7.model.V2_3.table.Table0066.getInstance();
		tables[42]=hl7.model.V2_3.table.Table0001.getInstance();
		tables[43]=null;
		tables[44]=null;
		tables[45]=hl7.model.V2_3.table.Table0072.getInstance();
		tables[46]=hl7.model.V2_3.table.Table0309.getInstance();
		tables[47]=hl7.model.V2_3.table.Table0310.getInstance();
		tables[48]=null;
		...
		descriptions[5]="INSURANCE_CO_CONTACT_PPERS";
		...
		descriptions[24]="RPT_OF_EIGIBILITY_CODE";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==29) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.XPN.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==17) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==45) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==46) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==3) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XON.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==4) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==5) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XPN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==6) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XTN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==8) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XON.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CX.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XON.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==18) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==29) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XPN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==36) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CP.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==37) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CP.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==39) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CP.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==40) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CP.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==41) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==43) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==48) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CX.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.IN1 type = (hl7.model.V2_31.segment.IN1)this;

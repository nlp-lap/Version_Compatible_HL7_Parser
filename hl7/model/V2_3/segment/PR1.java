...
public class PR1 extends hl7.model.V2_2.segment.PR1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_3.table.Table0089.getInstance();
		tables[2]=hl7.model.V2_3.table.Table0088.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_3.table.Table0230.getInstance();
		tables[6]=null;
		tables[7]=hl7.model.V2_3.table.Table0010.getInstance();
		tables[8]=hl7.model.V2_3.table.Table0019.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_3.table.Table0010.getInstance();
		tables[11]=hl7.model.V2_3.table.Table0010.getInstance();
		tables[12]=hl7.model.V2_3.table.Table0059.getInstance();
		tables[13]=null;
		tables[14]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XCN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XCN.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_2.segment.PR1 type = (hl7.model.V2_2.segment.PR1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.segment.PR1 type = (hl7.model.V2_31.segment.PR1)this;

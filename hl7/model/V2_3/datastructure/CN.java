...
public class CN extends hl7.character.datastructure.CN{
	...
	public CN(){
		type = DataStructure.CN;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.CN data = new hl7.pseudo.datastructure.CN();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.datastructure.CN type = (hl7.model.V2_31.datastructure.CN)this;

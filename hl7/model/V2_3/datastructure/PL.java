...
public class PL extends hl7.character.datastructure.PL{
	public static final String VERSION = "2.3";
	public static final String POINT_OF_CARE = "point of care (ID)";
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_31.datastructure.PL type = (hl7.model.V2_31.datastructure.PL)this;

...
public class XCN extends hl7.character.datastructure.XCN{
	...
	static{
		...
		descriptions[13]=ASSIGNING_FACILITY_ID;
	...
	public static void backward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, String prevVersion, int depth) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			if(i==1) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;
			if(i==6) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;
			if(i==7) components[i] = (subComponents[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(prevVersion, prevVersion):null;

...
public class ORDER_ROR_ROR extends hl7.model.V2_4.group.ORDER_ROR_ROR{
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_ROR_ROR group = new hl7.pseudo.group.ORDER_ROR_ROR();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.ORDER_ROR_ROR type = (hl7.model.V2_4.group.ORDER_ROR_ROR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.ORDER_ROR_ROR type = (hl7.model.V2_51.group.ORDER_ROR_ROR)this;

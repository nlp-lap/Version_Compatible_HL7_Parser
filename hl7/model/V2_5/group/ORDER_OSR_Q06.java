...
public class ORDER_OSR_Q06 extends hl7.model.V2_4.group.ORDER_OSR_Q06{
	...
	static{
		...
		standard[3]=hl7.pseudo.segment.RQD.CLASS;
		standard[4]=hl7.pseudo.segment.RQ1.CLASS;
		standard[5]=hl7.pseudo.segment.RXO.CLASS;
		standard[6]=hl7.pseudo.segment.ODS.CLASS;
		standard[7]=hl7.pseudo.segment.ODT.CLASS;
		standard[8]=hl7.pseudo.segment.NTE.CLASS;
		standard[9]=hl7.pseudo.segment.CTI.CLASS;
		standard[1]=hl7.pseudo.group.TIMING_OSR_Q06.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.ORDER_OSR_Q06 type = (hl7.model.V2_4.group.ORDER_OSR_Q06)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.ORDER_OSR_Q06 type = (hl7.model.V2_51.group.ORDER_OSR_Q06)this;

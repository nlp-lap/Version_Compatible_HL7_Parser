...
public class ORDER_RGV_O15 extends hl7.model.V2_4.group.ORDER_RGV_O15{
	...
	static{
		...
		standard[1]=hl7.pseudo.group.TIMING_RGV_O15.CLASS;
		standard[2]=hl7.pseudo.group.ORDER_DETAIL_RGV_O15.CLASS;
		standard[3]=hl7.pseudo.group.ENCODING_RGV_O15.CLASS;
		standard[4]=hl7.pseudo.group.GIVE_RGV_O15.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_RGV_O15 group = new hl7.pseudo.group.ORDER_RGV_O15();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.ORDER_RGV_O15 type = (hl7.model.V2_4.group.ORDER_RGV_O15)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.ORDER_RGV_O15 type = (hl7.model.V2_51.group.ORDER_RGV_O15)this;

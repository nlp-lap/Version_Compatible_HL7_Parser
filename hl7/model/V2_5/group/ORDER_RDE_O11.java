...
public class ORDER_RDE_O11 extends hl7.model.V2_4.group.ORDER_RDE_O11{
	...
	static{
		...
		standard[3]=hl7.pseudo.segment.RXE.CLASS;
		standard[4]=hl7.pseudo.segment.NTE.CLASS;
		standard[6]=hl7.pseudo.segment.RXR.CLASS;
		standard[7]=hl7.pseudo.segment.RXC.CLASS;
		standard[9]=hl7.pseudo.segment.FT1.CLASS;
		standard[10]=hl7.pseudo.segment.BLG.CLASS;
		...
		standard[5]=hl7.pseudo.group.TIMING_ENCODED_RDE_O11.CLASS;
		standard[8]=hl7.pseudo.group.OBSERVATION_RDE_O11.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.ORDER_RDE_O11 type = (hl7.model.V2_4.group.ORDER_RDE_O11)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.ORDER_RDE_O11 type = (hl7.model.V2_51.group.ORDER_RDE_O11)this;

...
public class SCHEDULE_SQR_S25 extends hl7.model.V2_4.group.SCHEDULE_SQR_S25{
	...
	static{
		standard[0]=hl7.pseudo.segment.SCH.CLASS;
		standard[1]=hl7.pseudo.segment.TQ1.CLASS;
		standard[2]=hl7.pseudo.segment.NTE.CLASS;
		standard[3]=hl7.pseudo.group.PATIENT_SQR_S25.CLASS;
		standard[4]=hl7.pseudo.group.RESOURCES_SQR_S25.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.SCHEDULE_SQR_S25 group = new hl7.pseudo.group.SCHEDULE_SQR_S25();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.SCHEDULE_SQR_S25 type = (hl7.model.V2_4.group.SCHEDULE_SQR_S25)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.SCHEDULE_SQR_S25 type = (hl7.model.V2_51.group.SCHEDULE_SQR_S25)this;

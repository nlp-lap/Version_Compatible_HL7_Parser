...
public class MF_STAFF_MFN_M02 extends hl7.model.V2_4.group.MF_STAFF_MFN_M02{
	...
	static{
		standard[0]=hl7.pseudo.segment.MFE.CLASS;
		standard[1]=hl7.pseudo.segment.STF.CLASS;
		standard[2]=hl7.pseudo.segment.PRA.CLASS;
		standard[3]=hl7.pseudo.segment.ORG.CLASS;
		standard[4]=hl7.pseudo.segment.AFF.CLASS;
		standard[5]=hl7.pseudo.segment.LAN.CLASS;
		standard[6]=hl7.pseudo.segment.EDU.CLASS;
		standard[7]=hl7.pseudo.segment.CER.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.MF_STAFF_MFN_M02 group = new hl7.pseudo.group.MF_STAFF_MFN_M02();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.MF_STAFF_MFN_M02 type = (hl7.model.V2_4.group.MF_STAFF_MFN_M02)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.MF_STAFF_MFN_M02 type = (hl7.model.V2_51.group.MF_STAFF_MFN_M02)this;

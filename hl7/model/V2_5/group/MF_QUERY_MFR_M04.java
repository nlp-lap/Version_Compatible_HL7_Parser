...
public class MF_QUERY_MFR_M04 extends hl7.character.group.MF_QUERY_MFR_M04{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.CDM.CLASS;
		standard[2]=hl7.pseudo.segment.LCH.CLASS;
		standard[3]=hl7.pseudo.segment.PRC.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.MF_QUERY_MFR_M04 group = new hl7.pseudo.group.MF_QUERY_MFR_M04();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.MF_QUERY_MFR_M04 type = (hl7.model.V2_51.group.MF_QUERY_MFR_M04)this;

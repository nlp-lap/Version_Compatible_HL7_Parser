...
public class COMMON_ORDER_RSP_Z82 extends hl7.model.V2_4.group.COMMON_ORDER_RSP_Z82{
	...
	static{
		...
		standard[5]=hl7.pseudo.segment.RXR.CLASS;
		standard[6]=hl7.pseudo.segment.RXC.CLASS;
		standard[1]=hl7.pseudo.group.TIMING_RSP_Z82.CLASS;
		standard[2]=hl7.pseudo.group.ORDER_DETAIL_RSP_Z82.CLASS;
		standard[3]=hl7.pseudo.group.ENCODED_ORDER_RSP_Z82.CLASS;
		standard[7]=hl7.pseudo.group.OBSERVATION_RSP_Z82.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.COMMON_ORDER_RSP_Z82 group = new hl7.pseudo.group.COMMON_ORDER_RSP_Z82();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.COMMON_ORDER_RSP_Z82 type = (hl7.model.V2_4.group.COMMON_ORDER_RSP_Z82)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.COMMON_ORDER_RSP_Z82 type = (hl7.model.V2_51.group.COMMON_ORDER_RSP_Z82)this;

...
public class PROVIDER_CONTACT_RRI_I12 extends hl7.model.V2_4.group.PROVIDER_CONTACT_RRI_I12{
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_4.group.PROVIDER_CONTACT_RRI_I12 type = (hl7.model.V2_4.group.PROVIDER_CONTACT_RRI_I12)this;

...
public class QUERY_RESPONSE_ORF_R04 extends hl7.model.V2_31.group.QUERY_RESPONSE_ORF_R04{
	...
	static{
		standard[0]=hl7.pseudo.group.PATIENT_ORF_R04.CLASS;
		standard[1]=hl7.pseudo.group.ORDER_ORF_R04.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.QUERY_RESPONSE_ORF_R04 group = new hl7.pseudo.group.QUERY_RESPONSE_ORF_R04();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_31.group.QUERY_RESPONSE_ORF_R04 type = (hl7.model.V2_31.group.QUERY_RESPONSE_ORF_R04)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.group.QUERY_RESPONSE_ORF_R04 type = (hl7.model.V2_51.group.QUERY_RESPONSE_ORF_R04)this;

...
public class IN3 extends hl7.model.V2_4.segment.IN3{
	...
	static{
		...
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_5.table.Table0233.getInstance();
		tables[12]=null;
		tables[13]=hl7.model.V2_5.table.Table0010.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_5.table.Table0345.getInstance();
		tables[17]=hl7.model.V2_5.table.Table0346.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=null;
		tables[22]=hl7.model.V2_5.table.Table0151.getInstance();
		tables[23]=hl7.model.V2_5.table.Table0152.getInstance();
		tables[24]=hl7.model.V2_5.table.Table0010.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==19) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.ICD.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.IN3 type = (hl7.model.V2_51.segment.IN3)this;

...
public class URD extends hl7.model.V2_4.segment.URD{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_5.table.Table0109.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_5.table.Table0048.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_5.table.Table0108.getInstance();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.URD type = (hl7.model.V2_51.segment.URD)this;

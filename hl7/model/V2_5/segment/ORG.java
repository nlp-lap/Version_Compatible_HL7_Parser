...
public class ORG extends hl7.model.V2_4.segment.ORG{
	...
	static{
		...
		standard[8]=hl7.pseudo.datastructure.DR.CLASS;
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_5.table.Table0405.getInstance();
		tables[2]=hl7.model.V2_5.table.Table0474.getInstance();
		tables[3]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[4]=null;
		tables[5]=hl7.model.V2_5.table.Table0452.getInstance();
		tables[6]=hl7.model.V2_5.table.Table0453.getInstance();
		tables[7]=hl7.model.V2_5.table.Table0454.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_5.table.Table0066.getInstance();
		tables[10]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[11]=hl7.model.V2_5.table.Table0136.getInstance();
		
		descriptions[0]="SET_ID_ORG";
		descriptions[1]="ORGANIZATION_UNIT_CODE";
		descriptions[2]="ORGANIZATION_UNIT_TYPE_CODE";
		descriptions[3]="PRIMARY_ORG_UNIT_INDICATOR";
		descriptions[4]="PRACTITIONER_ORG_UNIT_IDENTIFIER";
		descriptions[5]="HEALTH_CARE_PROVIDER_TYPE_CODE";
		descriptions[6]="HEALTH_CARE_PROVIDER_CLASSIFICATION_CODE";
		descriptions[7]="HEALTH_CARE_PROVIDER_AREA_OF_SPECIALIZATION_CODE";
		descriptions[8]="EFFECTIVE_DATE_RANGE";
		descriptions[9]="EMPLOYMENT_STATUS_CODE";
		descriptions[10]="BOARD_APPROVAL_INDICATOR";
		descriptions[11]="PRIMARY_CARE_PHYSICIAN_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ORG seg = new hl7.pseudo.segment.ORG();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.ORG type = (hl7.model.V2_4.segment.ORG)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.ORG type = (hl7.model.V2_51.segment.ORG)this;

...
public class SCH extends hl7.model.V2_4.segment.SCH{
	...
	static{
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_5.table.Table0276.getInstance();
		tables[7]=hl7.model.V2_5.table.Table0277.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		...
		tables[22]=null;
		tables[23]=null;
		tables[24]=hl7.model.V2_5.table.Table0278.getInstance();
		tables[25]=null;
		tables[26]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.SCH type = (hl7.model.V2_4.segment.SCH)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.SCH type = (hl7.model.V2_51.segment.SCH)this;

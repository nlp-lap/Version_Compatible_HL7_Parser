...
public class RXO extends hl7.model.V2_4.segment.RXO{
	...
	static{
		...
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_5.table.Table0161.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		...
		tables[24]=null;
		tables[25]=null;
		tables[26]=hl7.model.V2_5.table.Table0480.getInstance();
		tables[27]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==26) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;

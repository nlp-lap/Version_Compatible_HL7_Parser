...
public class ABS extends hl7.model.V2_4.segment.ABS{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0010.getInstance();
		tables[1]=hl7.model.V2_5.table.Table0069.getInstance();
		tables[2]=hl7.model.V2_5.table.Table0421.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_5.table.Table0422.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_5.table.Table0423.getInstance();
		tables[9]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[10]=hl7.model.V2_5.table.Table0424.getInstance();
		tables[11]=null;
		tables[12]=hl7.model.V2_5.table.Table0425.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.ABS type = (hl7.model.V2_4.segment.ABS)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.ABS type = (hl7.model.V2_51.segment.ABS)this;

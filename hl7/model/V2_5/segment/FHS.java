...
public class FHS extends hl7.model.V2_4.segment.FHS{
	...
	static{
		...
		descriptions[0]="FILE_FIELD_SEPARATOR";
		descriptions[1]="FILE_ENCODING_CHARACTERS";
		descriptions[2]="FILE_SENDING_APPLICATION";
		descriptions[3]="FILE_SENDING_FACILITY";
		descriptions[4]="FILE_RECEIVING_APPLICATION";
		descriptions[5]="FILE_RECEIVING_FACILITY";
		descriptions[6]="FILE_CREATION_DATE_TIME";
		descriptions[7]="FILE_SECURITY";
		descriptions[8]="FILE_NAME_ID";
		descriptions[9]="FILE_HEADER_COMMENT";
		descriptions[10]="FILE_CONTROL_ID";
		descriptions[11]="REFERENCE_FILE_CONTROL_ID";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.FHS seg = new hl7.pseudo.segment.FHS();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.FHS type = (hl7.model.V2_4.segment.FHS)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.FHS type = (hl7.model.V2_51.segment.FHS)this;

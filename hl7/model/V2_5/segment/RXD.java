...
public class RXD extends hl7.model.V2_4.segment.RXD{
	...
	static{
		...
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_5.table.Table0167.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=null;
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_5.table.Table0227.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=hl7.model.V2_5.table.Table0321.getInstance();
		tables[24]=null;
		tables[25]=null;
		tables[26]=null;
		tables[27]=null;
		...
		tables[29]=null;
		tables[30]=null;
		tables[31]=hl7.model.V2_5.table.Table0480.getInstance();
		tables[32]=hl7.model.V2_5.table.Table0484.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==30) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.RXD type = (hl7.model.V2_4.segment.RXD)this;

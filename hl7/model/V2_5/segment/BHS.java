...
public class BHS extends hl7.model.V2_4.segment.BHS{
	...
	static{
		...
		descriptions[0]="BATCH_FIELD_SEPARATOR";
		descriptions[1]="BATCH_ENCODING_CHARACTERS";
		descriptions[2]="BATCH_SENDING_APPLICATION";
		descriptions[3]="BATCH_SENDING_FACILITY";
		descriptions[4]="BATCH_RECEIVING_APPLICATION";
		descriptions[5]="BATCH_RECEIVING_FACILITY";
		descriptions[6]="BATCH_CREATION_DATE_TIME";
		descriptions[7]="BATCH_SECURITY";
		descriptions[8]="BATCH_NAME_ID_TYPE";
		descriptions[9]="BATCH_COMMENT";
		descriptions[10]="BATCH_CONTROL_ID";
		descriptions[11]="REFERENCE_BATCH_CONTROL_ID";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.BHS seg = new hl7.pseudo.segment.BHS();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.BHS type = (hl7.model.V2_4.segment.BHS)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.BHS type = (hl7.model.V2_51.segment.BHS)this;

...
public class PRD extends hl7.model.V2_4.segment.PRD{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0286.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_5.table.Table0185.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==6) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.PLN.CLASS.cloneClass(VERSION, VERSION):null;

...
public class STF extends hl7.model.V2_4.segment.STF{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table9999.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_5.table.Table0182.getInstance();
		tables[4]=hl7.model.V2_5.table.Table0001.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_5.table.Table0183.getInstance();
		tables[7]=hl7.model.V2_5.table.Table0184.getInstance();
		tables[8]=hl7.model.V2_5.table.Table0069.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_5.table.Table0537.getInstance();
		tables[12]=hl7.model.V2_5.table.Table0537.getInstance();
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_5.table.Table0185.getInstance();
		tables[16]=hl7.model.V2_5.table.Table0002.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_5.table.Table0066.getInstance();
		tables[20]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[21]=null;
		tables[22]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[23]=null;
		tables[24]=null;
		tables[25]=null;
		tables[26]=hl7.model.V2_5.table.Table0005.getInstance();
		tables[27]=hl7.model.V2_5.table.Table0189.getInstance();
		tables[28]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[29]=hl7.model.V2_5.table.Table0171.getInstance();
		tables[30]=null;
		tables[31]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[32]=hl7.model.V2_5.table.Table0538.getInstance();
		tables[33]=null;
		tables[34]=null;
		tables[35]=hl7.model.V2_5.table.Table0539.getInstance();
		tables[36]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[37]=hl7.model.V2_5.table.Table0540.getInstance();
		
		descriptions[0]="PRIMARY_KEY_VALUE_STF";
		descriptions[1]="STAFF_IDENTIFIER_LIST";
		...
		descriptions[8]="HOSPITAL_SERVICE_STF";
		descriptions[9]="PHONE";
		descriptions[10]="OFFICE_HOME_ADDRESS_BIRTHPLACE";
		...
		descriptions[29]="CITIZENSHIP";
		descriptions[30]="DEATH_DATE_AND_TIME";
		descriptions[31]="DEATH_INDICATOR";
		descriptions[32]="INSTITUTION_RELATIONSHIP_TYPE_CODE";
		descriptions[33]="INSTITUTION_RELATIONSHIP_PERIOD";
		descriptions[34]="EXPECTED_RETURN_DATE";
		descriptions[35]="COST_CENTER_CODE";
		descriptions[36]="GENERIC_CLASSIFICATION_INDICATOR";
		descriptions[37]="INACTIVE_REASON_CODE";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==30) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==31) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==34) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==33) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.DR.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.STF type = (hl7.model.V2_4.segment.STF)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.STF type = (hl7.model.V2_51.segment.STF)this;

...
public class GP2 extends hl7.model.V2_4.segment.GP2{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0456.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_5.table.Table0459.getInstance();
		tables[4]=hl7.model.V2_5.table.Table0460.getInstance();
		tables[5]=hl7.model.V2_5.table.Table0458.getInstance();
		tables[6]=hl7.model.V2_5.table.Table0466.getInstance();
		tables[7]=hl7.model.V2_5.table.Table0467.getInstance();
		tables[8]=hl7.model.V2_5.table.Table0468.getInstance();
		tables[9]=hl7.model.V2_5.table.Table0469.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_5.table.Table0470.getInstance();
		tables[12]=null;
		tables[13]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.GP2 type = (hl7.model.V2_4.segment.GP2)this;

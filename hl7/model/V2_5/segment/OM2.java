...
public class OM2 extends hl7.model.V2_4.segment.OM2{
	...
	static{
		...
		tables[2]=null;
		tables[3]=hl7.model.V2_5.table.Table9999.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==6) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.RFR.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.OM2 type = (hl7.model.V2_51.segment.OM2)this;

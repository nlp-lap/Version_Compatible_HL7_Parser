...
public class INV extends hl7.model.V2_4.segment.INV{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0451.getInstance();
		tables[1]=hl7.model.V2_5.table.Table0383.getInstance();
		tables[2]=hl7.model.V2_5.table.Table0384.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		...
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_5.table.Table0385.getInstance();
		tables[17]=hl7.model.V2_5.table.Table0386.getInstance();
		tables[18]=null;
		tables[19]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==18) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==19) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.INV type = (hl7.model.V2_4.segment.INV)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.INV type = (hl7.model.V2_51.segment.INV)this;

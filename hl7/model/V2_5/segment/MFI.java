...
public class MFI extends hl7.model.V2_4.segment.MFI{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0175.getInstance();
		tables[1]=hl7.model.V2_5.table.Table0361.getInstance();
		tables[2]=hl7.model.V2_5.table.Table0178.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_5.table.Table0179.getInstance();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.MFI type = (hl7.model.V2_51.segment.MFI)this;

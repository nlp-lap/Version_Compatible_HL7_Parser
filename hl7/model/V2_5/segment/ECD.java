...
public class ECD extends hl7.model.V2_4.segment.ECD{
	...
	static{
		...
		standard[3]=hl7.pseudo.datastructure.TQ.CLASS;
		standard[4]=hl7.bean.datastructure.primitive.TX.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_5.table.Table0368.getInstance();
		tables[2]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[3]=null;
		tables[4]=null;
		
		descriptions[0]="REFERENCE_COMMAND_NUMBER";
		descriptions[1]="REMOTE_CONTROL_COMMAND";
		descriptions[2]="RESPONSE_REQUIRED";
		descriptions[3]="REQUESTED_COMPLETION_TIME";
		descriptions[4]="PARAMETERS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ECD seg = new hl7.pseudo.segment.ECD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.ECD type = (hl7.model.V2_4.segment.ECD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.ECD type = (hl7.model.V2_51.segment.ECD)this;

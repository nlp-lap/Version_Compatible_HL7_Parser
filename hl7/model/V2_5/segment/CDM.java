...
public class CDM extends hl7.model.V2_4.segment.CDM{
	...
	static{
		...
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_5.table.Table0268.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_5.table.Table0088.getInstance();
		tables[7]=hl7.model.V2_5.table.Table0183.getInstance();
		tables[8]=hl7.model.V2_5.table.Table0463.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_5.table.Table0136.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CX.CLASS.cloneClass(VERSION, VERSION):null;

...
public class OM7 extends hl7.model.V2_4.segment.OM7{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_5.table.Table0412.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_5.table.Table9999.getInstance();
		tables[9]=hl7.model.V2_5.table.Table0335.getInstance();
		tables[10]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[11]=hl7.model.V2_5.table.Table0413.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_5.table.Table0414.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_5.table.Table0414.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=hl7.model.V2_5.table.Table0473.getInstance();
		tables[22]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[23]=hl7.model.V2_5.table.Table0132.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==23) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.segment.OM7 type = (hl7.model.V2_4.segment.OM7)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.segment.OM7 type = (hl7.model.V2_51.segment.OM7)this;

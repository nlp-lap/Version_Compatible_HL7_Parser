...
public class REF_I12 extends hl7.model.V2_4.message.REF_I12{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.RF1.CLASS;
		standard[5]=hl7.pseudo.segment.PID.CLASS;
		standard[6]=hl7.pseudo.segment.NK1.CLASS;
		standard[7]=hl7.pseudo.segment.GT1.CLASS;
		standard[9]=hl7.pseudo.segment.ACC.CLASS;
		standard[10]=hl7.pseudo.segment.DG1.CLASS;
		standard[11]=hl7.pseudo.segment.DRG.CLASS;
		standard[12]=hl7.pseudo.segment.AL1.CLASS;
		standard[16]=hl7.pseudo.segment.NTE.CLASS;
		standard[3]=hl7.pseudo.group.AUTHORIZATION_CONTACT_REF_I12.CLASS;
		standard[4]=hl7.pseudo.group.PROVIDER_CONTACT_REF_I12.CLASS;
		standard[8]=hl7.pseudo.group.INSURANCE_REF_I12.CLASS;
		standard[13]=hl7.pseudo.group.PROCEDURE_REF_I12.CLASS;
		standard[14]=hl7.pseudo.group.OBSERVATION_REF_I12.CLASS;
		standard[15]=hl7.pseudo.group.PATIENT_VISIT_REF_I12.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.message.REF_I12 type = (hl7.model.V2_4.message.REF_I12)this;

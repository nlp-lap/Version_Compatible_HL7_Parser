...
public class VXR_V03 extends hl7.model.V2_4.message.VXR_V03{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.SFT.CLASS;
		standard[3]=hl7.pseudo.segment.QRD.CLASS;
		standard[4]=hl7.pseudo.segment.QRF.CLASS;
		standard[5]=hl7.pseudo.segment.PID.CLASS;
		standard[6]=hl7.pseudo.segment.PD1.CLASS;
		standard[7]=hl7.pseudo.segment.NK1.CLASS;
		standard[9]=hl7.pseudo.segment.GT1.CLASS;
		standard[8]=hl7.pseudo.group.PATIENT_VISIT_VXR_V03.CLASS;
		standard[10]=hl7.pseudo.group.INSURANCE_VXR_V03.CLASS;
		standard[11]=hl7.pseudo.group.ORDER_VXR_V03.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.message.VXR_V03 type = (hl7.model.V2_4.message.VXR_V03)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.message.VXR_V03 type = (hl7.model.V2_51.message.VXR_V03)this;

...
public class RRI_I12 extends hl7.model.V2_4.message.RRI_I12{
	...
	static{
		...
		standard[7]=hl7.pseudo.segment.ACC.CLASS;
		standard[8]=hl7.pseudo.segment.DG1.CLASS;
		standard[9]=hl7.pseudo.segment.DRG.CLASS;
		standard[10]=hl7.pseudo.segment.AL1.CLASS;
		standard[14]=hl7.pseudo.segment.NTE.CLASS;
		standard[4]=hl7.pseudo.group.AUTHORIZATION_CONTACT_RRI_I12.CLASS;
		standard[5]=hl7.pseudo.group.PROVIDER_CONTACT_RRI_I12.CLASS;
		standard[11]=hl7.pseudo.group.PROCEDURE_RRI_I12.CLASS;
		standard[12]=hl7.pseudo.group.OBSERVATION_RRI_I12.CLASS;
		standard[13]=hl7.pseudo.group.PATIENT_VISIT_RRI_I12.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.message.RRI_I12 type = (hl7.model.V2_4.message.RRI_I12)this;

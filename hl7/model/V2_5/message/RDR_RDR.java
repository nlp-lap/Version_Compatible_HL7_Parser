...
public class RDR_RDR extends hl7.model.V2_6.message.RDR_RDR{
	...
	static{
		...
		standard[4]=hl7.pseudo.group.DEFINITION_RDR_RDR.CLASS;
	...
	public static void forward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		...
		subComponents[4] = components[24];
		subComponents[5] = components[25];
	}
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_7.message.RDR_RDR type = (hl7.model.V2_7.message.RDR_RDR)this;

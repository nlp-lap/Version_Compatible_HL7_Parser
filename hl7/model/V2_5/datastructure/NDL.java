...
public class NDL extends hl7.model.V2_4.datastructure.NDL{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_5.table.Table0302.getInstance();
		tables[4]=hl7.model.V2_5.table.Table0303.getInstance();
		tables[5]=hl7.model.V2_5.table.Table0304.getInstance();
		tables[6]=null;
		tables[7]=hl7.model.V2_5.table.Table0306.getInstance();
		tables[8]=hl7.model.V2_5.table.Table0305.getInstance();
		tables[9]=hl7.model.V2_5.table.Table0307.getInstance();
		tables[10]=hl7.model.V2_5.table.Table0308.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.NDL type = (hl7.model.V2_4.datastructure.NDL)this;

...
public class XCN extends hl7.model.V2_4.datastructure.XCN{
	...
	static{
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_5.table.Table0360.getInstance();
		tables[7]=hl7.model.V2_5.table.Table0297.getInstance();
		tables[8]=hl7.model.V2_5.table.Table0363.getInstance();
		tables[9]=hl7.model.V2_5.table.Table0200.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_5.table.Table0061.getInstance();
		tables[12]=hl7.model.V2_5.table.Table0203.getInstance();
		tables[13]=null;
		tables[14]=hl7.model.V2_5.table.Table0465.getInstance();
		tables[15]=hl7.model.V2_5.table.Table0448.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_5.table.Table0444.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=null;
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			if(i==18) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==19) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(VERSION, VERSION):null;
			...
			if(i==22) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.XCN type = (hl7.model.V2_4.datastructure.XCN)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.XCN type = (hl7.model.V2_51.datastructure.XCN)this;

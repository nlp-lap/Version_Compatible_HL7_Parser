...
public class DLT extends hl7.model.V2_4.datastructure.DLT{
	public static final String VERSION = "2.5";
	public static final String NORMAL_RANGE = "Normal Range";
	public static final String NUMERIC_THRESHOLD = "Numeric Threshold";
	public static final String CHANGE_COMPUTATION = "Change Computation";
	public static final String DAYS_RETAINED = "Days Retained";
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_5.table.Table0523.getInstance();
		tables[3]=null;
		
		descriptions[0]=NORMAL_RANGE;
		descriptions[1]=NUMERIC_THRESHOLD;
		descriptions[2]=CHANGE_COMPUTATION;
		descriptions[3]=DAYS_RETAINED;
	...
	public DLT(){
		type = DataStructure.DLT;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.DLT data = new hl7.pseudo.datastructure.DLT();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.DLT type = (hl7.model.V2_4.datastructure.DLT)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.DLT type = (hl7.model.V2_51.datastructure.DLT)this;

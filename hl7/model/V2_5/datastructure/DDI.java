...
public class DDI extends hl7.model.V2_4.datastructure.DDI{
	public static final String VERSION = "2.5";
	public static final String DELAY_DAYS = "Delay Days";
	public static final String MONETARY_AMOUNT = "Monetary Amount";
	...
	static{
		...
		descriptions[0]=DELAY_DAYS;
		descriptions[1]=MONETARY_AMOUNT;
		descriptions[2]=NUMBER_OF_DAYS;
	...
	public DDI(){
		type = DataStructure.DDI;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.DDI data = new hl7.pseudo.datastructure.DDI();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.DDI type = (hl7.model.V2_4.datastructure.DDI)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.DDI type = (hl7.model.V2_51.datastructure.DDI)this;

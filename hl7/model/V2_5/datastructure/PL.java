...
public class PL extends hl7.model.V2_4.datastructure.PL{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0302.getInstance();
		tables[1]=hl7.model.V2_5.table.Table0303.getInstance();
		tables[2]=hl7.model.V2_5.table.Table0304.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_5.table.Table0306.getInstance();
		tables[5]=hl7.model.V2_5.table.Table0305.getInstance();
		tables[6]=hl7.model.V2_5.table.Table0307.getInstance();
		tables[7]=hl7.model.V2_5.table.Table0308.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==9) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==10) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.PL type = (hl7.model.V2_4.datastructure.PL)this;

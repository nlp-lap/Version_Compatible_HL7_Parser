...
public class ICD extends hl7.character.datastructure.ICD{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0150.getInstance();
		tables[1]=hl7.model.V2_5.table.Table0136.getInstance();
		tables[2]=null;

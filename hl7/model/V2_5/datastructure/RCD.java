...
public class RCD extends hl7.model.V2_4.datastructure.RCD{
	public static final String VERSION = "2.5";
	public static final String SEGMENT_FIELD_NAME = "Segment Field Name";
	public static final String HL7_DATA_TYPE = "HL7 Data Type";
	public static final String MAXIMUM_COLUMN_WIDTH = "Maximum Column Width";
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_5.table.Table0440.getInstance();
		tables[2]=null;
		
		descriptions[0]=SEGMENT_FIELD_NAME;
		descriptions[1]=HL7_DATA_TYPE;
		descriptions[2]=MAXIMUM_COLUMN_WIDTH;
	...
	public RCD(){
		type = DataStructure.RCD;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.RCD data = new hl7.pseudo.datastructure.RCD();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==1) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.RCD type = (hl7.model.V2_4.datastructure.RCD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.RCD type = (hl7.model.V2_51.datastructure.RCD)this;

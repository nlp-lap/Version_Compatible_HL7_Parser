...
public class MOP extends hl7.model.V2_4.datastructure.MOP{
	public static final String VERSION = "2.5";
	public static final String MONEY_OR_PERCENTAGE_INDICATOR = "Money or Percentage Indicator";
	public static final String MONEY_OR_PERCENTAGE_QUANTITY = "Money or Percentage Quantity";
	public static final String CURRENCY_DENOMINATION = "Currency Denomination";
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0148.getInstance();
		tables[1]=null;
		tables[2]=null;
		
		descriptions[0]=MONEY_OR_PERCENTAGE_INDICATOR;
		descriptions[1]=MONEY_OR_PERCENTAGE_QUANTITY;
		descriptions[2]=CURRENCY_DENOMINATION;
	...
	public MOP(){
		type = DataStructure.MOP;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.MOP data = new hl7.pseudo.datastructure.MOP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.MOP type = (hl7.model.V2_4.datastructure.MOP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.MOP type = (hl7.model.V2_51.datastructure.MOP)this;

...
public class SPS extends hl7.model.V2_4.datastructure.SPS{
	public static final String VERSION = "2.5";
	public static final String SPECIMEN_SOURCE_NAME_OR_CODE = "Specimen Source Name or Code";
	public static final String ADDITIVES = "Additives";
	public static final String SPECIMEN_COLLECTION_METHOD = "Specimen Collection Method";
	public static final String BODY_SITE = "Body Site";
	public static final String SITE_MODIFIER = "Site Modifier";
	public static final String COLLECTION_METHOD_MODIFIER_CODE = "Collection Method Modifier Code";
	public static final String SPECIMEN_ROLE = "Specimen Role";
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_5.table.Table0371.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_5.table.Table0163.getInstance();
		tables[4]=hl7.model.V2_5.table.Table0495.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_5.table.Table0369.getInstance();
		
		descriptions[0]=SPECIMEN_SOURCE_NAME_OR_CODE;
		descriptions[1]=ADDITIVES;
		descriptions[2]=SPECIMEN_COLLECTION_METHOD;
		descriptions[3]=BODY_SITE;
		descriptions[4]=SITE_MODIFIER;
		descriptions[5]=COLLECTION_METHOD_MODIFIER_CODE;
		descriptions[6]=SPECIMEN_ROLE;
	...
	public SPS(){
		type = DataStructure.SPS;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.SPS data = new hl7.pseudo.datastructure.SPS();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==0) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==1) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==3) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==4) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==5) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==6) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.SPS type = (hl7.model.V2_4.datastructure.SPS)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.SPS type = (hl7.model.V2_51.datastructure.SPS)this;

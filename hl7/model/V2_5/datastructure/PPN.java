...
public class PPN extends hl7.model.V2_4.datastructure.PPN{
	...
	static{
		...
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_5.table.Table0465.getInstance();
		tables[16]=hl7.model.V2_5.table.Table0448.getInstance();
		tables[17]=null;
		tables[18]=hl7.model.V2_5.table.Table0444.getInstance();
		tables[19]=null;
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			if(i==20) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.TS.CLASS.cloneClass(VERSION, VERSION):null;
			...
			if(i==23) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CWE.CLASS.cloneClass(VERSION, VERSION):null;

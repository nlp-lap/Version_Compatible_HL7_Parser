...
public class OSP extends hl7.model.V2_4.datastructure.OSP{
	public static final String VERSION = "2.5";
	public static final String OCCURRENCE_SPAN_CODE = "Occurrence Span Code";
	public static final String OCCURRENCE_SPAN_START_DATE = "Occurrence Span Start Date";
	public static final String OCCURRENCE_SPAN_STOP_DATE = "Occurrence Span Stop Date";
	...
	static{
		...
		standard[1]=hl7.bean.datastructure.primitive.DT.CLASS;
		standard[2]=hl7.bean.datastructure.primitive.DT.CLASS;
		
		tables[0]=hl7.model.V2_5.table.Table0351.getInstance();
		tables[1]=null;
		tables[2]=null;
		
		descriptions[0]=OCCURRENCE_SPAN_CODE;
		descriptions[1]=OCCURRENCE_SPAN_START_DATE;
		descriptions[2]=OCCURRENCE_SPAN_STOP_DATE;
	...
	public OSP(){
		type = DataStructure.OSP;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.OSP data = new hl7.pseudo.datastructure.OSP();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==0) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CNE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.OSP type = (hl7.model.V2_4.datastructure.OSP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.OSP type = (hl7.model.V2_51.datastructure.OSP)this;

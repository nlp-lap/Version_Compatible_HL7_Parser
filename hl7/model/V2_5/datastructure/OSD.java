...
public class OSD extends hl7.model.V2_4.datastructure.OSD{
	...
	static{
		...
		tables[0]=hl7.model.V2_5.table.Table0524.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_5.table.Table0363.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_5.table.Table0363.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_5.table.Table0301.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_5.table.Table0301.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_4.datastructure.OSD type = (hl7.model.V2_4.datastructure.OSD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_51.datastructure.OSD type = (hl7.model.V2_51.datastructure.OSD)this;

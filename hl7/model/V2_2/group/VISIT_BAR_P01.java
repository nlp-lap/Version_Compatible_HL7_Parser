...
public class VISIT_BAR_P01 extends hl7.model.V2_1.group.VISIT_BAR_P01{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.OBX.CLASS;
		standard[3]=hl7.pseudo.segment.AL1.CLASS;
		standard[4]=hl7.pseudo.segment.DG1.CLASS;
		standard[5]=hl7.pseudo.segment.PR1.CLASS;
		standard[6]=hl7.pseudo.segment.GT1.CLASS;
		standard[7]=hl7.pseudo.segment.NK1.CLASS;
		standard[9]=hl7.pseudo.segment.ACC.CLASS;
		standard[10]=hl7.pseudo.segment.UB1.CLASS;
		standard[11]=hl7.pseudo.segment.UB2.CLASS;
		standard[8]=hl7.pseudo.group.INSURANCE_BAR_P01.CLASS;
	...
	public static void forward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		subComponents[4] = components[1];
		subComponents[5] = components[2];
		subComponents[6] = components[3];
		subComponents[7] = components[4];
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_1.group.VISIT_BAR_P01 type = (hl7.model.V2_1.group.VISIT_BAR_P01)this;

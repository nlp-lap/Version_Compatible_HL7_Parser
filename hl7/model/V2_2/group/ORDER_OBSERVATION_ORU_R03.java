...
public class ORDER_OBSERVATION_ORU_R03 extends hl7.model.V2_1.group.ORDER_OBSERVATION_ORU_R03{
	...
	static{
		...
		standard[3]=hl7.pseudo.group.OBSERVATION_ORU_R03.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_OBSERVATION_ORU_R03 group = new hl7.pseudo.group.ORDER_OBSERVATION_ORU_R03();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_1.group.ORDER_OBSERVATION_ORU_R03 type = (hl7.model.V2_1.group.ORDER_OBSERVATION_ORU_R03)this;

...
public class ADT_A14 extends hl7.model.V2_1.message.ADT_A14{
	...
	static{
		...
		standard[6]=hl7.pseudo.segment.OBX.CLASS;
		standard[7]=hl7.pseudo.segment.AL1.CLASS;
		standard[8]=hl7.pseudo.segment.DG1.CLASS;
		standard[9]=hl7.pseudo.segment.PR1.CLASS;
		standard[10]=hl7.pseudo.segment.GT1.CLASS;
		standard[12]=hl7.pseudo.segment.ACC.CLASS;
		standard[13]=hl7.pseudo.segment.UB1.CLASS;
		standard[14]=hl7.pseudo.segment.UB2.CLASS;
		standard[11]=hl7.pseudo.group.INSURANCE_ADT_A14.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_1.message.ADT_A14 type = (hl7.model.V2_1.message.ADT_A14)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.message.ADT_A14 type = (hl7.model.V2_3.message.ADT_A14)this;

...
public class QRD extends hl7.model.V2_1.segment.QRD{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_2.table.Table0106.getInstance();
		tables[2]=hl7.model.V2_2.table.Table0091.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_2.table.Table0107.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_2.table.Table0126.getInstance();
		tables[7]=null;
		tables[8]=hl7.model.V2_2.table.Table0048.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_2.table.Table0108.getInstance();
		
		descriptions[0]="QUERY_DATE_TIME";
		descriptions[1]="QUERY_FORMAT_CODE";
		descriptions[2]="QUERY_PRIORITY";
		descriptions[3]="QUERY_ID";
		descriptions[4]="DEFERRED_RESPONSE_TYPE";
		descriptions[5]="DEFERRED_RESPONSE_DATE_TIME";
		descriptions[6]="QUANTITY_LIMITED_REQUEST";
		descriptions[7]="WHO_SUBJECT_FILTER";
		descriptions[8]="WHAT_SUBJECT_FILTER";
		descriptions[9]="WHAT_DEPARTMENT_DATA_CODE";
		descriptions[10]="WHAT_DATA_CODE_VALUE_QUALIFIER";
		descriptions[11]="QUERY_RESULTS_LEVEL";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.QRD seg = new hl7.pseudo.segment.QRD();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==7) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_1.segment.QRD type = (hl7.model.V2_1.segment.QRD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.QRD type = (hl7.model.V2_3.segment.QRD)this;

...
public class IN3 extends hl7.character.segment.IN3{
	...
	static{
		...
		standard[15]=hl7.bean.datastructure.primitive.TN.CLASS;
		standard[16]=hl7.pseudo.datastructure.CE.CLASS;
		standard[17]=hl7.pseudo.datastructure.CE.CLASS;
		standard[18]=hl7.bean.datastructure.primitive.TN.CLASS;
		...
		standard[24]=hl7.pseudo.datastructure.CN.CLASS;
		
		tables[0]=null;
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_2.table.Table0136.getInstance();
		tables[4]=hl7.model.V2_2.table.Table0148.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_2.table.Table0149.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		...
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_2.table.Table0150.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=hl7.model.V2_2.table.Table0151.getInstance();
		tables[23]=hl7.model.V2_2.table.Table0152.getInstance();
		tables[24]=null;
		...
		descriptions[24]="SECOND_OPINION_PRACTITIONER";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==1) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==15) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TN.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==18) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TN.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==24) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CN.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.IN3 type = (hl7.model.V2_3.segment.IN3)this;

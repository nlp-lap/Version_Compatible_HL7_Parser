...
public class OM2 extends hl7.character.segment.OM2{
	...
	static{
		...
		descriptions[2]="UNITS_OF_MEASURE";
		descriptions[3]="RANGE_OF_DECIMAL_PRECISION";
		descriptions[4]="CORRESPONDING_SI_UNITS_OF_MEASURE";
		descriptions[5]="SI_CONVERSION_FACTOR";
		descriptions[6]="REFERENCE_RANGE_ORDINAL_CONTINUOUS_OBSERVATIONS";
		descriptions[7]="CRITICAL_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS";
		descriptions[8]="ABSOLUTE_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS";
		descriptions[9]="DELTA_CHECK_CRITERIA";
		descriptions[10]="MINIMUM_MEANINGFUL_INCREMENTS";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==3) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==5) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(prevVersion, prevVersion):null;

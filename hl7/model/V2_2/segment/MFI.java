...
public class MFI extends hl7.character.segment.MFI{
	...
	static{
		...
		tables[0]=hl7.model.V2_2.table.Table0175.getInstance();
		tables[1]=hl7.model.V2_2.table.Table0176.getInstance();
		tables[2]=hl7.model.V2_2.table.Table0178.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_2.table.Table0179.getInstance();
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.MFI type = (hl7.model.V2_3.segment.MFI)this;

...
public class RXR extends hl7.character.segment.RXR{
	...
	static{
		...
		tables[0]=hl7.model.V2_2.table.Table0162.getInstance();
		tables[1]=hl7.model.V2_2.table.Table0163.getInstance();
		tables[2]=hl7.model.V2_2.table.Table0164.getInstance();
		tables[3]=hl7.model.V2_2.table.Table0165.getInstance();

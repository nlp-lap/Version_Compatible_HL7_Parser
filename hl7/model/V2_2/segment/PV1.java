...
public class PV1 extends hl7.model.V2_1.segment.PV1{
	...
	static{
		...
		standard[5]=hl7.pseudo.datastructure.CM.CLASS;
		standard[6]=hl7.pseudo.datastructure.CN.CLASS;
		standard[7]=hl7.pseudo.datastructure.CN.CLASS;
		standard[8]=hl7.pseudo.datastructure.CN.CLASS;
		...
		standard[16]=hl7.pseudo.datastructure.CN.CLASS;
		standard[17]=hl7.bean.datastructure.primitive.ID.CLASS;
		standard[18]=hl7.pseudo.datastructure.CM.CLASS;
		...
		standard[39]=hl7.bean.datastructure.primitive.ID.CLASS;
		standard[40]=hl7.bean.datastructure.primitive.ID.CLASS;
		standard[41]=hl7.pseudo.datastructure.CM.CLASS;
		standard[42]=hl7.pseudo.datastructure.CM.CLASS;
		...
		standard[49]=hl7.pseudo.datastructure.CM.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_2.table.Table0004.getInstance();
		tables[2]=hl7.model.V2_2.table.Table0079.getInstance();
		tables[3]=hl7.model.V2_2.table.Table0007.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_2.table.Table0010.getInstance();
		tables[7]=hl7.model.V2_2.table.Table0010.getInstance();
		tables[8]=hl7.model.V2_2.table.Table0010.getInstance();
		tables[9]=hl7.model.V2_2.table.Table0069.getInstance();
		tables[10]=hl7.model.V2_2.table.Table0079.getInstance();
		tables[11]=hl7.model.V2_2.table.Table0087.getInstance();
		tables[12]=hl7.model.V2_2.table.Table0092.getInstance();
		tables[13]=hl7.model.V2_2.table.Table0023.getInstance();
		tables[14]=hl7.model.V2_2.table.Table0009.getInstance();
		tables[15]=hl7.model.V2_2.table.Table0099.getInstance();
		tables[16]=hl7.model.V2_2.table.Table0010.getInstance();
		tables[17]=hl7.model.V2_2.table.Table0018.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_2.table.Table0064.getInstance();
		tables[20]=hl7.model.V2_2.table.Table0032.getInstance();
		tables[21]=hl7.model.V2_2.table.Table0045.getInstance();
		tables[22]=hl7.model.V2_2.table.Table0046.getInstance();
		tables[23]=hl7.model.V2_2.table.Table0044.getInstance();
		tables[24]=null;
		tables[25]=null;
		tables[26]=null;
		tables[27]=hl7.model.V2_2.table.Table0073.getInstance();
		tables[28]=hl7.model.V2_2.table.Table0110.getInstance();
		tables[29]=null;
		tables[30]=hl7.model.V2_2.table.Table0021.getInstance();
		tables[31]=null;
		tables[32]=null;
		tables[33]=hl7.model.V2_2.table.Table0111.getInstance();
		tables[34]=null;
		tables[35]=hl7.model.V2_2.table.Table0112.getInstance();
		tables[36]=hl7.model.V2_2.table.Table0113.getInstance();
		tables[37]=hl7.model.V2_2.table.Table0114.getInstance();
		tables[38]=hl7.model.V2_2.table.Table0115.getInstance();
		tables[39]=hl7.model.V2_2.table.Table0116.getInstance();
		tables[40]=hl7.model.V2_2.table.Table0117.getInstance();
		tables[41]=null;
		tables[42]=null;
		tables[43]=null;
		tables[44]=null;
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==39) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==2) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==5) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==6) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CN.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==7) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CN.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==8) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CN.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==10) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==16) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CN.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==18) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==41) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==42) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==49) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==30) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==2) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==5) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==18) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==19) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==36) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==41) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==42) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==49) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CM.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_1.segment.PV1 type = (hl7.model.V2_1.segment.PV1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.PV1 type = (hl7.model.V2_3.segment.PV1)this;

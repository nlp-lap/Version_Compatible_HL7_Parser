...
public class UB1 extends hl7.model.V2_1.segment.UB1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_2.table.Table0136.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_2.table.Table0043.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_2.table.Table0153.getInstance();
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		...
		descriptions[9]="VALUE_AMOUNT_AND_CODE";
		descriptions[10]="NUMBER_OF_GRACE_DAYS";
		descriptions[11]="SPECIAL_PROGRAM_INDICATOR";
		descriptions[12]="PSRO_UR_APPROVAL_INDICATOR";
		descriptions[13]="PSRO_UR_APPROVED_STAY_FROM";
		descriptions[14]="PSRO_UR_APPROVED_STAY_TO";
		descriptions[15]="OCCURRENCE";
		descriptions[16]="OCCURRENCE_SPAN";
		descriptions[17]="OCCURRENCE_SPAN_START_DATE";
		descriptions[18]="OCCURRENCE_SPAN_END_DATE";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==6) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==1) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==5) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==7) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==8) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_1.segment.UB1 type = (hl7.model.V2_1.segment.UB1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.UB1 type = (hl7.model.V2_3.segment.UB1)this;

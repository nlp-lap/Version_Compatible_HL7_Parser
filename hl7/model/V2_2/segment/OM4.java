...
public class OM4 extends hl7.character.segment.OM4{
	...
	static{
		...
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_2.table.Table0027.getInstance();
		tables[14]=null;
		
		descriptions[0]="SEGMENT_TYPE_ID";
		descriptions[1]="SEQUENCE_NUMBER_TEST_OBSERVATION_MASTER_FILE";
		descriptions[2]="DERIVED_SPECIMEN";
		descriptions[3]="CONTAINER_DESCRIPTION";
		descriptions[4]="CONTAINER_VOLUME";
		descriptions[5]="CONTAINER_UNITS";
		descriptions[6]="SPECIMEN";
		descriptions[7]="ADDITIVE";
		descriptions[8]="PREPARATION";
		descriptions[9]="SPECIAL_HANDLING_REQUIREMENTS";
		descriptions[10]="NORMAL_COLLECTION_VOLUME";
		descriptions[11]="MINIMUM_COLLECTION_VOLUME";
		descriptions[12]="SPECIMEN_REQUIREMENTS";
		descriptions[13]="SPECIMEN_PRIORITIES";
		descriptions[14]="SPECIMEN_RETENTION_TIME";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==3) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==4) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==9) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==12) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==11) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==14) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.OM4 type = (hl7.model.V2_3.segment.OM4)this;

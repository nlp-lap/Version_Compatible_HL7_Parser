...
public class MFA extends hl7.character.segment.MFA{
	...
	static{
		...
		tables[0]=hl7.model.V2_2.table.Table0180.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_2.table.Table0181.getInstance();
		tables[4]=null;

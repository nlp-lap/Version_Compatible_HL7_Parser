...
public class MSH extends hl7.model.V2_1.segment.MSH{
	...
	static{
		...
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_2.table.Table0076.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_2.table.Table0103.getInstance();
		tables[11]=hl7.model.V2_2.table.Table0104.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_2.table.Table0155.getInstance();
		tables[15]=hl7.model.V2_2.table.Table0155.getInstance();
		tables[16]=null;
		...
		descriptions[14]="ACCEPT_ACKNOWLEDGEMENT_TYPE";
		descriptions[15]="APPLICATION_ACKNOWLEDGEMENT_TYPE";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==15) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==16) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_1.segment.MSH type = (hl7.model.V2_1.segment.MSH)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.MSH type = (hl7.model.V2_3.segment.MSH)this;

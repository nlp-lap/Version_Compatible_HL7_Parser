...
public class RQ1 extends hl7.character.segment.RQ1{
	...
	static{
		...
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_2.table.Table0136.getInstance();
		tables[6]=hl7.model.V2_2.table.Table0136.getInstance();
		
		descriptions[0]="ANTICIPATED_PRICE";
		descriptions[1]="MANUFACTURER_ID";
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.RQ1 type = (hl7.model.V2_3.segment.RQ1)this;

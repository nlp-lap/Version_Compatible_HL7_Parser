...
public class PV2 extends hl7.character.segment.PV2{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_2.table.Table0129.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_2.table.Table0130.getInstance();
		tables[7]=null;
		tables[8]=null;
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==8) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(prevVersion, prevVersion):null;

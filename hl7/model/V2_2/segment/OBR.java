...
public class OBR extends hl7.model.V2_1.segment.OBR{
	...
	static{
		...
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_2.table.Table0065.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_2.table.Table0070.getInstance();
		tables[15]=null;
		tables[16]=null;
		tables[17]=null;
		tables[18]=null;
		...
		tables[21]=null;
		tables[22]=null;
		tables[23]=hl7.model.V2_2.table.Table0074.getInstance();
		tables[24]=hl7.model.V2_2.table.Table0123.getInstance();
		tables[25]=null;
		tables[26]=null;
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_2.table.Table0124.getInstance();
		tables[30]=null;
		tables[31]=null;
		tables[32]=null;
		tables[33]=null;
		...
		descriptions[3]="UNIVERSAL_SERVICE_ID";
		...
		descriptions[21]="RESULTS_REPORT_STATUS_CHANGE_DATE_TIME";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==4) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==26) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.TQ.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_1.segment.OBR type = (hl7.model.V2_1.segment.OBR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_3.segment.OBR type = (hl7.model.V2_3.segment.OBR)this;

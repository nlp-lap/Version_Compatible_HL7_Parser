...
public class GT1 extends hl7.model.V2_1.segment.GT1{
	...
	static{
		...
		standard[3]=hl7.pseudo.datastructure.PN.CLASS;
		...
		standard[16]=hl7.pseudo.datastructure.AD.CLASS;
		...
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_2.table.Table0001.getInstance();
		tables[9]=hl7.model.V2_2.table.Table0068.getInstance();
		tables[10]=hl7.model.V2_2.table.Table0063.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		...
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_2.table.Table0066.getInstance();
		tables[20]=null;
		...
		descriptions[5]="GUARANTOR_PHONE_NUMBER_HOME";
		descriptions[6]="GUARANTOR_PHONE_NUMBER_BUSINESS";
		descriptions[7]="GUARANTOR_DATE_OF_BIRTH";
		descriptions[8]="GUARANTOR_SEX";
		descriptions[9]="GUARANTOR_TYPE";
		descriptions[10]="GUARANTOR_RELATIONSHIP";
		descriptions[11]="GUARANTOR_SOCIAL_SECURITY_NUMBER";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==7) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==8) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==15) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==18) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==3) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.PN.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==4) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.AD.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==16) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.AD.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==1) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CK.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_1.segment.GT1 type = (hl7.model.V2_1.segment.GT1)this;

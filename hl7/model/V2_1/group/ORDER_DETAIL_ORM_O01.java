...
public class ORDER_DETAIL_ORM_O01 extends hl7.character.group.ORDER_DETAIL_ORM_O01{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.ORO.CLASS;
		standard[2]=hl7.pseudo.segment.RX1.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[6] = subComponents[12];
		components[7] = subComponents[13];
		components[8] = subComponents[14];
		components[9] = subComponents[13];
	}

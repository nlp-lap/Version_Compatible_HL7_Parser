...
public class VISIT_BAR_P01 extends hl7.character.group.VISIT_BAR_P01{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.DG1.CLASS;
		standard[2]=hl7.pseudo.segment.PR1.CLASS;
		standard[3]=hl7.pseudo.segment.GT1.CLASS;
		standard[4]=hl7.pseudo.segment.NK1.CLASS;
		standard[5]=hl7.pseudo.segment.IN1.CLASS;
		standard[6]=hl7.pseudo.segment.ACC.CLASS;
		standard[7]=hl7.pseudo.segment.UB1.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[1] = subComponents[4];
		components[2] = subComponents[5];
		components[3] = subComponents[6];
		components[4] = subComponents[7];
		components[5] = subComponents[-1];
		components[6] = subComponents[9];

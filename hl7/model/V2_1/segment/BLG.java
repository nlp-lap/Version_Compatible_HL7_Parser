...
public class BLG extends hl7.character.segment.BLG{
	...
	static{
		...
		tables[0]=hl7.model.V2_1.table.Table0100.getInstance();
		tables[1]=hl7.model.V2_1.table.Table0122.getInstance();
		tables[2]=null;

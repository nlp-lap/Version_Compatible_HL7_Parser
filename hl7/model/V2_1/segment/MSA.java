...
public class MSA extends hl7.character.segment.MSA{
	...
	static{
		...
		tables[0]=hl7.model.V2_1.table.Table0008.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_1.table.Table0102.getInstance();

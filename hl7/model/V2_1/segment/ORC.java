...
public class ORC extends hl7.character.segment.ORC{
	...
	static{
		...
		tables[0]=hl7.model.V2_1.table.Table0119.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_1.table.Table0038.getInstance();
		tables[5]=hl7.model.V2_1.table.Table0121.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		...
		descriptions[3]="PLACER_GROUP";
		descriptions[4]="ORDER_STATUS";
		descriptions[5]="RESPONSE_FLAG";
		descriptions[6]="TIMING_QUANTITY";

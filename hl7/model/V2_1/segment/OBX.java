...
public class OBX extends hl7.character.segment.OBX{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_1.table.Table0125.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_1.table.Table0078.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_1.table.Table0080.getInstance();
		tables[10]=hl7.model.V2_1.table.Table0085.getInstance();
		tables[11]=null;
		
		descriptions[0]="SET_ID_OBSERVATION_SIMPLE";
		descriptions[1]="VALUE_TYPE";
		descriptions[2]="OBSERVATION_IDENTIFIER";
		descriptions[3]="OBSERVATION_SUB_ID";
		descriptions[4]="OBSERVATION_RESULTS";
		...
		descriptions[10]="OBSERV_RESULT_STATUS";
		descriptions[11]="DATE_LAST_OBS_NORMAL_VALUES";
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_2.segment.OBX type = (hl7.model.V2_2.segment.OBX)this;

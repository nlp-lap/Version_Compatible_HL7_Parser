...
public class FT1 extends hl7.character.segment.FT1{
	...
	static{
		...
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_1.table.Table0017.getInstance();
		tables[6]=hl7.model.V2_1.table.Table0096.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_1.table.Table0049.getInstance();
		tables[13]=hl7.model.V2_1.table.Table0072.getInstance();
		tables[14]=null;
		tables[15]=hl7.model.V2_1.table.Table0079.getInstance();
		tables[16]=hl7.model.V2_1.table.Table0024.getInstance();
		tables[17]=hl7.model.V2_1.table.Table0018.getInstance();
		tables[18]=hl7.model.V2_1.table.Table0051.getInstance();
		tables[19]=hl7.model.V2_1.table.Table0084.getInstance();
		tables[20]=null;
		tables[21]=null;
		...
		descriptions[9]="TRANSACTION_AMOUNT_EXTENDED";
		descriptions[10]="TRANSACTION_QUANTITY";
		...
		descriptions[15]="PATIENT_LOCATION";

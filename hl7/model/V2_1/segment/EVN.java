...
public class EVN extends hl7.character.segment.EVN{
	...
	static{
		...
		tables[0]=hl7.model.V2_1.table.Table0003.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_1.table.Table0062.getInstance();

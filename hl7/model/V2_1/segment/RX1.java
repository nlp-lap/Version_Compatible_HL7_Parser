...
public class RX1 extends hl7.character.segment.RX1{
	...
	static{
		...
		standard[4]=hl7.pseudo.datastructure.CQ.CLASS;
		...
		standard[27]=hl7.bean.datastructure.primitive.TX.CLASS;
		standard[28]=hl7.bean.datastructure.primitive.TX.CLASS;
		standard[29]=hl7.bean.datastructure.primitive.TX.CLASS;
		
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_1.table.Table0033.getInstance();
		tables[3]=hl7.model.V2_1.table.Table0034.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		...
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_1.table.Table0057.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=null;
		tables[17]=hl7.model.V2_1.table.Table0038.getInstance();
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=null;
		...
		descriptions[0]="UNUSED";
		descriptions[1]="UNUSED";
		descriptions[2]="ROUTE";
		descriptions[3]="SITE_ADMINISTERED";
		descriptions[4]="IV_SOLUTION_RATE";
		descriptions[5]="DRUG_STRENGTH";
		descriptions[6]="FINAL_CONCENTRATION";
		descriptions[7]="FINAL_VOLUME_IN_ML";
		descriptions[8]="DRUG_DOSE";
		descriptions[9]="DRUG_ROLE";
		descriptions[10]="PRESCRIPTION_SEQUENCE";
		descriptions[11]="QUANTITY_DISPENSED";
		descriptions[12]="UNUSED";
		descriptions[13]="DRUG_ID";
		descriptions[14]="COMPONENT_DRUG_IDS";
		descriptions[15]="PRESCRIPTION_TYPE";
		descriptions[16]="SUBSTITUTION_STATUS";
		descriptions[17]="RX_ORDER_STATUS";
		descriptions[18]="NUMBER_OF_REFILLS";
		descriptions[19]="UNUSED";
		descriptions[20]="REFILLS_REMAINING";
		descriptions[21]="DEA_CLASS";
		descriptions[22]="ORDERING_MDS_DEA_NUMBER";
		descriptions[23]="UNUSED";
		descriptions[24]="LAST_REFILL_DATE_TIME";
		descriptions[25]="RX_NUMBER";
		descriptions[26]="PRN_STATUS";
		descriptions[27]="PHARMACY_INSTRUCTIONS";
		descriptions[28]="PATIENT_INSTRUCTIONS";
		descriptions[29]="INSTRUCTIONS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.RX1 seg = new hl7.pseudo.segment.RX1();

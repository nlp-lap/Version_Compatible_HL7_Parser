...
public class NPU extends hl7.character.segment.NPU{
	...
	static{
		...
		tables[0]=hl7.model.V2_1.table.Table0079.getInstance();
		tables[1]=hl7.model.V2_1.table.Table0116.getInstance();

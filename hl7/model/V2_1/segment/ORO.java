...
public class ORO extends hl7.character.segment.ORO{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_1.table.Table0012.getInstance();
		
		descriptions[0]="ORDER_ITEM_ID";
		descriptions[1]="SUBSTITUTE_ALLOWED";
		descriptions[2]="RESULTS_COPIES_TO";
		descriptions[3]="STOCK_LOCATION";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ORO seg = new hl7.pseudo.segment.ORO();

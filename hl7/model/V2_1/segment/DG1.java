...
public class DG1 extends hl7.character.segment.DG1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_1.table.Table0053.getInstance();
		tables[2]=hl7.model.V2_1.table.Table0051.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_1.table.Table0052.getInstance();
		tables[6]=hl7.model.V2_1.table.Table0118.getInstance();
		tables[7]=hl7.model.V2_1.table.Table0055.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_1.table.Table0056.getInstance();
		tables[10]=hl7.model.V2_1.table.Table0083.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==6) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;

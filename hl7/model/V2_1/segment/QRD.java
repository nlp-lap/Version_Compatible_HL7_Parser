...
public class QRD extends hl7.character.segment.QRD{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_1.table.Table0106.getInstance();
		tables[2]=hl7.model.V2_1.table.Table0091.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_1.table.Table0107.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_1.table.Table0126.getInstance();
		tables[7]=null;
		tables[8]=hl7.model.V2_1.table.Table0048.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_1.table.Table0108.getInstance();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				...
				if(i==6) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(prevVersion, prevVersion):null;

...
public class PV1 extends hl7.character.segment.PV1{
	...
	static{
		...
		standard[30]=hl7.bean.datastructure.primitive.ST.CLASS;
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_1.table.Table0004.getInstance();
		tables[2]=hl7.model.V2_1.table.Table0079.getInstance();
		tables[3]=hl7.model.V2_1.table.Table0007.getInstance();
		tables[4]=null;
		tables[5]=hl7.model.V2_1.table.Table0079.getInstance();
		tables[6]=hl7.model.V2_1.table.Table0010.getInstance();
		tables[7]=hl7.model.V2_1.table.Table0010.getInstance();
		tables[8]=hl7.model.V2_1.table.Table0010.getInstance();
		tables[9]=hl7.model.V2_1.table.Table0069.getInstance();
		tables[10]=hl7.model.V2_1.table.Table0079.getInstance();
		tables[11]=hl7.model.V2_1.table.Table0087.getInstance();
		tables[12]=hl7.model.V2_1.table.Table0092.getInstance();
		tables[13]=hl7.model.V2_1.table.Table0023.getInstance();
		tables[14]=hl7.model.V2_1.table.Table0009.getInstance();
		tables[15]=hl7.model.V2_1.table.Table0099.getInstance();
		tables[16]=hl7.model.V2_1.table.Table0010.getInstance();
		tables[17]=hl7.model.V2_1.table.Table0018.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_1.table.Table0064.getInstance();
		tables[20]=hl7.model.V2_1.table.Table0032.getInstance();
		tables[21]=hl7.model.V2_1.table.Table0045.getInstance();
		tables[22]=hl7.model.V2_1.table.Table0046.getInstance();
		tables[23]=hl7.model.V2_1.table.Table0044.getInstance();
		tables[24]=null;
		tables[25]=null;
		tables[26]=null;
		tables[27]=hl7.model.V2_1.table.Table0073.getInstance();
		tables[28]=hl7.model.V2_1.table.Table0110.getInstance();
		tables[29]=null;
		tables[30]=hl7.model.V2_1.table.Table0021.getInstance();
		tables[31]=null;
		tables[32]=null;
		tables[33]=hl7.model.V2_1.table.Table0111.getInstance();
		tables[34]=null;
		tables[35]=hl7.model.V2_1.table.Table0112.getInstance();
		tables[36]=hl7.model.V2_1.table.Table0113.getInstance();
		tables[37]=hl7.model.V2_1.table.Table0114.getInstance();
		tables[38]=hl7.model.V2_1.table.Table0115.getInstance();
		tables[39]=hl7.model.V2_1.table.Table0116.getInstance();
		tables[40]=hl7.model.V2_1.table.Table0117.getInstance();
		tables[41]=hl7.model.V2_1.table.Table0079.getInstance();
		tables[42]=hl7.model.V2_1.table.Table0079.getInstance();
		tables[43]=null;
		tables[44]=null;
		tables[45]=null;
		tables[46]=null;
		...
		descriptions[4]="PRE_ADMIT_NUMBER";
		...
		descriptions[11]="PRE_ADMIT_TEST_INDICATOR";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==2) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==5) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==18) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.NM.CLASS.cloneClass(prevVersion, prevVersion):null;
				...
				if(i==30) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(prevVersion, prevVersion):null;
				if(i==36) components[i][c] = (subComponents[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(prevVersion, prevVersion):null;

...
public class MRG extends hl7.character.segment.MRG{
	...
	static{
		standard[0]=hl7.pseudo.datastructure.CK.CLASS;
		standard[1]=hl7.pseudo.datastructure.CK.CLASS;
		standard[2]=hl7.pseudo.datastructure.CK.CLASS;
		
		tables[0]=hl7.model.V2_1.table.Table0061.getInstance();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==0) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CK.CLASS.cloneClass(prevVersion, prevVersion):null;

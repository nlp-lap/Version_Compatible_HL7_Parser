...
public class CWE extends hl7.model.V2_31.datastructure.CWE{
	public static final String VERSION = "2.4";
	public static final String IDENTIFIER = "identifier (ST)";
	public static final String TEXT = "text";
	public static final String NAME_OF_CODING_SYSTEM = "name of coding system";
	public static final String ALTERNATE_IDENTIFIER = "alternate identifier (ST)";
	...
	public CWE(){
		type = DataStructure.CWE;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.CWE data = new hl7.pseudo.datastructure.CWE();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.CWE type = (hl7.model.V2_31.datastructure.CWE)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.datastructure.CWE type = (hl7.model.V2_5.datastructure.CWE)this;

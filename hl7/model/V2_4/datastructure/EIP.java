...
public class EIP extends hl7.model.V2_31.datastructure.EIP{
	public static final String VERSION = "2.4";
	public static final String PARENTS_PLACER_ORDER_NUMBER = "parent's placer order number";
	public static final String PARENTS_FILLER_ORDER_NUMBER = "parent's filler order number";
	...
	static{
		...
		descriptions[0]=PARENTS_PLACER_ORDER_NUMBER;
		descriptions[1]=PARENTS_FILLER_ORDER_NUMBER;
	...
	public EIP(){
		type = DataStructure.EIP;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.EIP data = new hl7.pseudo.datastructure.EIP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.EIP type = (hl7.model.V2_31.datastructure.EIP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.datastructure.EIP type = (hl7.model.V2_5.datastructure.EIP)this;

...
public class CCP extends hl7.model.V2_31.datastructure.CCP{
	public static final String VERSION = "2.4";
	public static final String CHANNEL_CALIBRATION_SENSITIVITY_CORRECTION_FACTOR = "channel calibration sensitivity correction factor";
	public static final String CHANNEL_CALIBRATION_BASELINE = "channel calibration baseline";
	public static final String CHANNEL_CALIBRATION_TIME_SKEW = "channel calibration time skew";
	...
	static{
		...
		descriptions[0]=CHANNEL_CALIBRATION_SENSITIVITY_CORRECTION_FACTOR;
		descriptions[1]=CHANNEL_CALIBRATION_BASELINE;
		descriptions[2]=CHANNEL_CALIBRATION_TIME_SKEW;
	...
	public CCP(){
		type = DataStructure.CCP;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.CCP data = new hl7.pseudo.datastructure.CCP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.CCP type = (hl7.model.V2_31.datastructure.CCP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.datastructure.CCP type = (hl7.model.V2_5.datastructure.CCP)this;

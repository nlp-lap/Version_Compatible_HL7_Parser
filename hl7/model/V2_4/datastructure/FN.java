...
public class FN extends hl7.model.V2_31.datastructure.FN{
	public static final String VERSION = "2.4";
	public static final String SURNAME = "surname";
	public static final String OWN_SURNAME_PREFIX = "own surname prefix";
	public static final String OWN_SURNAME = "own surname";
	public static final String SURNAME_PREFIX_FROM_PARTNER_SPOUSE = "surname prefix from partner/spouse";
	public static final String SURNAME_FROM_PARTNER_SPOUSE = "surname from partner/spouse";
	...
	static{
		...
		descriptions[0]=SURNAME;
		descriptions[1]=OWN_SURNAME_PREFIX;
		descriptions[2]=OWN_SURNAME;
		descriptions[3]=SURNAME_PREFIX_FROM_PARTNER_SPOUSE;
		descriptions[4]=SURNAME_FROM_PARTNER_SPOUSE;
	...
	public FN(){
		type = DataStructure.FN;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.FN data = new hl7.pseudo.datastructure.FN();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==2) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==3) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==4) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.FN type = (hl7.model.V2_31.datastructure.FN)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.datastructure.FN type = (hl7.model.V2_5.datastructure.FN)this;

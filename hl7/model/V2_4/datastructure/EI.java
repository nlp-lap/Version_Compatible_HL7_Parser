...
public class EI extends hl7.model.V2_31.datastructure.EI{
	public static final String VERSION = "2.4";
	public static final String ENTITY_IDENTIFIER = "entity identifier";
	public static final String NAMESPACE_ID = "namespace ID";
	public static final String UNIVERSAL_ID = "universal ID";
	public static final String UNIVERSAL_ID_TYPE = "universal ID type";
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0300.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_4.table.Table0301.getInstance();
		
		descriptions[0]=ENTITY_IDENTIFIER;
		descriptions[1]=NAMESPACE_ID;
		descriptions[2]=UNIVERSAL_ID;
		descriptions[3]=UNIVERSAL_ID_TYPE;
	...
	public EI(){
		type = DataStructure.EI;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.EI data = new hl7.pseudo.datastructure.EI();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.EI type = (hl7.model.V2_31.datastructure.EI)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.datastructure.EI type = (hl7.model.V2_5.datastructure.EI)this;

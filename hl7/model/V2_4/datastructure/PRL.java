...
public class PRL extends hl7.model.V2_31.datastructure.PRL{
	public static final String VERSION = "2.4";
	public static final String OBX_3_OBSERVATION_IDENTIFIER_OF_PARENT_RESULT = "OBX-3 observation identifier of parent result";
	public static final String OBX_4_SUB_ID_OF_PARENT_RESULT = "OBX-4 sub-ID of parent result";
	public static final String PART_OF_OBX_5_OBSERVATION_RESULT_FROM_PARENT = "part of OBX-5 observation result from parent";
	...
	static{
		...
		descriptions[0]=OBX_3_OBSERVATION_IDENTIFIER_OF_PARENT_RESULT;
		descriptions[1]=OBX_4_SUB_ID_OF_PARENT_RESULT;
		descriptions[2]=PART_OF_OBX_5_OBSERVATION_RESULT_FROM_PARENT;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.PRL type = (hl7.model.V2_31.datastructure.PRL)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.datastructure.PRL type = (hl7.model.V2_5.datastructure.PRL)this;

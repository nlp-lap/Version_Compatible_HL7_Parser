...
public class PCF extends hl7.model.V2_31.datastructure.PCF{
	public static final String VERSION = "2.4";
	public static final String PRE_CERTIFICATION_PATIENT_TYPE = "pre-certification patient type";
	public static final String PRE_CERTIFICATION_REQUIRED = "pre-certification required";
	public static final String PRE_CERTIFICATION_WINDOW = "pre-certification window";
	...
	static{
		...
		descriptions[0]=PRE_CERTIFICATION_PATIENT_TYPE;
		descriptions[1]=PRE_CERTIFICATION_REQUIRED;
		descriptions[2]=PRE_CERTIFICATION_WINDOW;
	...
	public PCF(){
		type = DataStructure.PCF;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.PCF data = new hl7.pseudo.datastructure.PCF();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.PCF type = (hl7.model.V2_31.datastructure.PCF)this;

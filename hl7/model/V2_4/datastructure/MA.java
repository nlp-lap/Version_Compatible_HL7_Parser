...
public class MA extends hl7.model.V2_31.datastructure.MA{
	...
	public static final String SAMPLE_1_FROM_CHANNEL_3 = "sample 1 from channel 3";
	public static final String SAMPLE_1_FROM_CHANNEL_4 = "sample 1 from channel 4";
	public static final String SAMPLE_1_FROM_CHANNEL_5 = "sample 1 from channel 5";
	public static final String SAMPLE_1_FROM_CHANNEL_6 = "sample 1 from channel 6";
	...
	static{
		...
		descriptions[2]=SAMPLE_1_FROM_CHANNEL_3;
		descriptions[3]=SAMPLE_1_FROM_CHANNEL_4;
		descriptions[4]=SAMPLE_1_FROM_CHANNEL_5;
		descriptions[5]=SAMPLE_1_FROM_CHANNEL_6;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.MA type = (hl7.model.V2_31.datastructure.MA)this;

...
public class TQ extends hl7.model.V2_31.datastructure.TQ{
	...
	public static final String CONJUNCTION_COMPONENT = "conjunction component";
	...
	static{
		...
		descriptions[7]=TEXT;
		descriptions[8]=CONJUNCTION_COMPONENT;
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==7) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.TX.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==8) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;

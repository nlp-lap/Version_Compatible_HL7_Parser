...
public class OCD extends hl7.model.V2_31.datastructure.OCD{
	public static final String VERSION = "2.4";
	public static final String OCCURRENCE_CODE = "occurrence code";
	public static final String OCCURRENCE_DATE = "occurrence date";
	...
	static{
		...
		descriptions[0]=OCCURRENCE_CODE;
		descriptions[1]=OCCURRENCE_DATE;
	...
	public OCD(){
		type = DataStructure.OCD;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.OCD data = new hl7.pseudo.datastructure.OCD();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==0) subComponents[i] = (components[i]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.datastructure.OCD type = (hl7.model.V2_31.datastructure.OCD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.datastructure.OCD type = (hl7.model.V2_5.datastructure.OCD)this;

...
public class DG1 extends hl7.model.V2_31.segment.DG1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0053.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0051.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_4.table.Table0052.getInstance();
		tables[6]=hl7.model.V2_4.table.Table0118.getInstance();
		tables[7]=hl7.model.V2_4.table.Table0055.getInstance();
		tables[8]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[9]=hl7.model.V2_4.table.Table0056.getInstance();
		tables[10]=hl7.model.V2_4.table.Table0083.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_4.table.Table0359.getInstance();
		tables[15]=null;
		tables[16]=hl7.model.V2_4.table.Table0228.getInstance();

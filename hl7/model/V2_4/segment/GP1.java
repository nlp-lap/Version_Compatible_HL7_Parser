...
public class GP1 extends hl7.character.segment.GP1{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0455.getInstance();
		tables[1]=hl7.model.V2_4.table.Table0456.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0457.getInstance();
		tables[3]=hl7.model.V2_4.table.Table0458.getInstance();
		tables[4]=null;

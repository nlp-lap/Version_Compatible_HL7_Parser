...
public class PRC extends hl7.model.V2_31.segment.PRC{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0132.getInstance();
		tables[1]=hl7.model.V2_4.table.Table0464.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0184.getInstance();
		tables[3]=hl7.model.V2_4.table.Table0004.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		...
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_4.table.Table0268.getInstance();
		tables[13]=hl7.model.V2_4.table.Table0293.getInstance();
		tables[14]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[15]=hl7.model.V2_4.table.Table0183.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_4.table.Table0269.getInstance();

...
public class TXA extends hl7.model.V2_31.segment.TXA{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0270.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0191.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		...
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_4.table.Table0271.getInstance();
		tables[17]=hl7.model.V2_4.table.Table0272.getInstance();
		tables[18]=hl7.model.V2_4.table.Table0273.getInstance();
		tables[19]=hl7.model.V2_4.table.Table0275.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.segment.TXA type = (hl7.model.V2_31.segment.TXA)this;

...
public class GP2 extends hl7.character.segment.GP2{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0456.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_4.table.Table0459.getInstance();
		tables[4]=hl7.model.V2_4.table.Table0460.getInstance();
		tables[5]=hl7.model.V2_4.table.Table0458.getInstance();
		tables[6]=hl7.model.V2_4.table.Table0466.getInstance();
		tables[7]=hl7.model.V2_4.table.Table0467.getInstance();
		tables[8]=hl7.model.V2_4.table.Table0468.getInstance();
		tables[9]=hl7.model.V2_4.table.Table0469.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_4.table.Table0470.getInstance();
		tables[12]=null;
		tables[13]=null;
		...
		descriptions[10]="EXPECTED_HCFA_PAYMENT_AMOUNT";
		descriptions[11]="REIMBURSEMENT_TYPE_CODE";
		descriptions[12]="CO_PAY_AMOUNT";
		descriptions[13]="PAY_RATE_PER_UNIT";

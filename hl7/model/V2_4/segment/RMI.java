...
public class RMI extends hl7.character.segment.RMI{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0427.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_4.table.Table0428.getInstance();

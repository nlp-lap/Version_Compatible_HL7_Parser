...
public class LAN extends hl7.character.segment.LAN{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0296.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0403.getInstance();
		tables[3]=hl7.model.V2_4.table.Table0404.getInstance();

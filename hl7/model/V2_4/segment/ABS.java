...
public class ABS extends hl7.character.segment.ABS{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0010.getInstance();
		tables[1]=hl7.model.V2_4.table.Table0069.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0421.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_4.table.Table0422.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_4.table.Table0423.getInstance();
		tables[9]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[10]=hl7.model.V2_4.table.Table0424.getInstance();
		tables[11]=null;
		tables[12]=hl7.model.V2_4.table.Table0425.getInstance();
		tables[13]=hl7.model.V2_4.table.Table0136.getInstance();

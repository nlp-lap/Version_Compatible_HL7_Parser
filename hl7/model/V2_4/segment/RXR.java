...
public class RXR extends hl7.model.V2_31.segment.RXR{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0162.getInstance();
		tables[1]=hl7.model.V2_4.table.Table0163.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0164.getInstance();
		tables[3]=hl7.model.V2_4.table.Table0165.getInstance();
		tables[4]=null;
		
		descriptions[0]="ROUTE";
		descriptions[1]="ADMINISTRATION_SITE";
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.RXR type = (hl7.model.V2_5.segment.RXR)this;

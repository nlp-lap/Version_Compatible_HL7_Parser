...
public class QAK extends hl7.model.V2_31.segment.QAK{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0208.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0471.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		
		descriptions[0]="QUERY_TAG";
		descriptions[1]="QUERY_RESPONSE_STATUS";
		descriptions[2]="MESSAGE_QUERY_NAME";
		descriptions[3]="HIT_COUNT_TOTAL";
		descriptions[4]="THIS_PAYLOAD";
		descriptions[5]="HITS_REMAINING";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.QAK seg = new hl7.pseudo.segment.QAK();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.segment.QAK type = (hl7.model.V2_31.segment.QAK)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.QAK type = (hl7.model.V2_5.segment.QAK)this;

...
public class PRD extends hl7.model.V2_31.segment.PRD{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0286.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_4.table.Table0185.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==6) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.PI.CLASS.cloneClass(prevVersion, prevVersion):null;

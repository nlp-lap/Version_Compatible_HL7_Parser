...
public class PID extends hl7.model.V2_31.segment.PID{
	...
	static{
		...
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_4.table.Table0001.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_4.table.Table0005.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_4.table.Table0289.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_4.table.Table0296.getInstance();
		tables[15]=hl7.model.V2_4.table.Table0002.getInstance();
		tables[16]=hl7.model.V2_4.table.Table0006.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
		tables[21]=hl7.model.V2_4.table.Table0189.getInstance();
		tables[22]=null;
		tables[23]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[24]=null;
		tables[25]=hl7.model.V2_4.table.Table0171.getInstance();
		tables[26]=hl7.model.V2_4.table.Table0172.getInstance();
		tables[27]=hl7.model.V2_4.table.Table0212.getInstance();
		tables[28]=null;
		tables[29]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[30]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[31]=hl7.model.V2_4.table.Table0445.getInstance();
		tables[32]=null;
		tables[33]=null;
		tables[34]=hl7.model.V2_4.table.Table0446.getInstance();
		tables[35]=hl7.model.V2_4.table.Table0447.getInstance();
		tables[36]=null;
		tables[37]=hl7.model.V2_4.table.Table0429.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==33) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;

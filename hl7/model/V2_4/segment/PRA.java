...
public class PRA extends hl7.model.V2_31.segment.PRA{
	...
	static{
		...
		standard[4]=hl7.pseudo.datastructure.SPD.CLASS;
		standard[5]=hl7.pseudo.datastructure.PLN.CLASS;
		standard[6]=hl7.pseudo.datastructure.PIP.CLASS;
		...
		standard[11]=hl7.bean.datastructure.primitive.SI.CLASS;
		
		tables[0]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[1]=hl7.model.V2_4.table.Table0358.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0186.getInstance();
		tables[3]=hl7.model.V2_4.table.Table0187.getInstance();
		tables[4]=hl7.model.V2_4.table.Table0337.getInstance();
		tables[5]=hl7.model.V2_4.table.Table0338.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_4.table.Table0401.getInstance();
		tables[11]=null;
		
		descriptions[0]="PRIMARY_KEY_VALUE_PRA";
		descriptions[1]="PRACTITIONER_GROUP";
		descriptions[2]="PRACTITIONER_CATEGORY";
		descriptions[3]="PROVIDER_BILLING";
		descriptions[4]="SPECIALTY";
		descriptions[5]="PRACTITIONER_ID_NUMBERS";
		descriptions[6]="PRIVILEGES";
		descriptions[7]="DATE_ENTERED_PRACTICE";
		descriptions[8]="INSTITUTION";
		descriptions[9]="DATE_LEFT_PRACTICE";
		descriptions[10]="GOVERNMENT_REIMBURSEMENT_BILLING_ELIGIBILITY";
		descriptions[11]="SET_ID_PRA";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.SI.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.PRA type = (hl7.model.V2_5.segment.PRA)this;

...
public class ORG extends hl7.character.segment.ORG{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0405.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0474.getInstance();
		tables[3]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[4]=null;
		tables[5]=hl7.model.V2_4.table.Table0452.getInstance();
		tables[6]=hl7.model.V2_4.table.Table0453.getInstance();
		tables[7]=hl7.model.V2_4.table.Table0454.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_4.table.Table0066.getInstance();
		...
		descriptions[2]="ORGANIZATION_UNIT_TYPE_CODE_ORG";

...
public class OM2 extends hl7.model.V2_31.segment.OM2{
	...
	static{
		...
		tables[2]=null;
		tables[3]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		...
		descriptions[5]="REFERENCE_RANGE_ORDINAL_AND_CONTINUOUS_OBSERVATIONS";
		descriptions[6]="CRITICAL_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS";
		descriptions[7]="ABSOLUTE_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS";
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==6) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.NR.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.OM2 type = (hl7.model.V2_5.segment.OM2)this;

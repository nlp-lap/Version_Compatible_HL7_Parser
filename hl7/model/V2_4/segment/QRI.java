...
public class QRI extends hl7.character.segment.QRI{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0392.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0393.getInstance();

...
public class EVN extends hl7.model.V2_31.segment.EVN{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0003.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_4.table.Table0062.getInstance();
		tables[4]=hl7.model.V2_4.table.Table0188.getInstance();
		tables[5]=null;
		tables[6]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==6) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.HD.CLASS.cloneClass(VERSION, VERSION):null;

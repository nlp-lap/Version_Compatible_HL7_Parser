...
public class OM1 extends hl7.model.V2_31.segment.OM1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0125.getInstance();
		tables[3]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[4]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[12]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[13]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[14]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[15]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_4.table.Table0174.getInstance();
		tables[18]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[19]=null;
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		tables[24]=hl7.model.V2_4.table.Table0168.getInstance();
		tables[25]=hl7.model.V2_4.table.Table0169.getInstance();
		tables[26]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_4.table.Table0177.getInstance();
		tables[30]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[31]=null;
		tables[32]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[33]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[34]=null;
		tables[35]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[36]=null;
		tables[37]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[38]=null;
		tables[39]=null;
		tables[40]=null;
		tables[41]=hl7.model.V2_4.table.Table0254.getInstance();
		tables[42]=hl7.model.V2_4.table.Table0255.getInstance();
		tables[43]=hl7.model.V2_4.table.Table0256.getInstance();
		tables[44]=hl7.model.V2_4.table.Table0258.getInstance();
		tables[45]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[46]=hl7.model.V2_4.table.Table0259.getInstance();
		...
		descriptions[38]="FACTORS_THAT_MAY_AFFECT_AFFECT_THE_OBSERVATION";

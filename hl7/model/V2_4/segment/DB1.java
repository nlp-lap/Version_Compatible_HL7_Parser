...
public class DB1 extends hl7.model.V2_31.segment.DB1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0334.getInstance();
		tables[2]=null;
		...
		descriptions[0]="SET_ID_DB1";
		descriptions[1]="DISABLED_PERSON_CODE";
		descriptions[2]="DISABLED_PERSON_IDENTIFIER";
		descriptions[3]="DISABILITY_INDICATOR";
		descriptions[4]="DISABILITY_START_DATE";
		descriptions[5]="DISABILITY_END_DATE";
		descriptions[6]="DISABILITY_RETURN_TO_WORK_DATE";
		descriptions[7]="DISABILITY_UNABLE_TO_WORK_DATE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.DB1 seg = new hl7.pseudo.segment.DB1();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.segment.DB1 type = (hl7.model.V2_31.segment.DB1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.DB1 type = (hl7.model.V2_5.segment.DB1)this;

...
public class PR1 extends hl7.model.V2_31.segment.PR1{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0089.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0088.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_4.table.Table0230.getInstance();
		tables[6]=null;
		tables[7]=hl7.model.V2_4.table.Table0010.getInstance();
		tables[8]=hl7.model.V2_4.table.Table0019.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_4.table.Table0010.getInstance();
		tables[11]=hl7.model.V2_4.table.Table0010.getInstance();
		tables[12]=hl7.model.V2_4.table.Table0059.getInstance();
		tables[13]=hl7.model.V2_4.table.Table0418.getInstance();
		tables[14]=hl7.model.V2_4.table.Table0051.getInstance();
		tables[15]=hl7.model.V2_4.table.Table0340.getInstance();
		tables[16]=hl7.model.V2_4.table.Table0416.getInstance();
		tables[17]=hl7.model.V2_4.table.Table0417.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==13) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;

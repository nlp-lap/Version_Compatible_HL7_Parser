...
public class ACC extends hl7.model.V2_31.segment.ACC{
	...
	static{
		standard[0]=hl7.bean.datastructure.primitive.TS.CLASS;
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_4.table.Table0050.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_4.table.Table0347.getInstance();
		tables[4]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[5]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_4.table.Table0136.getInstance();
		
		descriptions[0]="ACCIDENT_DATE_TIME";
		descriptions[1]="ACCIDENT_CODE";
		descriptions[2]="ACCIDENT_LOCATION";
		descriptions[3]="AUTO_ACCIDENT_STATE";
		descriptions[4]="ACCIDENT_JOB_RELATED_INDICATOR";
		descriptions[5]="ACCIDENT_DEATH_INDICATOR";
		descriptions[6]="ENTERED_BY";
		descriptions[7]="ACCIDENT_DESCRIPTION";
		descriptions[8]="BROUGHT_IN_BY";
		descriptions[9]="POLICE_NOTIFIED_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.ACC seg = new hl7.pseudo.segment.ACC();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==8) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ST.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.ID.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.segment.ACC type = (hl7.model.V2_31.segment.ACC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.ACC type = (hl7.model.V2_5.segment.ACC)this;

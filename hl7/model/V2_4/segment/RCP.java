...
public class RCP extends hl7.character.segment.RCP{
	...
	static{
		...
		tables[0]=hl7.model.V2_4.table.Table0091.getInstance();
		tables[1]=hl7.model.V2_4.table.Table0126.getInstance();
		tables[2]=hl7.model.V2_4.table.Table0394.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_4.table.Table0395.getInstance();
		tables[5]=null;
		tables[6]=null;

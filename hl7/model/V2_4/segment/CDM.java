...
public class CDM extends hl7.model.V2_31.segment.CDM{
	...
	static{
		...
		standard[10]=hl7.pseudo.datastructure.CK.CLASS;
		standard[11]=hl7.pseudo.datastructure.XON.CLASS;
		...
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_4.table.Table0268.getInstance();
		tables[5]=hl7.model.V2_4.table.Table9999.getInstance();
		tables[6]=hl7.model.V2_4.table.Table0088.getInstance();
		tables[7]=hl7.model.V2_4.table.Table0183.getInstance();
		tables[8]=hl7.model.V2_4.table.Table0463.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_4.table.Table0136.getInstance();
		
		descriptions[0]="PRIMARY_KEY_VALUE_CDM";
		descriptions[1]="CHARGE_CODE_ALIAS";
		descriptions[2]="CHARGE_DESCRIPTION_SHORT";
		descriptions[3]="CHARGE_DESCRIPTION_LONG";
		descriptions[4]="DESCRIPTION_OVERRIDE_INDICATOR";
		descriptions[5]="EXPLODING_CHARGES";
		descriptions[6]="PROCEDURE_CODE";
		descriptions[7]="ACTIVE_INACTIVE_FLAG";
		descriptions[8]="INVENTORY_NUMBER";
		descriptions[9]="RESOURCE_LOAD";
		descriptions[10]="CONTRACT_NUMBER";
		descriptions[11]="CONTRACT_ORGANIZATION";
		descriptions[12]="ROOM_FEE_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.CDM seg = new hl7.pseudo.segment.CDM();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==10) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.CK.CLASS.cloneClass(prevVersion, prevVersion):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.segment.CDM type = (hl7.model.V2_31.segment.CDM)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.CDM type = (hl7.model.V2_5.segment.CDM)this;

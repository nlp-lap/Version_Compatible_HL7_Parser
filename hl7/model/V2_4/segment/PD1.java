...
public class PD1 extends hl7.model.V2_31.segment.PD1{
	...
	static{
		...
		standard[2]=hl7.pseudo.datastructure.XON.CLASS;
		standard[3]=hl7.pseudo.datastructure.XCN.CLASS;
		...
		standard[13]=hl7.pseudo.datastructure.XON.CLASS;
		...
		tables[0]=hl7.model.V2_4.table.Table0223.getInstance();
		tables[1]=hl7.model.V2_4.table.Table0220.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_4.table.Table0231.getInstance();
		tables[5]=hl7.model.V2_4.table.Table0295.getInstance();
		tables[6]=hl7.model.V2_4.table.Table0315.getInstance();
		tables[7]=hl7.model.V2_4.table.Table0316.getInstance();
		tables[8]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[9]=null;
		tables[10]=hl7.model.V2_4.table.Table0215.getInstance();
		tables[11]=hl7.model.V2_4.table.Table0136.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_4.table.Table0435.getInstance();
		tables[15]=hl7.model.V2_4.table.Table0441.getInstance();
		tables[16]=null;
		tables[17]=null;
		tables[18]=hl7.model.V2_4.table.Table0140.getInstance();
		tables[19]=hl7.model.V2_4.table.Table0141.getInstance();
		tables[20]=hl7.model.V2_4.table.Table0142.getInstance();
		
		descriptions[0]="LIVING_DEPENDENCY";
		descriptions[1]="LIVING_ARRANGEMENT";
		descriptions[2]="PATIENT_PRIMARY_FACILITY";
		descriptions[3]="PATIENT_PRIMARY_CARE_PROVIDER_NAME_ID_NO";
		descriptions[4]="STUDENT_INDICATOR";
		descriptions[5]="HANDICAP";
		descriptions[6]="LIVING_WILL_CODE";
		descriptions[7]="ORGAN_DONOR_CODE";
		descriptions[8]="SEPARATE_BILL";
		descriptions[9]="DUPLICATE_PATIENT";
		descriptions[10]="PUBLICITY_CODE";
		descriptions[11]="PROTECTION_INDICATOR";
		descriptions[12]="PROTECTION_INDICATOR_EFFECTIVE_DATE";
		descriptions[13]="PLACE_OF_WORSHIP";
		descriptions[14]="ADVANCE_DIRECTIVE_CODE";
		descriptions[15]="IMMUNIZATION_REGISTRY_STATUS";
		descriptions[16]="IMMUNIZATION_REGISTRY_STATUS_EFFECTIVE_DATE";
		descriptions[17]="PUBLICITY_CODE_EFFECTIVE_DATE";
		descriptions[18]="MILITARY_BRANCH";
		descriptions[19]="MILITARY_RANK_GRADE";
		descriptions[20]="MILITARY_STATUS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PD1 seg = new hl7.pseudo.segment.PD1();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==12) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==17) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.DT.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==13) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XON.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==14) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.segment.PD1 type = (hl7.model.V2_31.segment.PD1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.PD1 type = (hl7.model.V2_5.segment.PD1)this;

...
public class SCH extends hl7.model.V2_31.segment.SCH{
	...
	static{
		...
		standard[25]=hl7.pseudo.datastructure.EI.CLASS;
		standard[26]=hl7.pseudo.datastructure.EI.CLASS;
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_4.table.Table0276.getInstance();
		tables[7]=hl7.model.V2_4.table.Table0277.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		...
		tables[22]=null;
		tables[23]=null;
		tables[24]=hl7.model.V2_4.table.Table0278.getInstance();
		tables[25]=null;
		tables[26]=null;
		...
		descriptions[10]="APPOINTMENT_TIMING_QUANTITY";
		descriptions[11]="PLACER_CONTACT_PERSON";
		descriptions[12]="PLACER_CONTACT_PHONE_NUMBER";
		descriptions[13]="PLACER_CONTACT_ADDRESS";
		descriptions[14]="PLACER_CONTACT_LOCATION";
		descriptions[15]="FILLER_CONTACT_PERSON";
		descriptions[16]="FILLER_CONTACT_PHONE_NUMBER";
		descriptions[17]="FILLER_CONTACT_ADDRESS";
		descriptions[18]="FILLER_CONTACT_LOCATION";
		descriptions[19]="ENTERED_BY_PERSON";
		descriptions[20]="ENTERED_BY_PHONE_NUMBER";
		descriptions[21]="ENTERED_BY_LOCATION";
		descriptions[22]="PARENT_PLACER_APPOINTMENT_ID";
		descriptions[23]="PARENT_FILLER_APPOINTMENT_ID";
		descriptions[24]="FILLER_STATUS_CODE";
		descriptions[25]="PLACER_ORDER_NUMBER";
		descriptions[26]="FILLER_ORDER_NUMBER";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.SCH seg = new hl7.pseudo.segment.SCH();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==25) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==26) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.EI.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.segment.SCH type = (hl7.model.V2_31.segment.SCH)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.SCH type = (hl7.model.V2_5.segment.SCH)this;

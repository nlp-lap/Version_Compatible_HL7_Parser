...
public class IN3 extends hl7.model.V2_31.segment.IN3{
	...
	static{
		...
		tables[4]=hl7.model.V2_4.table.Table0148.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_4.table.Table0149.getInstance();
		tables[11]=hl7.model.V2_4.table.Table0233.getInstance();
		tables[12]=null;
		tables[13]=hl7.model.V2_4.table.Table0010.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_4.table.Table0345.getInstance();
		tables[17]=hl7.model.V2_4.table.Table0346.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_4.table.Table0150.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=hl7.model.V2_4.table.Table0151.getInstance();
		tables[23]=hl7.model.V2_4.table.Table0152.getInstance();
		tables[24]=hl7.model.V2_4.table.Table0010.getInstance();
	...
	public static void backward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion, String prevVersion) throws Exception{
		for(int i=0; subComponents!=null&&i<subComponents.length; i++){
			...
			for(int c=0; c<subComps.length; c++){
				if(i==19) components[i][c] = (subComponents[i][c]!=null)?hl7.pseudo.datastructure.PCF.CLASS.cloneClass(prevVersion, prevVersion):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.segment.IN3 type = (hl7.model.V2_5.segment.IN3)this;

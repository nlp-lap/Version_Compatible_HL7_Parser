...
public class Table0354 extends Table{
	...
	public static final String RDY_K11 = "RDY_K11";
	...
	public static final String RSP_K24 = "RSP_K24";
	...
	private Table0354(){
		...
		putMap("MFN_M11", "M11");
		putMap("MFN_M12", "M12");
		putMap("MFQ_M01", "M01-M06");
		putMap("MFR_M01", "M01-M06");
		putMap("NMD_N02", "N02");
		putMap("NMQ_N01", "N01");
		putMap("NMR_N01", "N01");
		putMap("OMD_O03", "O03");
		...
		putMap("PMU_B03", "B03");
		putMap("PMU_B04", "B04, B05");
		putMap("PPG_PCG", "PCG, PCH, PCJ");
		putMap("PPP_PCB", "PCB, PCC, PCD");

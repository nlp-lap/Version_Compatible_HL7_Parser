...
public class Table0076 extends Table{
	...
	private Table0076(){
		...
		putMap("ESR", "Automated equipment status update acknowledgement message");
		...
		putMap("MCF", "Delayed Acknowledgement (Retained for backward compatibility only)");
		...
		putMap("ORD", "Dietary order - General order acknowledgment message");
		putMap("ORF", "Query for results of observation");
		putMap("ORG", "General clinical order acknowledgement message");
		putMap("ORL", "Laboratory acknowledgement message (unsolicited)");
		putMap("ORM", "Pharmacy/treatment order message");
		putMap("ORN", "Non-stock requisition - General order acknowledgment message");
		putMap("ORP", "Pharmacy/treatment order acknowledgement message");
		putMap("ORR", "General order response message response to any ORM");
		putMap("ORS", "Stock requisition - General order acknowledgment message");
		...
		putMap("RRA", "Pharmacy/treatment administration acknowledgement message");

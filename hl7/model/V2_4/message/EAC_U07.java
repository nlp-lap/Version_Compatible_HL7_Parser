...
public class EAC_U07 extends hl7.character.message.EAC_U07{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.EQU.CLASS;
		standard[2]=hl7.pseudo.segment.ECD.CLASS;
		standard[3]=hl7.pseudo.segment.SAC.CLASS;
		standard[4]=hl7.pseudo.segment.CNS.CLASS;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.message.EAC_U07 type = (hl7.model.V2_5.message.EAC_U07)this;

...
public class ADT_A01 extends hl7.model.V2_31.message.ADT_A01{
	...
	static{
		...
		standard[5]=hl7.pseudo.segment.NK1.CLASS;
		standard[6]=hl7.pseudo.segment.PV1.CLASS;
		standard[7]=hl7.pseudo.segment.PV2.CLASS;
		standard[8]=hl7.pseudo.segment.ROL.CLASS;
		standard[9]=hl7.pseudo.segment.DB1.CLASS;
		standard[10]=hl7.pseudo.segment.OBX.CLASS;
		standard[11]=hl7.pseudo.segment.AL1.CLASS;
		standard[12]=hl7.pseudo.segment.DG1.CLASS;
		standard[13]=hl7.pseudo.segment.DRG.CLASS;
		standard[15]=hl7.pseudo.segment.GT1.CLASS;
		standard[17]=hl7.pseudo.segment.ACC.CLASS;
		standard[18]=hl7.pseudo.segment.UB1.CLASS;
		standard[19]=hl7.pseudo.segment.UB2.CLASS;
		standard[20]=hl7.pseudo.segment.PDA.CLASS;
		standard[14]=hl7.pseudo.group.PROCEDURE_ADT_A01.CLASS;
		standard[16]=hl7.pseudo.group.INSURANCE_ADT_A01.CLASS;
	...
	public static void forward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		...
		subComponents[8] = null;
		subComponents[20] = null;
	}
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.message.ADT_A01 type = (hl7.model.V2_31.message.ADT_A01)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.message.ADT_A01 type = (hl7.model.V2_5.message.ADT_A01)this;

...
public class ADT_A05 extends hl7.model.V2_7.message.ADT_A05{
	...
	static{
		...
		standard[14]=hl7.pseudo.group.PROCEDURE_ADT_A05.CLASS;
		standard[16]=hl7.pseudo.group.INSURANCE_ADT_A05.CLASS;
	...
	public static void forward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		...
		subComponents[1] = components[3];
		subComponents[2] = components[4];
		subComponents[3] = components[5];
		subComponents[4] = components[7];
		subComponents[5] = components[8];
		subComponents[6] = components[9];
		subComponents[7] = components[10];
		subComponents[8] = components[12];
		subComponents[9] = components[13];
		subComponents[10] = components[14];
		subComponents[11] = components[15];
		subComponents[12] = components[16];
		subComponents[13] = components[17];
		subComponents[14] = components[18];
		subComponents[15] = components[19];
		subComponents[16] = components[20];
		subComponents[17] = components[21];
		subComponents[18] = components[22];
		subComponents[19] = components[23];
	}

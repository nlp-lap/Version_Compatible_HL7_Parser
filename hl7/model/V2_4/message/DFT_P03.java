...
public class DFT_P03 extends hl7.model.V2_31.message.DFT_P03{
	...
	static{
		...
		standard[5]=hl7.pseudo.segment.PV1.CLASS;
		standard[6]=hl7.pseudo.segment.PV2.CLASS;
		...
		standard[13]=hl7.pseudo.segment.GT1.CLASS;
		standard[15]=hl7.pseudo.segment.ACC.CLASS;
		standard[9]=hl7.pseudo.group.COMMON_ORDER_DFT_P03.CLASS;
		standard[10]=hl7.pseudo.group.FINANCIAL_DFT_P03.CLASS;
		standard[14]=hl7.pseudo.group.INSURANCE_DFT_P03.CLASS;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_31.message.DFT_P03 type = (hl7.model.V2_31.message.DFT_P03)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.message.DFT_P03 type = (hl7.model.V2_5.message.DFT_P03)this;

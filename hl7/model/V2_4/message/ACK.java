...
public class ACK extends hl7.model.V2_31.message.ACK{
	...
	static{
		...
		standard[3]=hl7.pseudo.segment.MSH.CLASS;
		standard[4]=hl7.pseudo.segment.MSA.CLASS;
		standard[5]=hl7.pseudo.segment.MSA.CLASS;
		standard[6]=hl7.pseudo.segment.MSH.CLASS;
		standard[7]=hl7.pseudo.segment.MSA.CLASS;
		standard[8]=hl7.pseudo.segment.ERR.CLASS;
		standard[9]=hl7.pseudo.segment.MSH.CLASS;
		standard[10]=hl7.pseudo.segment.MSA.CLASS;
		standard[11]=hl7.pseudo.segment.ERR.CLASS;
		standard[12]=hl7.pseudo.segment.MSH.CLASS;
		standard[13]=hl7.pseudo.segment.MSA.CLASS;
		standard[14]=hl7.pseudo.segment.MSH.CLASS;
		standard[15]=hl7.pseudo.segment.MSA.CLASS;
		standard[16]=hl7.pseudo.segment.ERR.CLASS;
		standard[17]=hl7.pseudo.segment.ERR.CLASS;
	...
	public static void forward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		...
		subComponents[3] = components[4];
		subComponents[4] = components[5];
		subComponents[5] = components[5];
		subComponents[6] = components[7];
		subComponents[7] = components[8];
		subComponents[8] = components[9];
		...
		subComponents[14] = components[16];
		subComponents[15] = components[17];
		subComponents[16] = components[18];
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.message.ACK type = (hl7.model.V2_5.message.ACK)this;

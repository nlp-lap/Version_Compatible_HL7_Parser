...
public class ORDER_ORF_R04 extends hl7.model.V2_31.group.ORDER_ORF_R04{
	...
	static{
		...
		standard[4]=hl7.pseudo.group.OBSERVATION_ORF_R04.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_31.group.ORDER_ORF_R04 type = (hl7.model.V2_31.group.ORDER_ORF_R04)this;

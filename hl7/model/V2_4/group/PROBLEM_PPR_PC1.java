...
public class PROBLEM_PPR_PC1 extends hl7.model.V2_31.group.PROBLEM_PPR_PC1{
	...
	static{
		standard[0]=hl7.pseudo.segment.PRB.CLASS;
		standard[1]=hl7.pseudo.segment.NTE.CLASS;
		standard[2]=hl7.pseudo.segment.VAR.CLASS;
		standard[3]=hl7.pseudo.group.PROBLEM_ROLE_PPR_PC1.CLASS;
		standard[4]=hl7.pseudo.group.PATHWAY_PPR_PC1.CLASS;
		standard[5]=hl7.pseudo.group.PROBLEM_OBSERVATION_PPR_PC1.CLASS;
		standard[6]=hl7.pseudo.group.GOAL_PPR_PC1.CLASS;
		standard[7]=hl7.pseudo.group.ORDER_PPR_PC1.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.PROBLEM_PPR_PC1 group = new hl7.pseudo.group.PROBLEM_PPR_PC1();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_31.group.PROBLEM_PPR_PC1 type = (hl7.model.V2_31.group.PROBLEM_PPR_PC1)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.group.PROBLEM_PPR_PC1 type = (hl7.model.V2_5.group.PROBLEM_PPR_PC1)this;

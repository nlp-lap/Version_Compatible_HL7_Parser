...
public class ORDER_ORM_O01 extends hl7.model.V2_31.group.ORDER_ORM_O01{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.FT1.CLASS;
		standard[3]=hl7.pseudo.segment.CTI.CLASS;
		standard[4]=hl7.pseudo.segment.BLG.CLASS;
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_ORM_O01.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.ORDER_ORM_O01 group = new hl7.pseudo.group.ORDER_ORM_O01();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_31.group.ORDER_ORM_O01 type = (hl7.model.V2_31.group.ORDER_ORM_O01)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.group.ORDER_ORM_O01 type = (hl7.model.V2_5.group.ORDER_ORM_O01)this;

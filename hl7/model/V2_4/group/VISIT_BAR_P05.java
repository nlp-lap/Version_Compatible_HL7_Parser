...
public class VISIT_BAR_P05 extends hl7.model.V2_31.group.VISIT_BAR_P05{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.ROL.CLASS;
		standard[3]=hl7.pseudo.segment.DB1.CLASS;
		standard[4]=hl7.pseudo.segment.OBX.CLASS;
		standard[5]=hl7.pseudo.segment.AL1.CLASS;
		standard[6]=hl7.pseudo.segment.DG1.CLASS;
		standard[7]=hl7.pseudo.segment.DRG.CLASS;
		standard[9]=hl7.pseudo.segment.GT1.CLASS;
		standard[10]=hl7.pseudo.segment.NK1.CLASS;
		standard[12]=hl7.pseudo.segment.ACC.CLASS;
		standard[13]=hl7.pseudo.segment.UB1.CLASS;
		standard[14]=hl7.pseudo.segment.UB2.CLASS;
		standard[15]=hl7.pseudo.segment.ABS.CLASS;
		standard[16]=hl7.pseudo.segment.BLC.CLASS;
		standard[17]=hl7.pseudo.segment.RMI.CLASS;
		standard[8]=hl7.pseudo.group.PROCEDURE_BAR_P05.CLASS;
		standard[11]=hl7.pseudo.group.INSURANCE_BAR_P05.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.VISIT_BAR_P05 group = new hl7.pseudo.group.VISIT_BAR_P05();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_31.group.VISIT_BAR_P05 type = (hl7.model.V2_31.group.VISIT_BAR_P05)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.group.VISIT_BAR_P05 type = (hl7.model.V2_5.group.VISIT_BAR_P05)this;

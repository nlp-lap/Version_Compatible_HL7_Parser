...
public class ORDER_RDE_O11 extends hl7.character.group.ORDER_RDE_O11{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.RXE.CLASS;
		standard[3]=hl7.pseudo.segment.RXR.CLASS;
		standard[4]=hl7.pseudo.segment.RXC.CLASS;
		standard[6]=hl7.pseudo.segment.CTI.CLASS;
		standard[1]=hl7.pseudo.group.ORDER_DETAIL_RDE_O11.CLASS;
		standard[5]=hl7.pseudo.group.OBSERVATION_RDE_O11.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[5] = subComponents[8];
		components[6] = subComponents[11];
	}

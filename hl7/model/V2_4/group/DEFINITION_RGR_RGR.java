...
public class DEFINITION_RGR_RGR extends hl7.model.V2_31.group.DEFINITION_RGR_RGR{
	...
	static{
		standard[0]=hl7.pseudo.segment.QRD.CLASS;
		standard[1]=hl7.pseudo.segment.QRF.CLASS;
		standard[2]=hl7.pseudo.group.PATIENT_RGR_RGR.CLASS;
		standard[3]=hl7.pseudo.group.ORDER_RGR_RGR.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.DEFINITION_RGR_RGR group = new hl7.pseudo.group.DEFINITION_RGR_RGR();
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_31.group.DEFINITION_RGR_RGR type = (hl7.model.V2_31.group.DEFINITION_RGR_RGR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_5.group.DEFINITION_RGR_RGR type = (hl7.model.V2_5.group.DEFINITION_RGR_RGR)this;

...
public class ORDER_VXR_V03 extends hl7.model.V2_31.group.ORDER_VXR_V03{
	...
	static{
		...
		standard[1]=hl7.pseudo.segment.RXA.CLASS;
		standard[2]=hl7.pseudo.segment.RXR.CLASS;
		standard[3]=hl7.pseudo.group.OBSERVATION_VXR_V03.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_31.group.ORDER_VXR_V03 type = (hl7.model.V2_31.group.ORDER_VXR_V03)this;

...
public class MF_NUMERIC_OBSERVATION_MFN_M08 extends hl7.character.group.MF_NUMERIC_OBSERVATION_MFN_M08{
	...
	static{
		standard[0]=hl7.pseudo.segment.OM2.CLASS;
		standard[1]=hl7.pseudo.segment.OM3.CLASS;
		standard[2]=hl7.pseudo.segment.OM4.CLASS;
	...
	public Group cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.group.MF_NUMERIC_OBSERVATION_MFN_M08 group = new hl7.pseudo.group.MF_NUMERIC_OBSERVATION_MFN_M08();

...
public class VISIT_BAR_P05 extends hl7.model.V2_3.group.VISIT_BAR_P05{
	...
	static{
		...
		standard[2]=hl7.pseudo.segment.DB1.CLASS;
		standard[3]=hl7.pseudo.segment.OBX.CLASS;
		standard[4]=hl7.pseudo.segment.AL1.CLASS;
		standard[5]=hl7.pseudo.segment.DG1.CLASS;
		standard[6]=hl7.pseudo.segment.DRG.CLASS;
		...
		standard[7]=hl7.pseudo.group.PROCEDURE_BAR_P05.CLASS;
		standard[10]=hl7.pseudo.group.INSURANCE_BAR_P05.CLASS;
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					//설정 버전이 현재 버전보다 낮을 때 (backward)
						hl7.model.V2_3.group.VISIT_BAR_P05 type = (hl7.model.V2_3.group.VISIT_BAR_P05)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.group.VISIT_BAR_P05 type = (hl7.model.V2_4.group.VISIT_BAR_P05)this;

...
public class ADT_A05 extends hl7.model.V2_3.message.ADT_A05{
	...
	static{
		...
		standard[7]=hl7.pseudo.segment.DB1.CLASS;
		standard[8]=hl7.pseudo.segment.OBX.CLASS;
		standard[9]=hl7.pseudo.segment.AL1.CLASS;
		...
		standard[16]=hl7.pseudo.segment.UB1.CLASS;
		standard[17]=hl7.pseudo.segment.UB2.CLASS;
		standard[12]=hl7.pseudo.group.PROCEDURE_ADT_A05.CLASS;
		standard[14]=hl7.pseudo.group.INSURANCE_ADT_A05.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[7] = subComponents[10];
		components[8] = subComponents[11];
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.message.ADT_A05 type = (hl7.model.V2_3.message.ADT_A05)this;

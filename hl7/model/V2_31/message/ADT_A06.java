...
public class ADT_A06 extends hl7.model.V2_3.message.ADT_A06{
	...
	static{
		...
		standard[4]=hl7.pseudo.segment.MRG.CLASS;
		standard[5]=hl7.pseudo.segment.NK1.CLASS;
		standard[6]=hl7.pseudo.segment.PV1.CLASS;
		standard[7]=hl7.pseudo.segment.PV2.CLASS;
		standard[8]=hl7.pseudo.segment.DB1.CLASS;
		standard[9]=hl7.pseudo.segment.OBX.CLASS;
		standard[10]=hl7.pseudo.segment.AL1.CLASS;
		standard[11]=hl7.pseudo.segment.DG1.CLASS;
		standard[12]=hl7.pseudo.segment.DRG.CLASS;
		standard[14]=hl7.pseudo.segment.GT1.CLASS;
		standard[16]=hl7.pseudo.segment.ACC.CLASS;
		standard[17]=hl7.pseudo.segment.UB1.CLASS;
		standard[18]=hl7.pseudo.segment.UB2.CLASS;
		standard[13]=hl7.pseudo.group.PROCEDURE_ADT_A06.CLASS;
		standard[15]=hl7.pseudo.group.INSURANCE_ADT_A06.CLASS;
	...
	public static void backward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{
		...
		components[12] = subComponents[14];
		components[13] = subComponents[15];
		components[14] = subComponents[16];
		components[15] = subComponents[17];
		components[16] = subComponents[18];
		components[17] = subComponents[19];
		components[18] = subComponents[20];
	}
	...
	public static void forward(Structure[][] components, Structure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		...
		subComponents[9] = components[10];
		subComponents[10] = components[11];
		subComponents[11] = components[12];
		subComponents[12] = components[13];
		subComponents[13] = components[14];
		subComponents[14] = components[15];
		subComponents[15] = components[16];
		subComponents[16] = components[17];
		subComponents[17] = components[18];
		subComponents[18] = components[19];
	}
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.message.ADT_A06 type = (hl7.model.V2_3.message.ADT_A06)this;

...
public class Table0227 extends Table{
	...
	private Table0227(){
		...
		putMap("BPC", "Berna Products Corporation (includes Swiss Serum and Vaccine Institute Berna)");
		...
		putMap("MIP", "Michigan Biologic Products Institute");
		...
		putMap("OTH", "Other");
		putMap("PD", "Parkdale Pharmaceuticals (formerly Parke-Davis)");
		putMap("PMC", "Pasteur Merieux Connaught (includes Connaught Laboratories and Pasteur Merieux)");

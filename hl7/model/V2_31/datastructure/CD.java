...
public class CD extends hl7.model.V2_3.datastructure.CD{
	public static final String VERSION = "2.3.1";
	public static final String CHANNEL_IDENTIFIER = "channel identifier";
	public static final String ELECTRODE_NAMES = "electrode names";
	public static final String CHANNEL_SENSITIVITY_UNITS = "channel sensitivity/units";
	public static final String CALIBRATION_PARAMETERS = "calibration parameters";
	public static final String SAMPLING_FREQUENCY = "sampling frequency";
	public static final String MINIMUM_MAXIMUM_DATA_VALUES = "minimum/maximum data values";
	...
	static{
		standard[0]=hl7.pseudo.datastructure.WVI.CLASS;
		standard[1]=hl7.pseudo.datastructure.WVS.CLASS;
		standard[2]=hl7.pseudo.datastructure.CSU.CLASS;
		standard[3]=hl7.pseudo.datastructure.CCP.CLASS;
		standard[4]=hl7.bean.datastructure.primitive.NM.CLASS;
		standard[5]=hl7.pseudo.datastructure.NR.CLASS;
		...
		descriptions[0]=CHANNEL_IDENTIFIER;
		descriptions[1]=ELECTRODE_NAMES;
		descriptions[2]=CHANNEL_SENSITIVITY_UNITS;
		descriptions[3]=CALIBRATION_PARAMETERS;
		descriptions[4]=SAMPLING_FREQUENCY;
		descriptions[5]=MINIMUM_MAXIMUM_DATA_VALUES;
	...
	public CD(){
		type = DataStructure.CD;
	}
	
	@Override
	public DataStructure cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.datastructure.CD data = new hl7.pseudo.datastructure.CD();
	...
	public static void forward(DataStructure[] components, DataStructure[] subComponents, String originalVersion, String setVersion, int depth) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			if(components[i]==null) continue;
			if(i==0) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.WVI.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==1) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.WVS.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==2) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CSU.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==3) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.CCP.CLASS.cloneClass(VERSION, VERSION):null;
			if(i==5) subComponents[i] = (components[i]!=null)?hl7.pseudo.datastructure.NR.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.datastructure.CD type = (hl7.model.V2_3.datastructure.CD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.datastructure.CD type = (hl7.model.V2_4.datastructure.CD)this;

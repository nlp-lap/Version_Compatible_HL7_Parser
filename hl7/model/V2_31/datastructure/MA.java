...
public class MA extends hl7.model.V2_3.datastructure.MA{
	...
	public static final String SAMPLE_2_FROM_CHANNEL_2 = "sample 2 from channel 2";
	public static final String SAMPLE_2_FROM_CHANNEL_3 = "sample 2 from channel 3";
	...
	static{
		...
		descriptions[4]=SAMPLE_2_FROM_CHANNEL_2;
		descriptions[5]=SAMPLE_2_FROM_CHANNEL_3;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.datastructure.MA type = (hl7.model.V2_3.datastructure.MA)this;

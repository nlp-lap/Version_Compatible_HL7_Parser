...
public class CTD extends hl7.model.V2_3.segment.CTD{
	...
	static{
		...
		tables[0]=hl7.model.V2_31.table.Table0131.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		...
		descriptions[0]="CONTACT_ROLE";
		descriptions[1]="CONTACT_NAME";
		descriptions[2]="CONTACT_ADDRESS";
		descriptions[3]="CONTACT_LOCATION";
		descriptions[4]="CONTACT_COMMUNICATION_INFORMATION";
		descriptions[5]="PREFERRED_METHOD_OF_CONTACT";
		descriptions[6]="CONTACT_IDENTIFIERS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.CTD seg = new hl7.pseudo.segment.CTD();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.CTD type = (hl7.model.V2_3.segment.CTD)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.CTD type = (hl7.model.V2_4.segment.CTD)this;

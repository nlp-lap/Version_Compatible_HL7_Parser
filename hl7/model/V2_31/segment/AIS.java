...
public class AIS extends hl7.model.V2_3.segment.AIS{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_31.table.Table0206.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_31.table.Table0279.getInstance();
		tables[9]=hl7.model.V2_31.table.Table0278.getInstance();
		
		descriptions[0]="SET_ID_AIS";
		descriptions[1]="SEGMENT_ACTION_CODE";
		descriptions[2]="UNIVERSAL_SERVICE_ID";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.AIS type = (hl7.model.V2_3.segment.AIS)this;

...
public class RXE extends hl7.model.V2_3.segment.RXE{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_31.table.Table0292.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_31.table.Table0167.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		...
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_31.table.Table0321.getInstance();
		...
		descriptions[6]="PROVIDER’S_ADMINISTRATION_INSTRUCTIONS";
		...
		descriptions[12]="ORDERING_PROVIDER’S_DEA_NUMBER";
		descriptions[13]="PHARMACIST_TREATMENT_SUPPLIER’S_VERIFIER_ID";
		...
		descriptions[20]="PHARMACY_TREATMENT_SUPPLIER’S_SPECIAL_DISPENSING_INSTRUCTIONS";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==7) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.LA1.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.RXE type = (hl7.model.V2_3.segment.RXE)this;

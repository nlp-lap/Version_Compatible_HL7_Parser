...
public class PRC extends hl7.model.V2_3.segment.PRC{
	...
	static{
		...
		standard[8]=hl7.pseudo.datastructure.MO.CLASS;
		standard[9]=hl7.pseudo.datastructure.MO.CLASS;
		standard[10]=hl7.bean.datastructure.primitive.TS.CLASS;
		...
		standard[16]=hl7.pseudo.datastructure.MO.CLASS;
		standard[17]=hl7.bean.datastructure.primitive.IS.CLASS;
		
		tables[0]=hl7.model.V2_31.table.Table0132.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_31.table.Table0184.getInstance();
		tables[3]=hl7.model.V2_31.table.Table0004.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		...
		tables[10]=null;
		tables[11]=null;
		tables[12]=hl7.model.V2_31.table.Table0268.getInstance();
		tables[13]=hl7.model.V2_31.table.Table0293.getInstance();
		tables[14]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[15]=hl7.model.V2_31.table.Table0183.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_31.table.Table0269.getInstance();
		
		descriptions[0]="PRIMARY_KEY_VALUE_PRC";
		descriptions[1]="FACILITY_ID_PRC";
		descriptions[2]="DEPARTMENT";
		descriptions[3]="VALID_PATIENT_CLASSES";
		descriptions[4]="PRICE";
		descriptions[5]="FORMULA";
		descriptions[6]="MINIMUM_QUANTITY";
		descriptions[7]="MAXIMUM_QUANTITY";
		descriptions[8]="MINIMUM_PRICE";
		descriptions[9]="MAXIMUM_PRICE";
		descriptions[10]="EFFECTIVE_START_DATE";
		descriptions[11]="EFFECTIVE_END_DATE";
		descriptions[12]="PRICE_OVERRIDE_FLAG";
		descriptions[13]="BILLING_CATEGORY";
		descriptions[14]="CHARGEABLE_FLAG";
		descriptions[15]="ACTIVE_INACTIVE_FLAG";
		descriptions[16]="COST";
		descriptions[17]="CHARGE_ON_INDICATOR";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.PRC seg = new hl7.pseudo.segment.PRC();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.PRC type = (hl7.model.V2_3.segment.PRC)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.PRC type = (hl7.model.V2_4.segment.PRC)this;

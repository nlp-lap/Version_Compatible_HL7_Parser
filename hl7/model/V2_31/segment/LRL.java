...
public class LRL extends hl7.model.V2_3.segment.LRL{
	...
	static{
		...
		standard[4]=hl7.pseudo.datastructure.XON.CLASS;
		standard[5]=hl7.pseudo.datastructure.PL.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_31.table.Table0206.getInstance();
		tables[2]=null;
		tables[3]=hl7.model.V2_31.table.Table0325.getInstance();
		tables[4]=null;
		tables[5]=null;
		
		descriptions[0]="PRIMARY_KEY_VALUE_LRL";
		descriptions[1]="SEGMENT_ACTION_CODE";
		descriptions[2]="SEGMENT_UNIQUE_KEY";
		descriptions[3]="LOCATION_RELATIONSHIP_ID";
		descriptions[4]="ORGANIZATIONAL_LOCATION_RELATIONSHIP_VALUE";
		descriptions[5]="PATIENT_LOCATION_RELATIONSHIP_VALUE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.LRL seg = new hl7.pseudo.segment.LRL();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.LRL type = (hl7.model.V2_3.segment.LRL)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.LRL type = (hl7.model.V2_4.segment.LRL)this;

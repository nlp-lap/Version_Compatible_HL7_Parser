...
public class DRG extends hl7.model.V2_3.segment.DRG{
	...
	static{
		...
		tables[0]=hl7.model.V2_31.table.Table0055.getInstance();
		tables[1]=null;
		tables[2]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[3]=hl7.model.V2_31.table.Table0056.getInstance();
		tables[4]=hl7.model.V2_31.table.Table0083.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_31.table.Table0229.getInstance();
		tables[8]=null;
		tables[9]=hl7.model.V2_31.table.Table0136.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.DRG type = (hl7.model.V2_3.segment.DRG)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.DRG type = (hl7.model.V2_4.segment.DRG)this;

...
public class ORC extends hl7.model.V2_3.segment.ORC{
	...
	static{
		...
		tables[0]=hl7.model.V2_31.table.Table0119.getInstance();
		tables[1]=null;
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_31.table.Table0038.getInstance();
		tables[5]=hl7.model.V2_31.table.Table0121.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		...
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_31.table.Table0339.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=null;
		...
		descriptions[12]="ENTERER’S_LOCATION";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==7) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.EIP.CLASS.cloneClass(VERSION, VERSION):null;
				...
				if(i==21) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==22) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XTN.CLASS.cloneClass(VERSION, VERSION):null;

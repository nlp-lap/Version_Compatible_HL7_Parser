...
public class IN3 extends hl7.model.V2_3.segment.IN3{
	...
	static{
		...
		standard[19]=hl7.pseudo.datastructure.PCF.CLASS;
		...
		tables[4]=hl7.model.V2_31.table.Table0148.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_31.table.Table0149.getInstance();
		tables[11]=hl7.model.V2_31.table.Table0233.getInstance();
		tables[12]=null;
		tables[13]=hl7.model.V2_31.table.Table0010.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_31.table.Table0345.getInstance();
		tables[17]=hl7.model.V2_31.table.Table0346.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_31.table.Table0150.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=hl7.model.V2_31.table.Table0151.getInstance();
		tables[23]=hl7.model.V2_31.table.Table0152.getInstance();
		tables[24]=hl7.model.V2_31.table.Table0010.getInstance();
		...
		descriptions[19]="PRE_CERTIFICATION_REQ_WINDOW";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==4) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.MOP.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.DTN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==19) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.PCF.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.IN3 type = (hl7.model.V2_4.segment.IN3)this;

...
public class CM0 extends hl7.model.V2_3.segment.CM0{
	...
	static{
		...
		descriptions[0]="SET_ID_CM0";
		descriptions[1]="SPONSOR_STUDY_ID";
		descriptions[2]="ALTERNATE_STUDY_ID";
		descriptions[3]="TITLE_OF_STUDY";
		descriptions[4]="CHAIRMAN_OF_STUDY";
		descriptions[5]="LAST_IRB_APPROVAL_DATE";
		descriptions[6]="TOTAL_ACCRUAL_TO_DATE";
		descriptions[7]="LAST_ACCRUAL_DATE";
		descriptions[8]="CONTACT_FOR_STUDY";
		descriptions[9]="CONTACTS_TEL_NUMBER";
		descriptions[10]="CONTACTS_ADDRESS";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.CM0 seg = new hl7.pseudo.segment.CM0();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.CM0 type = (hl7.model.V2_3.segment.CM0)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.CM0 type = (hl7.model.V2_4.segment.CM0)this;

...
public class MSH extends hl7.model.V2_3.segment.MSH{
	...
	static{
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_31.table.Table0361.getInstance();
		tables[3]=hl7.model.V2_31.table.Table0362.getInstance();
		tables[4]=hl7.model.V2_31.table.Table0361.getInstance();
		tables[5]=hl7.model.V2_31.table.Table0362.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_31.table.Table0076.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_31.table.Table0104.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_31.table.Table0155.getInstance();
		tables[15]=hl7.model.V2_31.table.Table0155.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_31.table.Table0211.getInstance();
		tables[18]=null;
		tables[19]=hl7.model.V2_31.table.Table0356.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==8) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.MSG.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.VID.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.MSH type = (hl7.model.V2_4.segment.MSH)this;

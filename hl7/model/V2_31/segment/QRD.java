...
public class QRD extends hl7.model.V2_3.segment.QRD{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_31.table.Table0106.getInstance();
		tables[2]=hl7.model.V2_31.table.Table0091.getInstance();
		tables[3]=null;
		tables[4]=hl7.model.V2_31.table.Table0107.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_31.table.Table0126.getInstance();
		tables[7]=null;
		tables[8]=hl7.model.V2_31.table.Table0048.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=hl7.model.V2_31.table.Table0108.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.VR.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.QRD type = (hl7.model.V2_4.segment.QRD)this;

...
public class STF extends hl7.model.V2_3.segment.STF{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_31.table.Table0182.getInstance();
		tables[4]=hl7.model.V2_31.table.Table0001.getInstance();
		tables[5]=null;
		tables[6]=hl7.model.V2_31.table.Table0183.getInstance();
		tables[7]=hl7.model.V2_31.table.Table0184.getInstance();
		tables[8]=hl7.model.V2_31.table.Table0069.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_31.table.Table0185.getInstance();
		tables[16]=hl7.model.V2_31.table.Table0002.getInstance();
		tables[17]=null;
		tables[18]=hl7.model.V2_31.table.Table0327.getInstance();
		tables[19]=hl7.model.V2_31.table.Table0066.getInstance();
		tables[20]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[21]=null;
		...
		descriptions[21]="DRIVER’S_LICENSE_NUMBER_STAFF";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XTN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XAD.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==11) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.DIN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==12) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.DIN.CLASS.cloneClass(VERSION, VERSION):null;

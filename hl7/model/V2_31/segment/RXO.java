...
public class RXO extends hl7.model.V2_3.segment.RXO{
	...
	static{
		...
		tables[6]=null;
		tables[7]=null;
		tables[8]=hl7.model.V2_31.table.Table0161.getInstance();
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[16]=null;
		tables[17]=null;
		tables[18]=null;
		tables[19]=null;
		...
		descriptions[5]="PROVIDER’S_PHARMACY_TREATMENT_INSTRUCTIONS";
		...
		descriptions[13]="ORDERING_PROVIDER’S_DEA_NUMBER";
		descriptions[14]="PHARMACIST_TREATMENT_SUPPLIER’S_VERIFIER_ID";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==14) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.XCN.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==22) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CQ.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.RXO type = (hl7.model.V2_3.segment.RXO)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.RXO type = (hl7.model.V2_4.segment.RXO)this;

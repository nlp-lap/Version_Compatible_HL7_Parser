...
public class OBR extends hl7.model.V2_3.segment.OBR{
	...
	static{
		...
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_31.table.Table0065.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=null;
		tables[14]=hl7.model.V2_31.table.Table0070.getInstance();
		tables[15]=null;
		tables[16]=null;
		tables[17]=null;
		tables[18]=null;
		...
		tables[21]=null;
		tables[22]=null;
		tables[23]=hl7.model.V2_31.table.Table0074.getInstance();
		tables[24]=hl7.model.V2_31.table.Table0123.getInstance();
		tables[25]=null;
		tables[26]=null;
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_31.table.Table0124.getInstance();
		tables[30]=null;
		tables[31]=null;
		tables[32]=null;
		tables[33]=null;
		...
		tables[38]=null;
		tables[39]=null;
		tables[40]=hl7.model.V2_31.table.Table0224.getInstance();
		tables[41]=hl7.model.V2_31.table.Table0225.getInstance();
		tables[42]=null;
		tables[43]=hl7.model.V2_31.table.Table0088.getInstance();
		tables[44]=hl7.model.V2_31.table.Table0340.getInstance();
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==14) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.SPS.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==22) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.MOC.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==25) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.PRL.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==28) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.EIP.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==31) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.NDL.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==32) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.NDL.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==33) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.NDL.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==34) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.NDL.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.OBR type = (hl7.model.V2_4.segment.OBR)this;

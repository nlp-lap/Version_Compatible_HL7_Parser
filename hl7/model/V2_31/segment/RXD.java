...
public class RXD extends hl7.model.V2_3.segment.RXD{
	...
	static{
		...
		tables[8]=null;
		tables[9]=null;
		tables[10]=hl7.model.V2_31.table.Table0167.getInstance();
		tables[11]=null;
		tables[12]=null;
		tables[13]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[14]=null;
		tables[15]=null;
		tables[16]=null;
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_31.table.Table0227.getInstance();
		tables[20]=null;
		tables[21]=null;
		tables[22]=null;
		tables[23]=hl7.model.V2_31.table.Table0321.getInstance();
		...
		descriptions[14]="PHARMACY_TREATMENT_SUPPLIER’S_SPECIAL_DISPENSING_INSTRUCTIONS";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==12) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.LA2.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.RXD type = (hl7.model.V2_3.segment.RXD)this;

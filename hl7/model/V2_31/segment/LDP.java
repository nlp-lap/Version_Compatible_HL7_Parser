...
public class LDP extends hl7.model.V2_3.segment.LDP{
	...
	static{
		...
		standard[9]=hl7.pseudo.datastructure.VH.CLASS;
		standard[10]=hl7.pseudo.datastructure.XTN.CLASS;
		
		tables[0]=null;
		tables[1]=hl7.model.V2_31.table.Table0264.getInstance();
		tables[2]=hl7.model.V2_31.table.Table0069.getInstance();
		tables[3]=hl7.model.V2_31.table.Table0265.getInstance();
		tables[4]=hl7.model.V2_31.table.Table0004.getInstance();
		tables[5]=hl7.model.V2_31.table.Table0183.getInstance();
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_31.table.Table0267.getInstance();
		tables[10]=null;
		
		descriptions[0]="PRIMARY_KEY_VALUE_LDP";
		descriptions[1]="LOCATION_DEPARTMENT";
		descriptions[2]="LOCATION_SERVICE";
		descriptions[3]="SPECIALTY_TYPE";
		descriptions[4]="VALID_PATIENT_CLASSES";
		descriptions[5]="ACTIVE_INACTIVE_FLAG";
		descriptions[6]="ACTIVATION_DATE_LDP";
		descriptions[7]="INACTIVATION_DATE_LDP";
		descriptions[8]="INACTIVATED_REASON";
		descriptions[9]="VISITING_HOURS";
		descriptions[10]="CONTACT_PHONE";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.LDP seg = new hl7.pseudo.segment.LDP();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.LDP type = (hl7.model.V2_3.segment.LDP)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.LDP type = (hl7.model.V2_4.segment.LDP)this;

...
public class RXG extends hl7.model.V2_3.segment.RXG{
	...
	static{
		...
		tables[1]=null;
		tables[2]=null;
		tables[3]=hl7.model.V2_31.table.Table0292.getInstance();
		tables[4]=null;
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_31.table.Table0167.getInstance();
		tables[10]=null;
		...
		tables[18]=null;
		tables[19]=null;
		tables[20]=hl7.model.V2_31.table.Table0227.getInstance();
		tables[21]=null;
		...
		descriptions[12]="PHARMACY_TREATMENT_SUPPLIER’S_SPECIAL_ADMINISTRATION_INSTRUCTIONS";
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				...
				if(i==10) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.LA2.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.RXG type = (hl7.model.V2_3.segment.RXG)this;

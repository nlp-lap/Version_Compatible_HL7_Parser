...
public class PV2 extends hl7.model.V2_3.segment.PV2{
	...
	static{
		...
		tables[0]=null;
		tables[1]=hl7.model.V2_31.table.Table0129.getInstance();
		tables[2]=null;
		tables[3]=null;
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_31.table.Table0130.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		...
		tables[15]=hl7.model.V2_31.table.Table0213.getInstance();
		tables[16]=null;
		tables[17]=hl7.model.V2_31.table.Table0214.getInstance();
		tables[18]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[19]=null;
		tables[20]=hl7.model.V2_31.table.Table0215.getInstance();
		tables[21]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[22]=null;
		tables[23]=hl7.model.V2_31.table.Table0216.getInstance();
		tables[24]=hl7.model.V2_31.table.Table0217.getInstance();
		tables[25]=null;
		tables[26]=hl7.model.V2_31.table.Table0112.getInstance();
		tables[27]=null;
		tables[28]=null;
		tables[29]=hl7.model.V2_31.table.Table0218.getInstance();
		tables[30]=hl7.model.V2_31.table.Table0219.getInstance();
		tables[31]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[32]=null;
		tables[33]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[34]=hl7.model.V2_31.table.Table0136.getInstance();
		tables[35]=hl7.model.V2_31.table.Table0136.getInstance();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.PV2 type = (hl7.model.V2_3.segment.PV2)this;

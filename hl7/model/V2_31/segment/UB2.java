...
public class UB2 extends hl7.model.V2_3.segment.UB2{
	...
	static{
		...
		standard[5]=hl7.pseudo.datastructure.UVC.CLASS;
		standard[6]=hl7.pseudo.datastructure.OCD.CLASS;
		standard[7]=hl7.pseudo.datastructure.OSP.CLASS;
		...
		tables[0]=null;
		tables[1]=null;
		tables[2]=hl7.model.V2_31.table.Table0043.getInstance();
		tables[3]=null;
		tables[4]=null;
		tables[5]=hl7.model.V2_31.table.Table0153.getInstance();
		tables[6]=hl7.model.V2_31.table.Table0350.getInstance();
		tables[7]=hl7.model.V2_31.table.Table0351.getInstance();
		tables[8]=null;
		tables[9]=null;
		tables[10]=null;
		tables[11]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==2) subComponents[i][c] = (components[i][c]!=null)?hl7.bean.datastructure.primitive.IS.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==5) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.UVC.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==6) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.OCD.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==7) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.OSP.CLASS.cloneClass(VERSION, VERSION):null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.UB2 type = (hl7.model.V2_3.segment.UB2)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.UB2 type = (hl7.model.V2_4.segment.UB2)this;

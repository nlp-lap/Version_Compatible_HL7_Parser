...
public class RXA extends hl7.model.V2_3.segment.RXA{
	...
	static{
		...
		tables[2]=null;
		tables[3]=null;
		tables[4]=hl7.model.V2_31.table.Table0292.getInstance();
		tables[5]=null;
		tables[6]=null;
		tables[7]=null;
		tables[8]=null;
		...
		tables[14]=null;
		tables[15]=null;
		tables[16]=hl7.model.V2_31.table.Table0227.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=hl7.model.V2_31.table.Table0322.getInstance();
		tables[20]=hl7.model.V2_31.table.Table0323.getInstance();
		tables[21]=null;
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.RXA type = (hl7.model.V2_3.segment.RXA)this;

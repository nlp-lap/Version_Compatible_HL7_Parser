...
public class BLG extends hl7.model.V2_3.segment.BLG{
	...
	static{
		...
		tables[0]=hl7.model.V2_31.table.Table0100.getInstance();
		tables[1]=hl7.model.V2_31.table.Table0122.getInstance();
		tables[2]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==0) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CCD.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.BLG type = (hl7.model.V2_4.segment.BLG)this;

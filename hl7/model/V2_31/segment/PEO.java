...
public class PEO extends hl7.model.V2_3.segment.PEO{
	...
	static{
		...
		tables[5]=null;
		tables[6]=null;
		tables[7]=hl7.model.V2_31.table.Table0237.getInstance();
		tables[8]=hl7.model.V2_31.table.Table0238.getInstance();
		tables[9]=hl7.model.V2_31.table.Table0239.getInstance();
		tables[10]=hl7.model.V2_31.table.Table0240.getInstance();
		tables[11]=hl7.model.V2_31.table.Table0241.getInstance();
		tables[12]=null;
		tables[13]=null;
		tables[14]=null;
		tables[15]=null;
		...
		tables[19]=null;
		tables[20]=null;
		tables[21]=hl7.model.V2_31.table.Table0242.getInstance();
		tables[22]=hl7.model.V2_31.table.Table0242.getInstance();
		tables[23]=null;
		tables[24]=hl7.model.V2_31.table.Table0243.getInstance();
		...
		descriptions[21]="PRIMARY_OBSERVER’S_QUALIFICATION";
		descriptions[22]="CONFIRMATION_PROVIDED_BY";
		descriptions[23]="PRIMARY_OBSERVER_AWARE_DATE_TIME";
		descriptions[24]="PRIMARY_OBSERVER’S_IDENTITY_MAY_BE_DIVULGED";
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.PEO type = (hl7.model.V2_3.segment.PEO)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.PEO type = (hl7.model.V2_4.segment.PEO)this;

...
public class UB1 extends hl7.model.V2_3.segment.UB1{
	...
	static{
		...
		standard[9]=hl7.pseudo.datastructure.UVC.CLASS;
		...
		standard[15]=hl7.pseudo.datastructure.OCD.CLASS;
		...
		tables[4]=null;
		tables[5]=null;
		tables[6]=hl7.model.V2_31.table.Table0043.getInstance();
		tables[7]=null;
		tables[8]=null;
		tables[9]=hl7.model.V2_31.table.Table0153.getInstance();
		tables[10]=null;
		tables[11]=hl7.model.V2_31.table.Table0348.getInstance();
		tables[12]=hl7.model.V2_31.table.Table0349.getInstance();
		tables[13]=null;
		tables[14]=null;
		tables[15]=hl7.model.V2_31.table.Table0350.getInstance();
		tables[16]=hl7.model.V2_31.table.Table0351.getInstance();
		tables[17]=null;
		tables[18]=null;
		tables[19]=null;
		tables[20]=null;
	...
	public static void forward(DataStructure[][] components, DataStructure[][] subComponents, String originalVersion, String setVersion) throws Exception{ 
		for(int i=0; components!=null&&i<components.length; i++){
			...
			for(int c=0; c<comps.length; c++){
				if(i==9) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.UVC.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==12) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.CE.CLASS.cloneClass(VERSION, VERSION):null;
				if(i==15) subComponents[i][c] = (components[i][c]!=null)?hl7.pseudo.datastructure.OCD.CLASS.cloneClass(VERSION, VERSION):null;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.UB1 type = (hl7.model.V2_4.segment.UB1)this;

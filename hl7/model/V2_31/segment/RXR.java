...
public class RXR extends hl7.model.V2_3.segment.RXR{
	...
	static{
		...
		tables[0]=hl7.model.V2_31.table.Table0162.getInstance();
		tables[1]=hl7.model.V2_31.table.Table0163.getInstance();
		tables[2]=hl7.model.V2_31.table.Table0164.getInstance();
		tables[3]=hl7.model.V2_31.table.Table0165.getInstance();
		tables[4]=null;
		
		descriptions[0]="ROUTE";
		descriptions[1]="SITE";
		descriptions[2]="ADMINISTRATION_DEVICE";
		descriptions[3]="ADMINISTRATION_METHOD";
		descriptions[4]="ROUTING_INSTRUCTION";
	...
	public Segment cloneClass(String originalVersion, String setVersion) {
		hl7.pseudo.segment.RXR seg = new hl7.pseudo.segment.RXR();
		...
		if(seekOriginalVersion&&MessageStructure.getVersionCode(originalVersion)<MessageStructure.getVersionCode(VERSION)){ //실제 버전의 위치 찾기
			...
			if(setVersion.equals(VERSION)){ //설정 버전의 위치 찾기
				...
				if(MessageStructure.getVersionCode(setVersion)<MessageStructure.getVersionCode(VERSION)){ //버전으로 이동 방향 찾기
					...
					//if(MessageStructure.getVersionCode(originalVersion)>=MessageStructure.getVersionCode(VERSION)){
						hl7.model.V2_3.segment.RXR type = (hl7.model.V2_3.segment.RXR)this;
	...
	public String encodeForward(String encodeVersion, String setVersion) throws Exception{
		...
		if(encodeVersion.equals(VERSION)){
			hl7.model.V2_4.segment.RXR type = (hl7.model.V2_4.segment.RXR)this;
